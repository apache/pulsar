...
public interface TopicPolicies {
    ...
    /**
     * Set custom metric labels for a topic.
     * <p/>
     * Custom metric labels are key-value pairs that will be exposed as Prometheus labels
     * on all metrics for this topic. Only keys defined in the broker configuration's
     * allowedCustomMetricLabelKeys can be used.
     *
     * @param topic Topic name
     * @param labels Map of custom metric label key-value pairs
     * @throws PulsarAdminException.NotAuthorizedException
     *             Don't have admin permission
     * @throws PulsarAdminException.NotFoundException
     *             Topic does not exist
     * @throws PulsarAdminException
     *             Unexpected error (e.g., invalid keys or values)
     */
    void setCustomMetricLabels(String topic, Map<String, String> labels) throws PulsarAdminException;

    /**
     * Set custom metric labels for a topic asynchronously.
     *
     * @param topic Topic name
     * @param labels Map of custom metric label key-value pairs
     * @return CompletableFuture
     */
    CompletableFuture<Void> setCustomMetricLabelsAsync(String topic, Map<String, String> labels);

    /**
     * Get custom metric labels for a topic.
     *
     * @param topic Topic name
     * @return Map of custom metric label key-value pairs
     * @throws PulsarAdminException Unexpected error
     */
    Map<String, String> getCustomMetricLabels(String topic) throws PulsarAdminException;

    /**
     * Get custom metric labels for a topic asynchronously.
     *
     * @param topic Topic name
     * @return CompletableFuture containing map of custom metric label key-value pairs
     */
    CompletableFuture<Map<String, String>> getCustomMetricLabelsAsync(String topic);

    /**
     * Remove specific custom metric labels or all custom metric labels from a topic.
     *
     * @param topic Topic name
     * @param removeAll If true, remove all labels regardless of keys parameter
     * @param keys List of label keys to remove, or null/empty to remove all labels
     * @throws PulsarAdminException Unexpected error
     */
    void removeCustomMetricLabels(String topic, boolean removeAll, List<String> keys) throws PulsarAdminException;

    /**
     * Remove specific custom metric labels or all custom metric labels from a topic asynchronously.
     *
     * @param topic Topic name
     * @param removeAll If true, remove all labels regardless of keys parameter
     * @param keys List of label keys to remove, or null/empty to remove all labels
     * @return CompletableFuture
     */
    CompletableFuture<Void> removeCustomMetricLabelsAsync(String topic, boolean removeAll, List<String> keys);
}
