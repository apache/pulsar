...
public final class BookieAffinityGroupDataImpl implements BookieAffinityGroupData {
    ...
    public static class BookieAffinityGroupDataImplBuilder implements BookieAffinityGroupData.Builder {
        ...
        public BookieAffinityGroupDataImplBuilder bookkeeperAffinityGroupPrimary(
                String bookkeeperAffinityGroupPrimary) {
            this.bookkeeperAffinityGroupPrimary = bookkeeperAffinityGroupPrimary;
            return this;
        }

        public BookieAffinityGroupDataImplBuilder bookkeeperAffinityGroupSecondary(
                String bookkeeperAffinityGroupSecondary) {
            this.bookkeeperAffinityGroupSecondary = bookkeeperAffinityGroupSecondary;
            return this;
        }

        public BookieAffinityGroupDataImpl build() {
            return new BookieAffinityGroupDataImpl(bookkeeperAffinityGroupPrimary, bookkeeperAffinityGroupSecondary);
        }
    }
}
