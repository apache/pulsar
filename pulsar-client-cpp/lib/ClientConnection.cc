...
static Result getResult(ServerError serverError) {
    switch (serverError) {
        ...
        case TransactionAckConflictException:
            return TransactionAckConflictException;

        case TransactionCommitConflictException:
            return TransactionCommitConflictException;

        case TransactionAbortConflictException:
            return TransactionAbortConflictException;
    }
