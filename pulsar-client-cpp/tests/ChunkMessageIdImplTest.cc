...
TEST(ChunkMessageIdImplTest, testCompareLedgerAndEntryId) {
    MessageId id1(MessageId(1, 1, 1, 1), MessageId(-1, 2, 1, 0));
    MessageId id2(MessageId(1, 1, 1, 1), MessageId(-1, 2, 1, 1));
    MessageId id3(MessageId(1, 1, 1, 1), MessageId(-1, 2, 2, 0));
    MessageId id4(MessageId(1, 1, 1, 1), MessageId(-1, 3, 0, 0));
