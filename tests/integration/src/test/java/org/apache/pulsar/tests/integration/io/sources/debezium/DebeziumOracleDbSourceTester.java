...
public class DebeziumOracleDbSourceTester extends SourceTester<DebeziumOracleDbContainer> {
    ...
    public void prepareSource() {
        ...
        // initial event
        runSqlCmd(
                "INSERT INTO inv.customers (first_name, last_name, email) VALUES ('James', 'Bond', 'jbond@null.dev');");
    }
    ...
    private ContainerExecResult runSqlCmd(String cmd) throws Exception {
        ...
        ContainerExecResult response = this.debeziumOracleDbContainer.execCmdAsUser(
                "oracle",
                "/bin/bash",
                "-c",
                "echo \"exit;\" | echo \"" + cmd.replace("$", "\\$") + "\" | sqlplus sys/oracle as sysdba");
