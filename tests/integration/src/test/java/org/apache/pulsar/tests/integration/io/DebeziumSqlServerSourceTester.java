...
public class DebeziumSqlServerSourceTester extends SourceTester<DebeziumSqlServerContainer> implements Closeable {
    ...
    public void prepareSource() throws Exception {
        URL inventorySql = DebeziumSqlServerSourceTester.class.getClassLoader().getResource("debezium-sqlserver-init-inventory.sql");
        this.debeziumSqlServerContainer.execCmd("docker cp " + inventorySql.getPath() + "  " + DebeziumSqlServerContainer.NAME + ":debezium-sqlserver-init/inventory.sql ");
