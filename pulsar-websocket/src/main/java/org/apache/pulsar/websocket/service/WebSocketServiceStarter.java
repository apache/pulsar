...
public class WebSocketServiceStarter {
    ...
    public static void start(ProxyServer proxyServer, WebSocketService service) throws Exception {
        ...
        proxyServer.addWebSocketServlet(WebSocketPingPongServlet.SERVLET_PATH, new WebSocketReaderServlet(service));
        ...
        proxyServer.addWebSocketServlet(WebSocketPingPongServlet.SERVLET_PATH_V2, new WebSocketReaderServlet(service));
