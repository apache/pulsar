...
public class ProducerHandler extends AbstractWebSocketHandler {
    ...
    public void onWebSocketText(String message) {
        ...
        try {
            sendRequest = ObjectMapperFactory.getInstance().readValue(message, ProducerMessage.class);
    ...
    private void sendAckResponse(ProducerAck response) {
        try {
            String msg = ObjectMapperFactory.getInstance().writeValueAsString(response);
