...
public class PulsarAdminToolTest {
    ...
    void namespaces() throws Exception {
        ...
        namespaces.run(split("set-offload-policies myprop/clust/ns1 -r test-region -d aws-s3 -b test-bucket -e http://test.endpoint -mbs 32M -rbs 5M -oat 10M -oae 10s -odat 100M -odae 1000s"));
        verify(mockNamespaces).setOffloadPolicies("myprop/clust/ns1",
                OffloadPolicies.create("aws-s3", "test-region", "test-bucket",
                        ...
                        10 * 1024 * 1024, 10000L, 100 * 1024 * 1024, 100000L));
