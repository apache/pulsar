...
public class ProtobufNativeSchemaTest {
    ...
    private static final String EXPECTED_SCHEMA_JSON =
            "{\"fileDescriptorSet\":\"CtMDCgpUZXN0LnByb3RvEgVwcm90bxoSRXh0ZXJuYWxUZXN0LnByb3RvImUKClN1Yk1lc3NhZ2U"
    ...
    public void testEncodeAndDecode() {
        ...
        org.apache.pulsar.client.schema.proto.Test.TestMessage testMessage =
                org.apache.pulsar.client.schema.proto.Test.TestMessage.newBuilder()
                        .setStringField(stringFieldValue)
                        .build();
    ...
    public void testSchema() {
        ...
        assertNotNull(ProtobufNativeSchemaUtils.deserialize(
                protobufSchema.getSchemaInfo().getSchema()));
        assertEquals(
                new String(protobufSchema.getSchemaInfo().getSchema(), StandardCharsets.UTF_8), EXPECTED_SCHEMA_JSON);
    }
    ...
    public void testGenericOf() {
        try {
            ProtobufNativeSchema<org.apache.pulsar.client.schema.proto.Test.TestMessage> protobufNativeSchema =
                    ProtobufNativeSchema.ofGenericClass(
                            org.apache.pulsar.client.schema.proto.Test.TestMessage.class, new HashMap<>());
        } catch (Exception e) {
        ...
        try {
            ProtobufSchema<org.apache.pulsar.client.schema.proto.Test.TestMessage> protobufSchema =
                    ProtobufSchema.ofGenericClass(String.class, Collections.emptyMap());
    ...
    public void testDecodeByteBuf() {
        ...
        org.apache.pulsar.client.schema.proto.Test.TestMessage testMessage =
                org.apache.pulsar.client.schema.proto.Test.TestMessage.newBuilder()
                        .build();
        byte[] bytes = protobufSchema.encode(org.apache.pulsar.client.schema.proto.Test.TestMessage.newBuilder()
                .build());
    ...
    public void testGetNativeSchema() {
        ProtobufNativeSchema<org.apache.pulsar.client.schema.proto.Test.TestMessage> protobufSchema =
                ProtobufNativeSchema.of(org.apache.pulsar.client.schema.proto.Test.TestMessage.class);
        Descriptors.Descriptor nativeSchema =
                (Descriptors.Descriptor) protobufSchema.getNativeSchema().get();
