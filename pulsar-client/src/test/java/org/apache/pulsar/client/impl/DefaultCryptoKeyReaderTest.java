...
public class DefaultCryptoKeyReaderTest {
    ...
    public void testBuild() throws Exception {
        ...
        DefaultCryptoKeyReader keyReader = DefaultCryptoKeyReader.builder()
                ...
                .publicKey("key4", "file:///path/to/public4.key")
                .publicKeys(publicKeys)
                .publicKey("key5", "file:///path/to/public5.key")
                .privateKey("key6", "file:///path/to/private6.key")
                .privateKeys(privateKeys)
                .privateKey("key7", "file:///path/to/private7.key")
                .build();
    ...
    public void testGetKeys() throws Exception {
        ...
        DefaultCryptoKeyReaderBuilder auxBuilder = DefaultCryptoKeyReader.builder()
                .defaultPublicKey("file:" + ecdsaPublicKey)
                .defaultPrivateKey("file:" + ecdsaPrivateKey)
                .publicKey("key2", "file:invalid")
                .privateKey("key2", "file:invalid")
                .publicKey("key3", "data:invalid")
