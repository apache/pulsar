...
public class AutoClusterFailoverTest {
    ...
    public void testBuildAutoClusterFailoverInstance() throws PulsarClientException {
        ...
        assertEquals(autoClusterFailover1.getSecondaryTlsTrustCertsFilePaths().get(secondary), secondaryTlsTrustCertsFilePath);
    ...
    public void testInitialize() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            Awaitility.await().untilAsserted(() ->
                    assertEquals(primary, autoClusterFailover.getServiceUrl()));
    ...
    public void testAutoClusterFailoverSwitchWithAuthentication() throws IOException {
        ...
        Awaitility.await().untilAsserted(() ->
                assertEquals(secondary, autoClusterFailover.getServiceUrl()));
