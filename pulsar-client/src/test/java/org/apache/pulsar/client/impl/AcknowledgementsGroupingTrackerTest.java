...
public class AcknowledgementsGroupingTrackerTest {
    ...
    public void setup() throws NoSuchFieldException, IllegalAccessException {
        ...
        consumer.unAckedChunkedMessageIdSequenceMap = ConcurrentOpenHashMap.<MessageIdAdv, MessageIdImpl[]>newBuilder()
                .build();
    ...
    public void testDoIndividualBatchAckAsync() throws Exception {
        ...
        Method doIndividualBatchAckAsync = PersistentAcknowledgmentsGroupingTracker.class.getDeclaredMethod(
                "doIndividualBatchAckAsync", MessageIdAdv.class);
