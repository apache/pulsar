...
public class FloatSchemaTest {
    ...
    @Test
    public void testSchemaDecodeBiggerBuffer() {
        ...
        byte[] byteDataExtra = new byte[] {
                0,
                10,
                24,
                42,
                53, // this should be ignored
                48  // this should be ignored
        };
        FloatSchema schema = FloatSchema.of();
        Assert.assertEquals(schema.decode(byteDataExtra), schema.decode(byteData));
    }
