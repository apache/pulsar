...
public class AbstractGenericSchemaTest {
    ...
    public void testAutoProtobufNativeSchema() {
        ...
        GenericSchema genericProtobufNativeSchema = GenericProtobufNativeSchema.of(
                Schema.PROTOBUF_NATIVE(org.apache.pulsar.client.schema.proto.Test.TestMessage.class)
                        .getSchemaInfo());
    ...
    private static org.apache.pulsar.client.schema.proto.Test.TestMessage newTestMessage(int i) {
        return org.apache.pulsar.client.schema.proto.Test.TestMessage.newBuilder()
                .setStringField("field-value-" + i)
                .setIntField(i)
                .build();
    }
