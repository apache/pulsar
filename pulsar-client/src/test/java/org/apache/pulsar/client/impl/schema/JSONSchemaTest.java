...
public class JSONSchemaTest {
    ...
    public void testNotAllowNullSchema() throws JSONException {
        JSONSchema<Foo> jsonSchema = JSONSchema.of(SchemaDefinition.<Foo>builder()
                .withPojo(Foo.class)
    ...
    public void testAllowNullSchema() throws JSONException {
        JSONSchema<Foo> jsonSchema = JSONSchema.of(
    ...
    public void testAllowNullNestedClasses() {
        JSONSchema<NestedBar> jsonSchema = JSONSchema.of(
                SchemaDefinition.<NestedBar>builder().withPojo(NestedBar.class).build());
        JSONSchema<NestedBarList> listJsonSchema = JSONSchema.of(SchemaDefinition.<NestedBarList>builder()
                .withPojo(NestedBarList.class)
                .build());
    ...
    public void testNotAllowNullNestedClasses() {
        JSONSchema<NestedBar> jsonSchema = JSONSchema.of(SchemaDefinition.<NestedBar>builder()
                .withPojo(NestedBar.class)
                .withAlwaysAllowNull(false)
                .build());
        JSONSchema<NestedBarList> listJsonSchema = JSONSchema.of(SchemaDefinition.<NestedBarList>builder()
                .withPojo(NestedBarList.class)
    ...
    public void testNotAllowNullCorrectPolymorphism() {
        ...
        JSONSchema<Foo> baseJsonSchema = JSONSchema.of(
                SchemaDefinition.<Foo>builder().withPojo(Foo.class).build());
        ...
        JSONSchema<DerivedFoo> derivedJsonSchema = JSONSchema.of(SchemaDefinition.<DerivedFoo>builder()
                .withPojo(DerivedFoo.class)
                .build());
        ...
        JSONSchema<SchemaTestUtils.DerivedDerivedFoo> derivedDerivedJsonSchema =
                JSONSchema.of(SchemaDefinition.<SchemaTestUtils.DerivedDerivedFoo>builder()
                        .withPojo(SchemaTestUtils.DerivedDerivedFoo.class)
                        .build());
        Assert.assertEquals(
                derivedDerivedJsonSchema.decode(derivedDerivedJsonSchema.encode(derivedDerivedFoo)), derivedDerivedFoo);
    }
    ...
    public void testAllowNullCorrectPolymorphism() {
        ...
        // schema for base class
        JSONSchema<Foo> baseJsonSchema = JSONSchema.of(SchemaDefinition.<Foo>builder()
                .withPojo(Foo.class)
                .withAlwaysAllowNull(false)
                .build());
        Assert.assertEquals(baseJsonSchema.decode(baseJsonSchema.encode(foo)), foo);
    ...
    public void testJsonGenericRecordBuilder() {
        ...
        pcSchemaBuilder
                .field("seller", sellerGenericSchema)
        ...
        GenericRecord sellerRecord = sellerGenericSchema
                .newRecordBuilder()
                .set("state", "USA")
        ...
        GenericRecord pcRecord = pcGenericSchema
                .newRecordBuilder()
                .set("brand", "dell")
                .set("model", "g3")
                .set("year", 2020)
