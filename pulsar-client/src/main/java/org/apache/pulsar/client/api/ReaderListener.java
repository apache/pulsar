 ...
 */
public interface ReaderListener<M extends Message> extends Serializable {
    /**
     ...
     *            the message object
     */
    void received(Reader<M> reader, M msg);
     ...
     */
    default void reachedEndOfTopic(Reader<M> reader) {
