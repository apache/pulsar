...
@Data
@NoArgsConstructor
public class TrimTopicData {
    protected long ledgerId;
    protected long entryId;
    protected boolean dryrun = true;

    public TrimTopicData(long ledgerId, long entryId) {
        this.ledgerId = ledgerId;
        this.entryId = entryId;
    }

    public TrimTopicData(MessageId messageId) {
        if (messageId instanceof BatchMessageIdImpl) {
            ...
            throw new IllegalArgumentException("Not supported messageId type");
        }
    }
}
