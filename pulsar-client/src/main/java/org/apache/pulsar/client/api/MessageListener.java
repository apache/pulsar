 ...
 *
 */
public interface MessageListener<M extends Message> extends Serializable {
    /**
     ...
     *            the message object
     */
    void received(Consumer<M> consumer, M msg);
     ...
     */
    default void reachedEndOfTopic(Consumer<M> consumer) {
