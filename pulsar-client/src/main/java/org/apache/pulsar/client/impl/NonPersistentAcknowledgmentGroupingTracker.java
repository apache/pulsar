...
public class NonPersistentAcknowledgmentGroupingTracker implements AcknowledgmentsGroupingTracker {
    ...
    @Override
    public void addAcknowledgment(MessageIdImpl msgId, AckType ackType, Map<String, Long> properties, TransactionImpl txnImpl) {
        // no-op
    }
    ...
    @Override
    public void addBatchIndexAcknowledgment(BatchMessageIdImpl msgId, int batchIndex, int batchSize, AckType ackType, Map<String, Long> properties, TransactionImpl transaction) {
        // no-op
    }
