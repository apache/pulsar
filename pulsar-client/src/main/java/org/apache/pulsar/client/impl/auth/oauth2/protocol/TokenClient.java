...
public class TokenClient implements ClientCredentialsExchanger {
    ...
    public TokenResult exchangeClientCredentials(ClientCredentialsExchangeRequest req)
        ...
        try {
            ...
            case 200:
                return ObjectMapperFactory.getInstance().reader().readValue(res.getResponseBodyAsBytes(),
                        TokenResult.class);

            case 400: // Bad request
            case 401: // Unauthorized
                throw new TokenExchangeException(
                        ObjectMapperFactory.getInstance().reader().readValue(res.getResponseBodyAsBytes(),
                                TokenError.class));
