...
|nonContiguousDeletedMessagesRanges| The number of non-contiguous deleted message ranges.|
|nonContiguousDeletedMessagesRangesSerializedSize| The serialized size of non-contiguous deleted message ranges.|
...
|msgRateRedeliver| The total rate of messages redelivered on this subscription (msg/s).|
...
|msgDelayed| The number of delayed messages that are currently being tracked.|
...
|bytesOutCounter| The total bytes delivered to a consumer.|
|msgOutCounter| The total messages delivered to a consumer.|
|msgRateRedeliver| The total rate of messages redelivered by this consumer (msg/s).|
...
|currentLedgerSize| The size in bytes of messages written to ledger that is currently open for writing.|
...
|lastConfirmedEntry| The `ledgerid:entryid` of the last message that is written successfully. If the `entryid` is `-1`, then the ledger is opened or is being currently opened but has no entries written yet.|
