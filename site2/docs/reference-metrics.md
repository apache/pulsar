...
| pulsar_schema_get_ops_failed_count | Counter | Number of get schema failed operations. |
| pulsar_schema_put_ops_failed_count | Counter | Number of put schema failed operations. |
