...
- **Sink** metrics
  ...
  | Name | Type | Description |
  |---|---|---|
  pulsar_sink_written_total|Counter| Total number of records processed by a sink. 
  pulsar_sink_written_total_1min|Counter| Total number of records processed by a sink in the last 1 minute.
  pulsar_sink_received_total_1min|Counter| Total number of messages that a sink has received from Pulsar topics in the last 1 minute. 
  pulsar_sink_received_total|Counter| Total number of records that a sink has received from Pulsar topics. 
  pulsar_sink_last_invocation|Gauge|The timestamp of the last invocation of the sink.
  pulsar_sink_sink_exception|Gauge|Exception from a sink.
  pulsar_sink_sink_exceptions_total|Counter|Total number of sink exceptions.
  pulsar_sink_sink_exceptions_total_1min |Counter|Total number of sink exceptions in the last 1 minute.
  pulsar_sink_system_exception|Gauge|Exception from system code.
  pulsar_sink_system_exceptions_total|Counter|Total number of system exceptions.
  pulsar_sink_system_exceptions_total_1min|Counter|Total number of system exceptions in the last 1 minute.
  pulsar_sink_user_metric_ | Summary|User defined metric.
