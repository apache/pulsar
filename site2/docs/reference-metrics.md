...
| pulsar_ml_cache_hits_throughput | Gauge | The amount of data is retrieved from the cache (in byte/s) on the broker side.  |
| pulsar_ml_cache_misses_rate | Gauge | The number of cache misses per second on the broker side. |
| pulsar_ml_cache_misses_throughput | Gauge | The amount of data is retrieved from the cache (in byte/s) on the broker side. |
