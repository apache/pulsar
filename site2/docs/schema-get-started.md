...
Producers and consumers need some kind of mechanism for coordinating types at the topic level to avoid various potential problems from arising. For example, serialization and deserialization issues. 
