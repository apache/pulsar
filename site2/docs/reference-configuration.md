...
| additionalServlets | The additional servlet name, multiple additionalServlets are separated by commas. For example: additionalServlet_1, additionalServlet_2 | N/A |
