...
|loadBalancerLoadManagerStrategy | The load manager strategy of load balance. <br /><br />Available values: <li>`LeastLongTermMessageRate`</li><li>`ThresholdLoadManagerStrategy`</li> |`LeastLongTermMessageRate`
