...
|loadBalancerLoadManagerStrategy | The load manager strategy of load balance. <br /><br />Available values: <li>`org.apache.pulsar.broker.loadbalance.impl.LeastLongTermMessageRate`</li><li>`org.apache.pulsar.broker.loadbalance.impl.ThresholdLoadManagerStrategy`</li> |`org.apache.pulsar.broker.loadbalance.impl.LeastLongTermMessageRate`
