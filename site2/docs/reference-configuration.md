...
|saslJaasServerRoleTokenSignerSecret|Secret for SaslRoleTokenSigner. By default, it is set to `SaslConstants.JAAS_DEFAULT_ROLE_TOKEN_SIGNER_SECRET`, which is "PulsarSecret".|PulsarSecret|
