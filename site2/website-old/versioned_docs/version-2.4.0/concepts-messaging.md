---
id: version-2.4.0-concepts-messaging
...
In the diagram below, Consumer-C-1 is the master consumer while Consumer-C-2 would be the next consumer in line to receive messages if Consumer-C-1 is disconnected.
