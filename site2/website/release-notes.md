...
### Misc
- [Authorization] AuthorizationService should use provider's canLookupAsync method. [11777](https://github.com/apache/pulsar/pull/11777)
...
- Avoid trying to refresh MetadataCaches when we're disconnected from ZK. [12120](https://github.com/apache/pulsar/pull/12120)
...
- Ensure the ownership cache lock expiring triggers an unload. [12194](https://github.com/apache/pulsar/pull/12194)
- BookkeeperClientFactory should pass in the ZK instance. [12192](https://github.com/apache/pulsar/pull/12192)
- ModularLoadManager should not attempt to update the load report on ZK if we're not connected. [12191](https://github.com/apache/pulsar/pull/12191)
...
- [issue-12272] PulsarAuthorizationProvider initialization. [12273](https://github.com/apache/pulsar/pull/12273)
...
- [pulsar-server] support v1 api to create non-partition topic. [12122](https://github.com/apache/pulsar/pull/12122)
- [pulsar-broker] support remove-ttl api for V1 namespace. [12121](https://github.com/apache/pulsar/pull/12121)
- [Issue 1240][C++] Support setting ConsumerEventListener in pulsar cpp client. [12118](https://github.com/apache/pulsar/pull/12118)
...
- [PIP-92] Part-1: Separate Topic Policies into a separate class. [12034](https://github.com/apache/pulsar/pull/12034)
- Avoid adding duplicated BrokerEntryMetadata. [12018](https://github.com/apache/pulsar/pull/12018)
- Remove deprecated netty allocator tiny size. [12012](https://github.com/apache/pulsar/pull/12012)
- [Standalone] Fix the assignment of a custom stream-storage-port number. [11995](https://github.com/apache/pulsar/pull/11995)
...
- [Issue #11799][logging] PIP-89: Timed log events. [11944](https://github.com/apache/pulsar/pull/11944)
- [Issue 11936] forget to call SendCallback on producer close. [11939](https://github.com/apache/pulsar/pull/11939)
- [website][upgrade]feat: pulsar functions docs migratin for version next/2.8.0/2.7.3. [11938](https://github.com/apache/pulsar/pull/11938)
- Avoid to infinitely split bundle. [11937](https://github.com/apache/pulsar/pull/11937)
- Update the default log pattern. [11935](https://github.com/apache/pulsar/pull/11935)
- [Transaction] add method to clear up transaction buffer snapshot. [11934](https://github.com/apache/pulsar/pull/11934)
- [website][upgrade] inject link plugin implement. [11929](https://github.com/apache/pulsar/pull/11929)
- Fix messages in TopicPolicies will never be cleaned up. [11928](https://github.com/apache/pulsar/pull/11928)
- Use ZK "container" types for intermediate z-nodes. [11925](https://github.com/apache/pulsar/pull/11925)
...
- [doc] update terminate topic docs, since terminate is not support for non-p…. [11907](https://github.com/apache/pulsar/pull/11907)
- Forget to update memory usage on producer close. [11906](https://github.com/apache/pulsar/pull/11906)
- [Broker] Add verification when terminating non-persistent topic. [11903](https://github.com/apache/pulsar/pull/11903)
- [Issue #11799][logging] Base implementation of structured logging. [11901](https://github.com/apache/pulsar/pull/11901)
- [C++] Fix incorrect connect timeout implementation. [11889](https://github.com/apache/pulsar/pull/11889)
- [Python] Ensure producer is keeping the client object alive. [11887](https://github.com/apache/pulsar/pull/11887)
- [Client] Fix ConcurrentModificationException in sendAsync. [11884](https://github.com/apache/pulsar/pull/11884)
- Added MetadataStore deleteRecursive operation. [11867](https://github.com/apache/pulsar/pull/11867)
...
- [IO] Set the output message key when the source record has a key. [11822](https://github.com/apache/pulsar/pull/11822)
- [Functions] ConcurrentHashMap should be used for caching producers. [11820](https://github.com/apache/pulsar/pull/11820)
- [Client] Set key in message metadata for batch message built with KEY_BASED batch builder. [11816](https://github.com/apache/pulsar/pull/11816)
- [pulsar-client-tools] fix packages tool parameter desc. [11809](https://github.com/apache/pulsar/pull/11809)
...
- [Broker] Remove unnecessary futures; fix comment. [11776](https://github.com/apache/pulsar/pull/11776)
...
- [Broker] Handle NPE and memory leak when full key range isn't covered with active consumers. [11749](https://github.com/apache/pulsar/pull/11749)
- [Broker] Call .release() when discarding entry to prevent direct memory leak. [11748](https://github.com/apache/pulsar/pull/11748)
- Avoid duplicated disconnecting producer when after add entry failed.. [11741](https://github.com/apache/pulsar/pull/11741)
...
- Switch from deprecated Slf4jRequestLog to CustomRequestLog. [11733](https://github.com/apache/pulsar/pull/11733)
- [Broker] Remove subscription when closing Reader on non-persistent topics. [11731](https://github.com/apache/pulsar/pull/11731)
- PIP 83 : Pulsar Reader: Message consumption with pooled buffer. [11725](https://github.com/apache/pulsar/pull/11725)
- [server] Fixed Casting Error. [11697](https://github.com/apache/pulsar/pull/11697)
- Refactored PulsarResources to avoid building metadata paths everywhere. [11693](https://github.com/apache/pulsar/pull/11693)
...
- [Issue 11689][Client] Fixed block forever bug in Consumer.batchReceive. [11691](https://github.com/apache/pulsar/pull/11691)
...
- [server] Allow broker to start with default backlogquota in bytes. [11671](https://github.com/apache/pulsar/pull/11671)
- [Issue 11632][C++] Turning on more compiler warnings, and enforcing warnings as errors. [11668](https://github.com/apache/pulsar/pull/11668)
- [pulsar-admin] allow create functions with package URL. [11666](https://github.com/apache/pulsar/pull/11666)
- Use getIfValid to avoid handleMetadataStoreNotification swallow exception. [11656](https://github.com/apache/pulsar/pull/11656)
- Check null or empty instead of catch NPE. [11655](https://github.com/apache/pulsar/pull/11655)
- [Broker Interceptor] Fix Pulsar didn't respond error messages when throw InterceptException. [11650](https://github.com/apache/pulsar/pull/11650)
- [PIP-82] [pulsar-broker] Use the qualified NS-name in RG-register/unr…. [11643](https://github.com/apache/pulsar/pull/11643)
- [Enhancement] avoid duplicate deletion of schema. [11640](https://github.com/apache/pulsar/pull/11640)
- Sync up C error code with C++. [11633](https://github.com/apache/pulsar/pull/11633)
- [C++] Fixing use-after-free and constructor bugs in UnAckedMessageTrackerEnabled. [11630](https://github.com/apache/pulsar/pull/11630)
...
- Allow Pulsar Functions / Sinks to pool messages. [11618](https://github.com/apache/pulsar/pull/11618)
- avoid non-durable subscription misuse an existed durable subscription. [11613](https://github.com/apache/pulsar/pull/11613)
- Fix: Cast exception occurs if function/source/sink type is ByteBuffer. [11611](https://github.com/apache/pulsar/pull/11611)
- Fix sink byte buffer. [11610](https://github.com/apache/pulsar/pull/11610)
...
- Add Docs for the new ElasticSearch sink features. [11602](https://github.com/apache/pulsar/pull/11602)
...
- [Docs] Add broker additional servlet configuration. [11590](https://github.com/apache/pulsar/pull/11590)
- [Issue-11449] [docs] Updated Python installation steps for Mac. [11589](https://github.com/apache/pulsar/pull/11589)
- [docs] [issue 8640] Update helm chart link. [11587](https://github.com/apache/pulsar/pull/11587)
- Fix python doc generate. [11585](https://github.com/apache/pulsar/pull/11585)
- [ManagedLedger] Make 'StatsPeroidSeconds' configurable. [11584](https://github.com/apache/pulsar/pull/11584)
- [Issue 11581][broker] feat:pass the executor to RateLimiter in ResourceGroupPublishLimiter. [11582](https://github.com/apache/pulsar/pull/11582)
- [C++] Fix wrong Base64 paddings. [11578](https://github.com/apache/pulsar/pull/11578)
- [Issue 11496][C++] Allow partitioned producers to start lazily. [11570](https://github.com/apache/pulsar/pull/11570)
- [Patch] Fix decode compression managedLedgerInfo data. [11569](https://github.com/apache/pulsar/pull/11569)
...
- [Issue 11558][Python] Check if the record is not None. [11559](https://github.com/apache/pulsar/pull/11559)
- Exposing the broker entry metadata to client. [11553](https://github.com/apache/pulsar/pull/11553)
...
- Update concepts-transactions.md. [11540](https://github.com/apache/pulsar/pull/11540)
...
- [Issue #11523] Check the BrokerInterceptor before de-ref in newMessag…. [11524](https://github.com/apache/pulsar/pull/11524)
- Typo Fix: Capitalization. [11519](https://github.com/apache/pulsar/pull/11519)
- Make getTopicPoliciesAsyncWithRetry as a default method. [11518](https://github.com/apache/pulsar/pull/11518)
- [Issue 11412] Add shutdownGracefully for ManagedLedgerFactoryImpl. [11517](https://github.com/apache/pulsar/pull/11517)
...
- [feature][pulsar-broker]: Add additional servlet support to broker. [11498](https://github.com/apache/pulsar/pull/11498)
- Use equals instead of == to compare strings (#11462). [11497](https://github.com/apache/pulsar/pull/11497)
...
- [Issue 11485][C++] Connect timer cancellation does not call timeout callback. [11486](https://github.com/apache/pulsar/pull/11486)
- Remove unsupport command description in doc. [11479](https://github.com/apache/pulsar/pull/11479)
- [pulsar-io] fix source stats exposing empty exceptions list. [11478](https://github.com/apache/pulsar/pull/11478)
- [Go Functions] Upgrade go client version to 0.6.0. [11477](https://github.com/apache/pulsar/pull/11477)
...
- [Function worker] Load ServiceConfiguration from file, not from Worke…. [11468](https://github.com/apache/pulsar/pull/11468)
- [docs] Update deploy-bare-metal-multi-cluster.md. [11466](https://github.com/apache/pulsar/pull/11466)
...
- [websocket] Remove System.out.println from ConsumerHandler. [11459](https://github.com/apache/pulsar/pull/11459)
...
- [python] Support CryptoKeyReader for Reader API in python clients. [11447](https://github.com/apache/pulsar/pull/11447)
...
- [Broker] Fix producing messages when preciseTopicPublishRateLimiterEnable=true. [11442](https://github.com/apache/pulsar/pull/11442)
- [PIP-88] Replicate schemas across clusters. [11441](https://github.com/apache/pulsar/pull/11441)
...
- Generate documentation of PulsarProxy automatically. [11421](https://github.com/apache/pulsar/pull/11421)
- [Doc] Add schema examples for Java client. [11420](https://github.com/apache/pulsar/pull/11420)
- Generate documentation of Client automatically. [11419](https://github.com/apache/pulsar/pull/11419)
...
- [Docs]Update Kubernetes (Helm). [11406](https://github.com/apache/pulsar/pull/11406)
...
- [pulsar-function] Stop calling the deprated method Thread.stop when stopping the function thread in ThreadRuntime.. [11401](https://github.com/apache/pulsar/pull/11401)
- [Python Client] Fix handle complex schema. [11400](https://github.com/apache/pulsar/pull/11400)
- [pulsar function] add instanceId and fqn into log message properties. [11399](https://github.com/apache/pulsar/pull/11399)
- [issues 11397][Docs] make java code sample match the actual API. [11398](https://github.com/apache/pulsar/pull/11398)
- [Broker] Fix replicated subscriptions direct memory leak. [11396](https://github.com/apache/pulsar/pull/11396)
- Issue 11338: add documentation about the upgrade of Pulsar 2.8.0. [11392](https://github.com/apache/pulsar/pull/11392)
- Invalidate the read handle after all cursors consumed.. [11389](https://github.com/apache/pulsar/pull/11389)
- [C++] Support protobuf native schema. [11388](https://github.com/apache/pulsar/pull/11388)
- Fix NPE when builtin connector does not exist.. [11385](https://github.com/apache/pulsar/pull/11385)
- [broker] Fixed Replicated Subscription isn't replicate new subscription when remote producer is closed. [11382](https://github.com/apache/pulsar/pull/11382)
- Fix issue in CLI when validating batch source config. [11378](https://github.com/apache/pulsar/pull/11378)
- Disable replicate system topic across clusters.. [11376](https://github.com/apache/pulsar/pull/11376)
- [Issue #11351] Parallel Precise Publish Rate Limiting Fix. [11372](https://github.com/apache/pulsar/pull/11372)
- Generate documentation of ServiceDiscovery automatically. [11369](https://github.com/apache/pulsar/pull/11369)
- [Transaction] Transaction coordinator fence mechanism.. [11357](https://github.com/apache/pulsar/pull/11357)
...
- [ISSUE #11351] separate Rate Limiter Implementation to LeakyBucket and FixedWindow. [11352](https://github.com/apache/pulsar/pull/11352)
- Avoid infinite waiting for consumer close. [11347](https://github.com/apache/pulsar/pull/11347)
- [Issue 11340] Fix concurrency issues in NarUnpacker. [11343](https://github.com/apache/pulsar/pull/11343)
- Close the replicator and replication client when delete cluster.. [11342](https://github.com/apache/pulsar/pull/11342)
- [Broker] Add multi roles support for authorization. [11341](https://github.com/apache/pulsar/pull/11341)
- Add missing parameters for pulsar-perf. [11337](https://github.com/apache/pulsar/pull/11337)
- [Go Functions] Upgrade the go client version to 0.5.0. [11336](https://github.com/apache/pulsar/pull/11336)
- Add docs about how to use stateful functions in pulsar. [11335](https://github.com/apache/pulsar/pull/11335)
- [function] set subscription name for go function runtime. [11332](https://github.com/apache/pulsar/pull/11332)
- [PIP-82] [pulsar-broker] updates to resource-group stats:. [11331](https://github.com/apache/pulsar/pull/11331)
- PIP-45: Converted ResourceQuotaCache. [11330](https://github.com/apache/pulsar/pull/11330)
- [C++] Avoid throwing exceptions when setting socket option. [11329](https://github.com/apache/pulsar/pull/11329)
- [website][pulsar]: auto generate docs for pulsar subcommand: delete-cluster-metadata. [11328](https://github.com/apache/pulsar/pull/11328)
- [website][pulsar]: auto generate docs for pulsar subcommand: initialize-cluster-metadata. [11327](https://github.com/apache/pulsar/pull/11327)
- [website][pulsar]: auto generate docs for pulsar subcommand: functions-worker. [11326](https://github.com/apache/pulsar/pull/11326)
...
- fix required params to set-retention. [11319](https://github.com/apache/pulsar/pull/11319)
- [pulsar-doc] Document pulsar-kafka adapter encryption support. [11317](https://github.com/apache/pulsar/pull/11317)
- When delete a topic, delete the topic policy together.. [11316](https://github.com/apache/pulsar/pull/11316)
- expose producer name to getMessageById for Admin API. [11312](https://github.com/apache/pulsar/pull/11312)
- [DOCS] function worker docs enhancement. [11311](https://github.com/apache/pulsar/pull/11311)
...
- [tools] Pulsar Client: add ability to produce KV messages. [11303](https://github.com/apache/pulsar/pull/11303)
- Admin Tool: fix batch size < 0 erro when peekmessage. [11301](https://github.com/apache/pulsar/pull/11301)
- [documentation] Remove duplicate section in Messaging > Consumers > Acknowledgement. [11296](https://github.com/apache/pulsar/pull/11296)
- Fix using partitioned topic name to get Policy. [11294](https://github.com/apache/pulsar/pull/11294)
- [IO] Pass client builder to debezium database history. [11293](https://github.com/apache/pulsar/pull/11293)
- Fixed retention of keys in compaction. [11287](https://github.com/apache/pulsar/pull/11287)
- Remove Pulsar Dashboard. [11284](https://github.com/apache/pulsar/pull/11284)
...
- Update README.md. [11275](https://github.com/apache/pulsar/pull/11275)
- Support new topic format for broker admin healthcheck endpoint.. [11268](https://github.com/apache/pulsar/pull/11268)
- PIP-45: Removed direct ZK access from BrokerService. [11267](https://github.com/apache/pulsar/pull/11267)
- Fix typo and duplicate config doc entries. [11266](https://github.com/apache/pulsar/pull/11266)
- PIP-45: Removed localZkCache access from AdminResource. [11265](https://github.com/apache/pulsar/pull/11265)
- Fix missing replicator metrics. [11264](https://github.com/apache/pulsar/pull/11264)
- Enhanced ElasticSearch Sink (TLS, Auth, KeyValue Schema, INSERT/UPDATE/DELETE, "_id" management, multi index support). [11263](https://github.com/apache/pulsar/pull/11263)
- Add annotations for ClientConfigurationData. [11258](https://github.com/apache/pulsar/pull/11258)
- Generate documentation of webSocket automatically. [11256](https://github.com/apache/pulsar/pull/11256)
...
- [pulsar-io] pass the pulsar service url to debezium source for history database. [11251](https://github.com/apache/pulsar/pull/11251)
- [hotfix] simplify code. [11248](https://github.com/apache/pulsar/pull/11248)
- Pulsar Adapters: add download section (only source tarball). [11247](https://github.com/apache/pulsar/pull/11247)
- Fix exception typo. [11245](https://github.com/apache/pulsar/pull/11245)
...
- Fix incorrect usage of localrun command in ES sink. [11240](https://github.com/apache/pulsar/pull/11240)
- [Doc] Add explanations for partition key. [11239](https://github.com/apache/pulsar/pull/11239)
- [Issue 11007] Schema.NATIVE_AVRO: add a version of AUTO_PRODUCE_BYTES that doesn't validate the message in `encode`. [11238](https://github.com/apache/pulsar/pull/11238)
- [docs]Update getting-started-standalone.md. [11236](https://github.com/apache/pulsar/pull/11236)
- [Doc] Add guides for Transactions. [11235](https://github.com/apache/pulsar/pull/11235)
- Fix init WebSocketService with ClusterData. [11234](https://github.com/apache/pulsar/pull/11234)
- [website][pulsar]generate html pages for pulsar command. [11232](https://github.com/apache/pulsar/pull/11232)
- [website][pulsar]generate docs for pulsar subcommand: tokens. [11231](https://github.com/apache/pulsar/pull/11231)
- [website][pulsar]generate docs for pulsar subcommand: compact-topic. [11230](https://github.com/apache/pulsar/pull/11230)
- [website][pulsar]generate docs for pulsar subcommand: broker-tool. [11229](https://github.com/apache/pulsar/pull/11229)
- [website][pulsar][broker]generate docs for pulsar subcommand - broker. [11228](https://github.com/apache/pulsar/pull/11228)
- [website][common]common util for generate docs. [11225](https://github.com/apache/pulsar/pull/11225)
- Add a usage example for redis sink. [11222](https://github.com/apache/pulsar/pull/11222)
- [fix master build] use `entryTimestamp` for expiry checking in `internalGetMessageIdByTimestamp`. [11220](https://github.com/apache/pulsar/pull/11220)
- [website][pulsar] supported auto generate html docs for pulsar command. [11219](https://github.com/apache/pulsar/pull/11219)
- [docs]Update getting-started-docker.md. [11218](https://github.com/apache/pulsar/pull/11218)
- PIP-45: Changed Topic initialization to use MetadataStore and to be fully async. [11217](https://github.com/apache/pulsar/pull/11217)
- Remove unused listener to reduce creating executor pool. [11215](https://github.com/apache/pulsar/pull/11215)
- fix: python client docs consumer example code missing client object. [11214](https://github.com/apache/pulsar/pull/11214)
- fix: incorrect command in helm-deploy docs. [11213](https://github.com/apache/pulsar/pull/11213)
- PIP-45: Converted bookies REST endpoint to use metadata store. [11210](https://github.com/apache/pulsar/pull/11210)
- Generate documentation of broker automatically.. [11208](https://github.com/apache/pulsar/pull/11208)
- Make the compaction phase one loop timeout configurable. [11206](https://github.com/apache/pulsar/pull/11206)
- [Issue 8502] Upgrade Debezium to a newer version. [11204](https://github.com/apache/pulsar/pull/11204)
- Fixed using CommandSubscribe.getConsumerName() without checking. [11199](https://github.com/apache/pulsar/pull/11199)
- Use ZK persistent watches. [11198](https://github.com/apache/pulsar/pull/11198)
- remove legacy znode when delete namespace or tenant forcefully. [11196](https://github.com/apache/pulsar/pull/11196)
...
- [Doc] fix pulsar admin website format. [11189](https://github.com/apache/pulsar/pull/11189)
- Fix some typos of the PersistentTopics. [11187](https://github.com/apache/pulsar/pull/11187)
- [PIP-82] [pulsar-broker] Add publish ratelimiter to resource group. [11184](https://github.com/apache/pulsar/pull/11184)
- Fix the dead lock when using hasMessageAvailableAsync and readNextAsync. [11183](https://github.com/apache/pulsar/pull/11183)
- [website][pulsar-client/pulsar-perf] pulsar-client and pulsar-perf cli doc command flag duplicated. [11182](https://github.com/apache/pulsar/pull/11182)
- [C++] fix regex namespace to avoid core dump. [11179](https://github.com/apache/pulsar/pull/11179)
- fix compaction entry read exception. [11175](https://github.com/apache/pulsar/pull/11175)
- add a note about parameter plugin.name. [11174](https://github.com/apache/pulsar/pull/11174)
- fix: python client docs missing pular pkg import code. [11173](https://github.com/apache/pulsar/pull/11173)
...
- Adjust the implementation of getDynamicConfigurationDouble and DynamicConfigurationBoolean. [11171](https://github.com/apache/pulsar/pull/11171)
- [website][pulsar-perf] Support auto generate html page for pulsar perf cli tool. [11169](https://github.com/apache/pulsar/pull/11169)
- [ Functions ] Fixed some incorrect usage methods.. [11167](https://github.com/apache/pulsar/pull/11167)
- Add a call ACK / unack example to avoid confusing the retrial mechani…. [11166](https://github.com/apache/pulsar/pull/11166)
- [feat][website] add local debugging tools shell for website. [11160](https://github.com/apache/pulsar/pull/11160)
- [WIP] Fix reading compacted data with the earliest start position by using Reader API. [11159](https://github.com/apache/pulsar/pull/11159)
- [C++] Fix missed header for some compilers. [11152](https://github.com/apache/pulsar/pull/11152)
- fix: pulsar admin/client cli docs jump incorrect. [11151](https://github.com/apache/pulsar/pull/11151)
- [Doc] Add descriptions for various API docs. [11146](https://github.com/apache/pulsar/pull/11146)
- remove import regex format. [11144](https://github.com/apache/pulsar/pull/11144)
- add parameter to control publish message check policy frequency. [11141](https://github.com/apache/pulsar/pull/11141)
- [Issue 10896] add get message id by timestamp. [11139](https://github.com/apache/pulsar/pull/11139)
- [Broker/Bookie] Set -Dio.netty.tryReflectionSetAccessible=true for pulsar processes. [11138](https://github.com/apache/pulsar/pull/11138)
- [docs] backport debezium source docu. [11137](https://github.com/apache/pulsar/pull/11137)
- fix replay topic policy message not work. [11136](https://github.com/apache/pulsar/pull/11136)
- [Broker] Fix broker dispatch byte rate limiter.. [11135](https://github.com/apache/pulsar/pull/11135)
...
- [ Issues 11103 ] Fixed Compile error. [11104](https://github.com/apache/pulsar/pull/11104)
...
- [Issue 10579] Fix inputs to return a list of topic. [11094](https://github.com/apache/pulsar/pull/11094)
...
- Support socks5 proxy. [11085](https://github.com/apache/pulsar/pull/11085)
- [C++] Fix Windows 32 bits compile and runtime failures. [11082](https://github.com/apache/pulsar/pull/11082)
- [python functions] use keyword argument to create `pulsar_client`. [11080](https://github.com/apache/pulsar/pull/11080)
- [Issue 10975][config]add 'brokerDeleteInactivePartitionedTopicMetadataEnabled' in conf/standalone.conf. [11078](https://github.com/apache/pulsar/pull/11078)
- [Issue 11075][Python] Use the subscription name defined in function details. [11076](https://github.com/apache/pulsar/pull/11076)
- clear redundant code. [11071](https://github.com/apache/pulsar/pull/11071)
...
- [docs] Capitalize sidebar headers. [11060](https://github.com/apache/pulsar/pull/11060)
...
- [Broker] Fixed the incorrectly used logger.. [11047](https://github.com/apache/pulsar/pull/11047)
...
- [Security] Exclude grpc-okhttp dependency and set okhttp3 & okio version. [11025](https://github.com/apache/pulsar/pull/11025)
- [PIP-82] [pulsar-broker] Resource group metrics. [11024](https://github.com/apache/pulsar/pull/11024)
...
- Do not expose meaningless stats for consumer.. [11005](https://github.com/apache/pulsar/pull/11005)
...
- [Issue 10996] release multiTopicsConsumerImpl when unsubscribe. [10997](https://github.com/apache/pulsar/pull/10997)
- [issue 10989 ] Java Client: KeyValueSchema with AutoConsume component - make it work if the topic schema is still not set. [10995](https://github.com/apache/pulsar/pull/10995)
- [python-client] Fixed crash when using Python logger. [10981](https://github.com/apache/pulsar/pull/10981)
- [Broker] Fix direct memory leak in getLastMessageId. [10977](https://github.com/apache/pulsar/pull/10977)
- [Transaction] Transaction coordinator client connect add response command.. [12301](https://github.com/apache/pulsar/pull/12301)
- [Transaction] Transaction buffer take snapshot max read position. [12219](https://github.com/apache/pulsar/pull/12219)
