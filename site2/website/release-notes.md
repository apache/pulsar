...
- Fix topic ownership is not checked when get topic policy [#9781](https://github.com/apache/pulsar/pull/9781)
...
- Fix master broker while subscribe to non-persistent partitioned topic without topic auto-creation [#9107](https://github.com/apache/pulsar/pull/9107)
...
- Execute removing non-persistent subscription of topic from different thread to avoid deadlock when removing inactive subscriptions [#8820](https://github.com/apache/pulsar/pull/8820)
...
- Inform user when expire message request is not executed. [#9561](https://github.com/apache/pulsar/pull/9561)
