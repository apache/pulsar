...
- [Security] Upgrade protobuf to 3.16.1 to address CVE-2021-22569 [#13695](https://github.com/apache/pulsar/pull/13695)
- [Security] Upgrade Jackson to 2.12.6 [#13694](https://github.com/apache/pulsar/pull/13694)
- [Security] Upgrade Log4j to 2.17.1 to address CVE-2021-44832 [#13552](https://github.com/apache/pulsar/pull/13552)
...
- [security] Upgrade Postgre driver to 42.2.25 to get rid of CVE-2022-21724 [#14119](https://github.com/apache/pulsar/pull/14119)
...
- [Tests] Fix thread leak in MLTransactionMetadataStore [#14524](https://github.com/apache/pulsar/pull/14524)
- fix npe in ManagedLedgerImpl [#14481](https://github.com/apache/pulsar/pull/14481)
- [Broker] Fix ``Future.join()`` causing deadlock. [#14469](https://github.com/apache/pulsar/pull/14469)
- [Broker] Fix Broker HealthCheck Endpoint Exposes Race Conditions [#14367](https://github.com/apache/pulsar/pull/14367)
- Validate rack name [#14336](https://github.com/apache/pulsar/pull/14336)
- [pulsar-broker] Fix avg-messagePerEntry metrics for consumer [#14330](https://github.com/apache/pulsar/pull/14330)
- Fix the wrong parameter in the log. [#14309](https://github.com/apache/pulsar/pull/14309)
- Fix batch ack count is negtive issue. [#14288](https://github.com/apache/pulsar/pull/14288)
...
- [Broker] Change broker producer fence log level [#14196](https://github.com/apache/pulsar/pull/14196)
- [Issue 14105] Avoid creating any topics in `NamespaceService#checkTopicExists` during topic lookup. [#14134](https://github.com/apache/pulsar/pull/14134)
- Fix NPE of cumulative ack mode and incorrect unack message count [#14021](https://github.com/apache/pulsar/pull/14021)
- Fixes NPE - ``ReplicatedSubscriptionsController`` send marker message when enable deduplicated. [#14017](https://github.com/apache/pulsar/pull/14017)
...
- Fixed handling of consumers with equal names on on key shared selector with consistent hashing [#13991](https://github.com/apache/pulsar/pull/13991)
- Trim configuration value string which contains blank prefix or suffix [#13984](https://github.com/apache/pulsar/pull/13984)
- [Broker] waitingCursors potential  heap memory leak  [#13939](https://github.com/apache/pulsar/pull/13939)
- [Broker] Fix read schema compatibility strategy priority [#13938](https://github.com/apache/pulsar/pull/13938)
- [Branch-2.9] Fix SystemTopicBasedTopicPoliciesService NPE issue. [#13840](https://github.com/apache/pulsar/pull/13840)
- NPE when get isAllowAutoUploadSchema [#13831](https://github.com/apache/pulsar/pull/13831)
- [broker] Fix topic produced through REST not support Authorization [#13771](https://github.com/apache/pulsar/pull/13771)
...
- [broker] Fix inefficient forEach loop [#13742](https://github.com/apache/pulsar/pull/13742)
- [Issuse 13640][broker] Fix non persistent topic subscription error. [#13685](https://github.com/apache/pulsar/pull/13685)
...
- [issue #13439][backlogQuota] Allow both limit and limitsize be null [#13557](https://github.com/apache/pulsar/pull/13557)
- [pulsar-broker] The log prints NamespaceService#isServiceUnitActive exception stack information. [#13553](https://github.com/apache/pulsar/pull/13553)
...
- [Broker] Fix race conditions in closing producers and consumers [#13428](https://github.com/apache/pulsar/pull/13428)
- [Issue 12726] [broker] Fix deadlock in metadata-store callback thread for branch 2.9 [#13426](https://github.com/apache/pulsar/pull/13426)
- [Broker] Remove check resource when delete failure domain [#13421](https://github.com/apache/pulsar/pull/13421)
- [Broker] Fix create the dynamic configuration resource if not exist [#13420](https://github.com/apache/pulsar/pull/13420)
...
- [Broker] Modify return result of NamespacesBase#internalGetPublishRate [#13237](https://github.com/apache/pulsar/pull/13237)
...
- [pulsar-broker] clean up active consumer on already closed connection [#13196](https://github.com/apache/pulsar/pull/13196)
...
- [Broker] Don't attempt to delete pending ack store unless transactions are enabled [#13041](https://github.com/apache/pulsar/pull/13041)
- [Issue 13004] Fix race condition in ResourceLockImpl#revalidate [#13006](https://github.com/apache/pulsar/pull/13006)
- [Broker] Fix NPE in `PersistentTopic.checkSubscriptionTypesEnable` [#12961](https://github.com/apache/pulsar/pull/12961)
- Fix wrong isEmpty method of ConcurrentOpenLongPairRangeSet [#12953](https://github.com/apache/pulsar/pull/12953)
- [Broker] Correct param of delete method for v1 topic [#12936](https://github.com/apache/pulsar/pull/12936)
- [Broker] Change create topic return error to Status.BAD_REQUEST [#12919](https://github.com/apache/pulsar/pull/12919)
- [broker] Fix topic policy listener deleted by mistake. [#12904](https://github.com/apache/pulsar/pull/12904)
...
- [broker] Bug Fix: topic policy is not properly init if namespace is loaded first. [#12833](https://github.com/apache/pulsar/pull/12833)
- [Issue 12757][broker] add broker config isAllowAutoUpdateSchema [#12786](https://github.com/apache/pulsar/pull/12786)
...
- [pulsar-broker] Handle lookup redirect for V1-topics with different cluster [#12743](https://github.com/apache/pulsar/pull/12743)
...
- [Broker] Fixed wrong behaviour caused by not cleaning up topic policy service state. [#14503](https://github.com/apache/pulsar/pull/14503)
- [Broker] Avoid thread deadlock problem when creating topic policy reader [#13837](https://github.com/apache/pulsar/pull/13837)
- [broker] Bug Fix: topic policy is not properly init if namespace is loaded first. [#13422](https://github.com/apache/pulsar/pull/13422)
- [Schema] Fix parse BigDecimal [#14019](https://github.com/apache/pulsar/pull/14019)
- fix: bug when allAll bucket [#13467](https://github.com/apache/pulsar/pull/13467)
- [Authorization] Support GET_BACKLOG_SIZE topic op after enable auth [#12850](https://github.com/apache/pulsar/pull/12850)
...
#### Transaction
- [Transaction] Fix cursor readPosition is bigger than maxPosition in OpReadEntry [#14667](https://github.com/apache/pulsar/pull/14667)
- Fix MLTransactionMetadataStore.update async fail [#14532](https://github.com/apache/pulsar/pull/14532)
- [Transaction] Fix end transaction at state of timeout [#14370](https://github.com/apache/pulsar/pull/14370)
- [Transaction] Optimize testEndTBRecoveringWhenManagerLedgerDisReadable [#14303](https://github.com/apache/pulsar/pull/14303)
- [Transaction] delete changeMaxReadPositionAndAddAbortTimes when checkIfNoSnapshot [#14276](https://github.com/apache/pulsar/pull/14276)
- [Transaction] Adopt single thread pool in TC [#14238](https://github.com/apache/pulsar/pull/14238)
- [Transaction] Fix send normal message can't change MaxReadPosition [#14192](https://github.com/apache/pulsar/pull/14192)
- [Transaction] Optimize transaction timeout [#14172](https://github.com/apache/pulsar/pull/14172)
- [Transaction] Fix subscription ack transaction marker. [#14170](https://github.com/apache/pulsar/pull/14170)
- [Client][Transaction] Fix OpBase.callback is not called in TransactionMetaStoreHandler#failPendingRequest [#14133](https://github.com/apache/pulsar/pull/14133)
- Fixed deadlock on txn semaphore permit exhaustion [#14131](https://github.com/apache/pulsar/pull/14131)
...
- [Transaction] Fix individual ack with transaction decrease unAckMessageCounnt [#14020](https://github.com/apache/pulsar/pull/14020)
- [Transaction] Resolve the performance bottleneck of TransactionBufferHandle [#13988](https://github.com/apache/pulsar/pull/13988)
- [Transaction] RetryException should not be return [#13828](https://github.com/apache/pulsar/pull/13828)
- [Transaction] Fix recover of TransactionBuffer [#13739](https://github.com/apache/pulsar/pull/13739)
- [Transaction] Duplicate TYPE of Prometheus metrics [#13704](https://github.com/apache/pulsar/pull/13704)
...
- [Transaction] PendingAckHandleImpl handle isInCacheRequest [#13481](https://github.com/apache/pulsar/pull/13481)
- [Branch-2.9] [Transaction] Stop TB recovering with exception [#13425](https://github.com/apache/pulsar/pull/13425)
- Optimize transaction FieldUpdater to static final [#13396](https://github.com/apache/pulsar/pull/13396)
- [Transaction] Delete the redundant code [#13327](https://github.com/apache/pulsar/pull/13327)
- [Transaction] Allow transaction to be committed or aborted in the state of aborting or committing. [#13323](https://github.com/apache/pulsar/pull/13323)
- [Transaction]remove request if can not send [#13308](https://github.com/apache/pulsar/pull/13308)
- [Transaction] Fix generate transactionId some comments [#13234](https://github.com/apache/pulsar/pull/13234)
- [Transaction] Fix transaction sequenceId generate error. [#13209](https://github.com/apache/pulsar/pull/13209)
- [Transaction]No TransactionCoordinatorNotFound, but automatic reconnect [#13135](https://github.com/apache/pulsar/pull/13135)
- [Transaction] Add a check for uninitialized PendingAck [#13088](https://github.com/apache/pulsar/pull/13088)
- Handle exception double [#12881](https://github.com/apache/pulsar/pull/12881)
- [Transaction]stop TP replaying with Exception [#12700](https://github.com/apache/pulsar/pull/12700)
- [Transaction]Stop TB recovering with exception [#12636](https://github.com/apache/pulsar/pull/12636)
- [Transaction]Txn client check timeout [#12521](https://github.com/apache/pulsar/pull/12521)
- [Transaction]Fix maxReadPosition with normal publish [#12386](https://github.com/apache/pulsar/pull/12386)
- [Transaction] Fix bugs, Exception thrower by TB::appendBufferToTxn must be ManagedLedgerException.  [#12376](https://github.com/apache/pulsar/pull/12376)
- [Transaction] Merge transactionBuffer exception into a class [#12358](https://github.com/apache/pulsar/pull/12358)
- [Transaction] Add transaction perf [#11933](https://github.com/apache/pulsar/pull/11933)
- [Transaction] Adopt Single_thread to handle TcClient connecting [#13969](https://github.com/apache/pulsar/pull/13969)
- [Transaction]stop TC replaying with exception [#12705](https://github.com/apache/pulsar/pull/12705)
- [Transaction] Fix performance [#13253](https://github.com/apache/pulsar/pull/13253)

#### Admin
- [Branch-2.9] Fix Broker HealthCheck Endpoint Exposes Race Conditions. [#14658](https://github.com/apache/pulsar/pull/14658)
- [Branch-2.9] Fix delete namespace issue. [#14657](https://github.com/apache/pulsar/pull/14657)
...
- [ Issue 13551 ] FIxed NPE when reset-cursor at a non-existent topic (RestException without cause) [#13573](https://github.com/apache/pulsar/pull/13573)
- [Transaction] Add transaction admin [#13447](https://github.com/apache/pulsar/pull/13447)
- [pulsar-admin] Print topic internal info as formatted json [#12709](https://github.com/apache/pulsar/pull/12709)
- [pulsar-admin] Add --all option to get all version schema of topic [#12535](https://github.com/apache/pulsar/pull/12535)
...
- [pulsar-admin] Add corresponding get command for namespace [#12322](https://github.com/apache/pulsar/pull/12322)
...
#### Proxy
- [Proxy] Fix port exhaustion and connection issues in Pulsar Proxy [#14078](https://github.com/apache/pulsar/pull/14078)
- Allow config of IO and acceptor threads in proxy [#14054](https://github.com/apache/pulsar/pull/14054)
- [Proxy] Prevent leak of unreleased lookupRequestSemaphore permits [#13812](https://github.com/apache/pulsar/pull/13812)
- [Proxy] Fix issue when Proxy fails to start and logs about an uncaught exception [#13171](https://github.com/apache/pulsar/pull/13171)
- Add error log when new jetty client exception [#12840](https://github.com/apache/pulsar/pull/12840)
- [Proxy] Remove unnecessary Pulsar Client usage from Pulsar Proxy [#13836](https://github.com/apache/pulsar/pull/13836)

#### Client
- Fix ConsumerBuilderImpl#subscribeAsync blocks calling thread. [#14433](https://github.com/apache/pulsar/pull/14433)
- Fix adding message to list potential issue [#14377](https://github.com/apache/pulsar/pull/14377)
- [pulsar-client] Fix send to deadLetterTopic not working when reach maxRedeliverCount [#14317](https://github.com/apache/pulsar/pull/14317)
- [client] Fix time unit mismatch in errMsg when producer send fails. [#14299](https://github.com/apache/pulsar/pull/14299)
...
- [Issue 12262][client] Fix consume failure when BatchReceivePolicy#maxNumBytes < message size [#14139](https://github.com/apache/pulsar/pull/14139)
...
- [Client] Fix send chunking message failed when ordering key is set. [#13699](https://github.com/apache/pulsar/pull/13699)
- [Issue 13688][client] Fix send chunking message failed when encryption enabled [#13689](https://github.com/apache/pulsar/pull/13689)
- fixed Producer semaphore permit release issue [#13682](https://github.com/apache/pulsar/pull/13682)
- [pulsar-client] Fix the wrong multi-topic has message available behavior [#13634](https://github.com/apache/pulsar/pull/13634)
...
- [pulsar-client] Fix multi topic reader has message available behavior [#13332](https://github.com/apache/pulsar/pull/13332)
- [Java Client] Improve consumer listener logic [#13273](https://github.com/apache/pulsar/pull/13273)
- [Client] Fix memory leak when message payload processor is configured [#13233](https://github.com/apache/pulsar/pull/13233)
...
- [pulsar-client] Fix pending queue-size stats for batch messages [#12704](https://github.com/apache/pulsar/pull/12704)
...
- Fix race condition of OpSendMsgQueue when publishing messages [#14231](https://github.com/apache/pulsar/pull/14231)
...
- [CAPI] Support setting priority for consumers [#12526](https://github.com/apache/pulsar/pull/12526)
...
- [Issue #12486][Python Client]JsonSchema encoding is not idempotent [#12490](https://github.com/apache/pulsar/pull/12490)
- [Issue #12485][Python Client] cannot use any values that evaluates to False [#12489](https://github.com/apache/pulsar/pull/12489)
...
#### CleanUp
- [clean up] Remove unnecessary boxing unboxing [#12790](https://github.com/apache/pulsar/pull/12790)
...
- [broker] remove useless method "PersistentTopic#getPersistentTopic" [#12655](https://github.com/apache/pulsar/pull/12655)
- optimization：remove unused isTxnMessage [#12472](https://github.com/apache/pulsar/pull/12472)
...
#### Doc
- [Doc] Fix doc for the wrong default value of `maxPendingChunkedMessage` [#14144](https://github.com/apache/pulsar/pull/14144)
- Update notice year. [#13653](https://github.com/apache/pulsar/pull/13653)
- Fix java doc for MultipleListenerValidator [#12389](https://github.com/apache/pulsar/pull/12389)

#### Pulsar SQL
- [Pulsar SQL] Fix PulsarRecordCursor deserialize issue. [#14379](https://github.com/apache/pulsar/pull/14379)
- [Pulsar SQL] support protobuf/timestamp [#13287](https://github.com/apache/pulsar/pull/13287)
- [Pulsar SQL] Handle message null schema version in PulsarRecordCursor [#12809](https://github.com/apache/pulsar/pull/12809)
- [Pulsar SQL] Support query chunked messages feature in Pulsar SQL [#12720](https://github.com/apache/pulsar/pull/12720)
...
- [Presto] Fix issue of mixed SLF4J library versions in presto libs [#13603](https://github.com/apache/pulsar/pull/13603)
...
- Some depdency in integration tests scope should be test [#12696](https://github.com/apache/pulsar/pull/12696)
...
#### Test
- [Flaky-Test] BacklogQuotaManagerTest#testProducerExceptionAndThenUnblockSizeQuota [#14213](https://github.com/apache/pulsar/pull/14213)
- [Flaky-test] BacklogQuotaManagerTest.testConsumerBacklogEvictionTimeQuotaWithEmptyLedger [#13724](https://github.com/apache/pulsar/pull/13724)
- [Tests] Fix flakiness issue when spying ServerCnx [#13608](https://github.com/apache/pulsar/pull/13608)
...
- [Issue 12883] Fix flaky caused by message receive timeout in testBlockBrokerDispatching [#12954](https://github.com/apache/pulsar/pull/12954)
- [Issue 12883] Fix flaky test in PersistentStreamingDispatcherBlockConsumerTest [#12943](https://github.com/apache/pulsar/pull/12943)
- [Issue 12897] Fix flaky test in testReplicatorProducerName [#12898](https://github.com/apache/pulsar/pull/12898)
- JavaInstanceTest should be AssertEquals [#12836](https://github.com/apache/pulsar/pull/12836)
- Flaky tests: ElasticSearchClientTests tests time out [#12694](https://github.com/apache/pulsar/pull/12694)
- Close Zk database on unit tests [#12649](https://github.com/apache/pulsar/pull/12649)
- [Transaction]Optimize the tests extends from TransactionTestBase [#12560](https://github.com/apache/pulsar/pull/12560)
...
- [Flaky-test]: AdminApiTest.testNamespaceSplitBundleConcurrent [#14565](https://github.com/apache/pulsar/pull/14565)
- Add test to ensure correct zk children cache invalidation [#14178](https://github.com/apache/pulsar/pull/14178)
- [Tests] Upgrade Mockito to latest stable 3.x version, 3.12.4 [#13622](https://github.com/apache/pulsar/pull/13622)
- [test] Add @Test annotation to test methods [#12640](https://github.com/apache/pulsar/pull/12640)

#### Build
- [owasp] add suppression for pulsar-package-bookkeeper-storage [#13451](https://github.com/apache/pulsar/pull/13451)
- [owasp] Suppress false positive check for netty-tcnative-classes [#13364](https://github.com/apache/pulsar/pull/13364)
...
#### CI
- [CI] Replace deprecated "adopt" OpenJDK distribution with "temurin" in GitHub Actions config [#12945](https://github.com/apache/pulsar/pull/12945)
...
- [ElasticSearch Sink] Correct @FieldDoc defaultValue for some fields [#12697](https://github.com/apache/pulsar/pull/12697)
