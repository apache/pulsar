...
You can use the [Connector Admin CLI](io-cli.md) to monitor a connector and perform other operations on it.
...
You can use the [Connector Admin CLI](io-cli.md) to delete a connector and perform other operations on it.
...
You can use the [Connector Admin CLI](io-cli.md) to create a sink connector and perform other operations on it.
...
You can use the [Connector Admin CLI](io-cli.md) to stop a connector and perform other operations on it.
...
You can use the [Connector Admin CLI](io-cli.md) to restart a connector and perform other operations on it.
...
You can use the [Connector Admin CLI](io-cli.md) to update a connector and perform other operations on it.
