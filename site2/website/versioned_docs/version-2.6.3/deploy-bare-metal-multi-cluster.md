---
id: version-2.6.3-deploy-bare-metal-multi-cluster
...
Directory | Contains
:---------|:--------
`bin` | [Command-line tools](reference-cli-tools.md) of Pulsar, such as [`pulsar`](reference-cli-tools.md#pulsar) and [`pulsar-admin`](http://pulsar.apache.org/tools/pulsar-admin/)
