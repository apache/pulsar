...
For more information about the command and descriptions, see [here](http://pulsar.apache.org/tools/pulsar-admin/2.7.0-SNAPSHOT/#-em-set-em-).
...
For more information about the command and descriptions, see [here](http://pulsar.apache.org/tools/pulsar-admin/2.7.0-SNAPSHOT/#-em-set-bookie-affinity-group-em-).
