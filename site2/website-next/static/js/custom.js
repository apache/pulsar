...
window.addEventListener("load", function () {
  ...
  if (
    restApiVersions[version][0]["fileName"].indexOf("swaggerfunctions") >= 0
  ) {
  ...
  const restapisMenu =
    ...
    '<li><a href="/admin-rest-api?version=' +
    version +
    "&apiversion=" +
    adminApiVersion +
    '">Admin REST API </a></li>' +
    '<li><a href="/functions-rest-api?version=' +
    version +
    "&apiversion=" +
    functionApiVersion +
    '">Functions </a></li>' +
    '<li><a href="/source-rest-api?version=' +
    version +
    "&apiversion=" +
    sourceApiVersion +
    '">Sources </a></li>' +
    '<li><a href="/sink-rest-api?version=' +
    version +
    "&apiversion=" +
    sinkApiVersion +
    '">Sinks </a></li>' +
    '<li><a href="/packages-rest-api?version=' +
    version +
    "&apiversion=" +
    packagesApiVersion +
    '">Packages </a></li>' +
  ...
  const cliMenu =
    ...
    '<li><a href="/pulsar-admin-cli?version=' +
    version +
    '">Pulsar Admin</a></li>' +
    '<li><a href="/pulsar-client-cli?version=' +
    version +
    '">Pulsar Client</a></li>' +
    '<li><a href="/pulsar-perf-cli?version=' +
    version +
    '">Pulsar Perf</a></li>' +
    '<li><a href="/pulsar-cli?version=' +
    version +
    '">Pulsar</a></li>' +
    "</ul>" +
    "</div>" +
  ...
  if (
    pathName.indexOf("/admin-rest-api") >= 0 ||
  ...
  versionSelect.addEventListener("change", (e) => {
    ...
    changeValueDom.href =
      pathName + "?version=" + version + "&apiversion=" + optionValue;
