...
| allowAutoUpdateSchema | Allow schema to be auto updated. If this is disabled, 'is_allow_auto_update_schema' in namespace policy will be ignored. This is enabled by default.|true|
