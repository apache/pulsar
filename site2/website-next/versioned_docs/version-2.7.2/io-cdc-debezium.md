...
* YAML 
  ...
  archive: "connectors/pulsar-io-debezium-mysql-2.7.2.nar"
  parallelism: 1
...
3. Start the Pulsar Debezium connector in local run mode using one of the following methods.
    ...
    * Use the **JSON** configuration file as shown previously. 
       ...
       Make sure the nar file is available at `connectors/pulsar-io-debezium-mysql-2.7.2.nar`.
...
* YAML 
  ...
  archive: "connectors/pulsar-io-debezium-postgres-2.7.2.nar"
  parallelism: 1
...
3. Start the Pulsar Debezium connector in local run mode using one of the following methods.
   ...
   * Use the **JSON** configuration file as shown previously. 
    ...
    Make sure the nar file is available at `connectors/pulsar-io-debezium-postgres-2.7.2.nar`.
...
* YAML 
  ...
  archive: "connectors/pulsar-io-debezium-mongodb-2.7.2.nar"
  parallelism: 1
...
3. Start the Pulsar Debezium connector in local run mode using one of the following methods.
   ...
   * Use the **JSON** configuration file as shown previously. 
    ...
    Make sure the nar file is available at `connectors/pulsar-io-mongodb-2.7.2.nar`.
