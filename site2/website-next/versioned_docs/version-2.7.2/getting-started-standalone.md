...
* download from the Apache mirror (<a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.2/apache-pulsar-2.7.2-bin.tar.gz" download>Pulsar 2.7.2 binary release</a>)
...
$ tar xvfz apache-pulsar-2.7.2-bin.tar.gz
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.2/connectors" download>Pulsar IO Connectors 2.7.2 release</a>
...
For example, if you download the `pulsar-io-aerospike-2.7.2.nar` connector file, enter the following commands:
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.2/apache-pulsar-offloaders-2.7.2-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.7.2 release</a>
...
// you will find a directory named `apache-pulsar-offloaders-2.7.2` in the pulsar directory
