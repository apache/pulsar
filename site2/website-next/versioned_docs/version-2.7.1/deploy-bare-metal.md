...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.1/connectors" download>Pulsar IO Connectors 2.7.1 release</a>
...
For example, if you download the connector file `pulsar-io-aerospike-2.7.1.nar`:
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.1/apache-pulsar-offloaders-2.7.1-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.7.1 release</a>
...
// you can find a directory named `apache-pulsar-offloaders-2.7.1` in the pulsar directory
