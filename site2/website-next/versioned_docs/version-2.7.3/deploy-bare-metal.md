...
$ tar xvzf apache-pulsar-2.7.3-bin.tar.gz
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.3/connectors" download>Pulsar IO Connectors 2.7.3 release</a>
...
For example, if you download the connector file `pulsar-io-aerospike-2.7.3.nar`:
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.3/apache-pulsar-offloaders-2.7.3-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.7.3 release</a>
...
// you can find a directory named `apache-pulsar-offloaders-2.7.3` in the pulsar directory
