...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.7.3/apache-pulsar-2.7.3-bin.tar.gz" download>Pulsar 2.7.3 binary release</a>
...
* using [wget](https://www.gnu.org/software/wget):
  ...
  $ wget 'https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=pulsar/pulsar-2.7.3/apache-pulsar-2.7.3-bin.tar.gz' -O apache-pulsar-2.7.3-bin.tar.gz
