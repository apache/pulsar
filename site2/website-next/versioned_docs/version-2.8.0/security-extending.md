 ...
 * `Authentication` -> http://pulsar.apache.org/api/client/2.8.0-SNAPSHOT/2.8.0-SNAPSHOT/org/apache/pulsar/client/api/Authentication.html
 * `AuthenticationDataProvider` -> http://pulsar.apache.org/api/client/2.8.0-SNAPSHOT/2.8.0-SNAPSHOT/org/apache/pulsar/client/api/AuthenticationDataProvider.html
