...
* download from the Apache mirror (<a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.0/apache-pulsar-2.6.0-bin.tar.gz" download>Pulsar 2.6.0 binary release</a>)
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.0/connectors" download>Pulsar IO Connectors 2.6.0 release</a>
...
For example, if you download the `pulsar-io-aerospike-2.6.0.nar` connector file, enter the following commands:
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.0/apache-pulsar-offloaders-2.6.0-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.6.0 release</a>
