...
* By clicking on the link below directly, which automatically triggers a download:
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/apache-pulsar-2.6.4-bin.tar.gz" download>Pulsar 2.6.4 binary release</a>
...
$ tar xvzf apache-pulsar-2.6.4-bin.tar.gz
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/connectors" download>Pulsar IO Connectors 2.6.4 release</a>
...
For example, if you download the connector file `pulsar-io-aerospike-2.6.4.nar`:
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/apache-pulsar-offloaders-2.6.4-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.6.4 release</a>
...
// you can find a directory named `apache-pulsar-offloaders-2.6.4` in the pulsar directory
