...
* download from the Apache mirror (<a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/apache-pulsar-2.6.4-bin.tar.gz" download>Pulsar 2.6.4 binary release</a>)
...
$ tar xvfz apache-pulsar-2.6.4-bin.tar.gz
$ cd apache-pulsar-2.6.4
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/connectors" download>Pulsar IO Connectors 2.6.4 release</a>
...
* use [wget](https://www.gnu.org/software/wget):
  ...
  $ wget https://archive.apache.org/dist/pulsar/pulsar-2.6.4/connectors/{connector}-2.6.4.nar
  
  ```

After you download the nar file, copy the file to the `connectors` directory in the pulsar directory. 
For example, if you download the `pulsar-io-aerospike-2.6.4.nar` connector file, enter the following commands:

```bash

$ mkdir connectors
$ mv pulsar-io-aerospike-2.6.4.nar connectors

$ ls connectors
pulsar-io-aerospike-2.6.4.nar
...
...
* download from the Apache mirror <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.4/apache-pulsar-offloaders-2.6.4-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.6.4 release</a>
...
* use [wget](https://www.gnu.org/software/wget):
  ...
  $ wget https://archive.apache.org/dist/pulsar/pulsar-2.6.4/apache-pulsar-offloaders-2.6.4-bin.tar.gz
...
$ tar xvfz apache-pulsar-offloaders-2.6.4-bin.tar.gz

// you will find a directory named `apache-pulsar-offloaders-2.6.4` in the pulsar directory
// then copy the offloaders

$ mv apache-pulsar-offloaders-2.6.4/offloaders offloaders

$ ls offloaders
tiered-storage-jcloud-2.6.4.nar
