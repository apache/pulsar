...
* using [wget](https://www.gnu.org/software/wget):
  ...
  $ wget 'https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=pulsar/pulsar-2.6.3/apache-pulsar-2.6.3-bin.tar.gz' -O apache-pulsar-2.6.3-bin.tar.gz
