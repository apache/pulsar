...
Pulsar Python client library is a wrapper over the existing [C++ client library](client-libraries-cpp) and exposes all of the [same features](/api/cpp/2.6.0-SNAPSHOT/2.6.0-SNAPSHOT). You can find the code in the [`python` subdirectory](https://github.com/apache/pulsar/tree/master/pulsar-client-cpp/python) of the C++ client code.

All the methods in producer, consumer, and reader of a Python client are thread-safe.

[pdoc](https://github.com/BurntSushi/pdoc)-generated API docs for the Python client are available [here](/api/python/2.6.0-SNAPSHOT/2.6.0-SNAPSHOT).
...
The complete Python API reference is available at [api/python](/api/python/2.6.0-SNAPSHOT/2.6.0-SNAPSHOT).
