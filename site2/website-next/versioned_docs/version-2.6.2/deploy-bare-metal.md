...
* By clicking on the link below directly, which automatically triggers a download:
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.2/apache-pulsar-2.6.2-bin.tar.gz" download>Pulsar 2.6.2 binary release</a>
...
$ tar xvzf apache-pulsar-2.6.2-bin.tar.gz
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.2/connectors" download>Pulsar IO Connectors 2.6.2 release</a>
...
* using [wget](https://www.gnu.org/software/wget):
  ...
  $ wget https://archive.apache.org/dist/pulsar/pulsar-2.6.2/connectors/{connector}-2.6.2.nar
  
  ```

Once you download the .nar file, copy the file to directory `connectors` in the pulsar directory. 
For example, if you download the connector file `pulsar-io-aerospike-2.6.2.nar`:

```bash

$ mkdir connectors
$ mv pulsar-io-aerospike-2.6.2.nar connectors

$ ls connectors
pulsar-io-aerospike-2.6.2.nar
...
...
* by clicking the link below and downloading the release from an Apache mirror:
  ...
  * <a href="https://archive.apache.org/dist/pulsar/pulsar-2.6.2/apache-pulsar-offloaders-2.6.2-bin.tar.gz" download>Pulsar Tiered Storage Offloaders 2.6.2 release</a>
...
// you can find a directory named `apache-pulsar-offloaders-2.6.2` in the pulsar directory
