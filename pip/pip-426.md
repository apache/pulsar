...
In [pip-379](https://github.com/apache/pulsar/edit/master/pip/pip-379.md) We achieved the goal: 
...
The core implementation is available in [PR #24396](https://github.com/apache/pulsar/pull/24396)
...
#### In `Consumer.individualAckNormal()`
...
#### In `Consumer.individualAckWithTransaction()`
