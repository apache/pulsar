...
Since more than one component uses Cursor to do **Sequentially Read** or **Message Replay Read**, these components may also have their own attributes that need to be modified atomicity, we should also provide a mechanism to guarantee the atomicity modification of both attributes of Cursor and attributes of other components. 
