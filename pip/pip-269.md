...
In the messages delivery scenario, if **Message Replay Read** and **Cursor Position Reset** are executed concurrently, the consumption will be out of order. For example:
