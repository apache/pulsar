# PIP-488: Add subscription-level storage backlog age metric
...
subscriptions and emits the Prometheus metric for subscriptions whose value is
known.
...
The metric is emitted only when:
