# PIP-434: Expose Netty channel configuration WRITE_BUFFER_WATER_MARK to pulsar conf
...
|------------------------------------------------------|---------------------------------------------------------------------------------------------|--------------| --- |
| `pulsar_server_channel_write_buf_memory_used_bytes` | Counter. The number of replicators.                      | cluster | - |
