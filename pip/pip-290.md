...
| --- | --- | --- | 
| `encryptionKeyValues` | Base64 encoded and URL encoded secret key | `byte[]` |
| `encryptionKeyMetadata` | Base64 encoded and URL encoded and JSON formatted key-value metadata list of encryption key | `List<KeyValue>` |
