...
1. Write the data of cursor metadata to BK in one Entry; by default, the maximum size of the Entry is 5MB.
2. Write the data of cursor metadata to ZK if BK-Write fails; data of a ZK node that is less than 10MB is recommended.
