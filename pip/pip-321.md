...
Let's take a look at more examples to understand the problem of geo-replication at the topic level.
...
Environment: Cluster1 and Cluster2 in different regions sharing the same Zookeeper cluster.

Replication Configuration: Namespace 'ns1' -> Cluster1 (local cluster); 'ns1/topic1' -> Cluster1, Cluster2.

Expected: 'ns1/topic1'  Cluster1 <--> Cluster2.

Actual: 'ns1/topic1' cannot be created at Cluster2.

**Example 2:**

Environment: Cluster1, Cluster2, and Cluster3 in different regions using different Zookeeper clusters.

Replication Configuration: Namespace 'ns1' -> Cluster1/Cluster2/Cluster3 (local cluster); 'ns1/topic1' -> Cluster1, Cluster2, Cluster3; 'ns1/topic2' -> null.

Expected: 'ns1/topic1'  Cluster1 <--> Cluster2 <--> Cluster3.
...
Allowed-Clusters: 'ns1' -> Cluster1, Cluster2

Expected: 'ns1/topic1'  Cluster1 <--> Cluster2.

Actual: 'ns1/topic1' can be created at Cluster2. Replication works as expected.
...
Expected: 'ns1/change_event'  Cluster1 <--> Cluster2 <--> Cluster3.

Actual: 'ns1/change_event' does not have a replication configuration, so the topic policies will not be replicated.
...
Topic-Policy-Synchronized-Clusters: 'ns1' -> Cluster1, Cluster2, Cluster3

Expected: 'ns1/change_event'  Cluster1 <--> Cluster2 <--> Cluster3.

Actual: Topic policies can work as expected.
