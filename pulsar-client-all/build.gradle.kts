...
description = "Pulsar Client All (Shaded)"
...
tasks.shadowJar {
    // Same relocations as pulsar-client-shaded plus admin relocations
    ...
    relocate("com.sun.activation", "org.apache.pulsar.shade.com.sun.activation")
    relocate("com.thoughtworks.paranamer", "org.apache.pulsar.shade.com.thoughtworks.paranamer")
    ...
    relocate("org.codehaus.jackson", "org.apache.pulsar.shade.org.codehaus.jackson")
    ...
    relocate("org.tukaani", "org.apache.pulsar.shade.org.tukaani")
