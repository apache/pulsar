 ...
 * under the License.
 */
package org.apache.pulsar.grpc.service;
...
public class GrpcProxyConfiguration implements PulsarConfiguration {
    ...
    // Number of threads used by Grpc service
    public static final int GRPC_SERVICE_THREADS = 20;
