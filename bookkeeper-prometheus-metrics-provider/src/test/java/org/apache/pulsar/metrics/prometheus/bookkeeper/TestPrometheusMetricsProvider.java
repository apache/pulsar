...
public class TestPrometheusMetricsProvider {
    ...
    public void testJvmDirectMemoryMetrics() throws Exception {
        ...
        try {
            ...
            // The Prometheus Java client 1.x writer omits the empty label set that the legacy simpleclient
            // rendered, so these lines are now "jvm_memory_direct_bytes_max <value>" rather than
            // "jvm_memory_direct_bytes_max{} <value>".
