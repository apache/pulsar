...
public class PulsarMetadataDriverBaseStaticTest {
    ...
    public void testResolveLedgerManagerFactoryUnspecifiedLayout() {
        assertNull(ZKMetadataDriverBase.resolveLedgerManagerFactory(URI.create("zk://127.0.0.1/ledgers")));
    }

    @Test
    public void testResolveLedgerManagerFactoryNullLayout() {
        assertNull(ZKMetadataDriverBase.resolveLedgerManagerFactory(URI.create("zk+null://127.0.0.1/ledgers")));
    }
