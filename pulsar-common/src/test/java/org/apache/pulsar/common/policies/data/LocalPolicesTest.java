...
public class LocalPolicesTest {
    ...
    public void testMakeLocalPoliciesImmutableSerializationCompatibility() throws IOException {
        ...
        byte[] data = ObjectMapperFactory.getMapper().getWriter().writeValueAsBytes(mutableLocalPolicies);
        LocalPolicies mutableDeserializedPolicies = ObjectMapperFactory.getMapper().getReader().readValue(data, LocalPolicies.class);
        ...
        // serialize and deserialize
        data = ObjectMapperFactory.getMapper().getWriter().writeValueAsBytes(mutableLocalPolicies);
        mutableDeserializedPolicies = ObjectMapperFactory.getMapper().getReader().readValue(data, LocalPolicies.class);
    ...
    public void testMakeLocalPoliciesImmutableStringSerializationCompatibility() throws IOException {
        ...
        // serialize and deserialize
        String data = ObjectMapperFactory.getMapper().getWriter().writeValueAsString(mutableLocalPolicies);
        LocalPolicies mutableDeserializedPolicies = ObjectMapperFactory.getMapper().getReader().readValue(data, LocalPolicies.class);
        ...
        // serialize and deserialize
        data = ObjectMapperFactory.getMapper().getWriter().writeValueAsString(mutableLocalPolicies);
        mutableDeserializedPolicies = ObjectMapperFactory.getMapper().getReader().readValue(data, LocalPolicies.class);
