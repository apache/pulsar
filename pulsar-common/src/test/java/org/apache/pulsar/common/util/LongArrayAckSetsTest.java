...
public class LongArrayAckSetsTest {

    // ---- cardinality ----

    @Test
    public void testCardinalityEmptyArray() {
        Assert.assertEquals(LongArrayAckSets.cardinality(new long[0]), 0);
    }

    @Test
    public void testCardinalityAllZero() {
        Assert.assertEquals(LongArrayAckSets.cardinality(new long[]{0L, 0L, 0L}), 0);
    }

    @Test
    public void testCardinalityAllOnes() {
        // -1L == all 64 bits set
        Assert.assertEquals(LongArrayAckSets.cardinality(new long[]{-1L}), 64);
    }

    @Test
    public void testCardinalityMixed() {
        // 0b1011 has 3 bits set; Long.MIN_VALUE (0x8000...0) has 1 bit set → total 4
        Assert.assertEquals(LongArrayAckSets.cardinality(new long[]{0b1011L, 0L, Long.MIN_VALUE}), 4);
    }

    @Test
    public void testCardinalityLongMaxValue() {
        // Long.MAX_VALUE has 63 bits set
        Assert.assertEquals(LongArrayAckSets.cardinality(new long[]{Long.MAX_VALUE}), 63);
    }
    ...
    public void testAndCardinalityBothEmpty() {
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[0], new long[0]), 0);
    }

    @Test
    public void testAndCardinalityFirstEmpty() {
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[0], new long[]{Long.MAX_VALUE}), 0);
    }

    @Test
    public void testAndCardinalitySecondEmpty() {
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[]{Long.MAX_VALUE}, new long[0]), 0);
    }

    @Test
    public void testAndCardinalityNoOverlap() {
        // 0b1010 & 0b0101 == 0
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[]{0b1010L}, new long[]{0b0101L}), 0);
    }

    @Test
    public void testAndCardinalityFullOverlap() {
        // -1L & -1L == -1L → 64 bits
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[]{-1L}, new long[]{-1L}), 64);
    }

    @Test
    public void testAndCardinalityPartialOverlap() {
        // 0b1111 & 0b1010 == 0b1010 → 2 bits
        Assert.assertEquals(LongArrayAckSets.cardinalityOfIntersection(new long[]{0b1111L}, new long[]{0b1010L}), 2);
    }
    ...
    public void testIntersectBothEmpty() {
        Assert.assertEquals(LongArrayAckSets.intersect(new long[0], new long[0]), new long[0]);
    }

    @Test
    public void testIntersectFirstEmpty() {
        Assert.assertEquals(LongArrayAckSets.intersect(new long[0], new long[]{-1L}), new long[0]);
    }

    @Test
    public void testIntersectSecondEmpty() {
        Assert.assertEquals(LongArrayAckSets.intersect(new long[]{-1L}, new long[0]), new long[0]);
    }

    @Test
    public void testIntersectNoOverlap() {
        // 0b1010 & 0b0101 == 0 → the all-zero word is trimmed, leaving an empty array
        Assert.assertEquals(LongArrayAckSets.intersect(new long[]{0b1010L}, new long[]{0b0101L}), new long[0]);
    }

    @Test
    public void testIntersectFullOverlap() {
        Assert.assertEquals(LongArrayAckSets.intersect(new long[]{-1L}, new long[]{-1L}), new long[]{-1L});
    }

    @Test
    public void testIntersectPartialOverlap() {
        // 0b1111 & 0b1010 == 0b1010
        Assert.assertEquals(LongArrayAckSets.intersect(new long[]{0b1111L}, new long[]{0b1010L}),
                new long[]{0b1010L});
    }
    ...
    public void testIntersectFirstLonger() {
        ...
        Assert.assertEquals(
                LongArrayAckSets.intersect(new long[]{0b1111L, 0b1010L, -1L}, new long[]{0b1100L, 0b1110L}),
    ...
    public void testIntersectSecondLonger() {
        ...
        Assert.assertEquals(
                LongArrayAckSets.intersect(new long[]{0b1111L, 0b1010L}, new long[]{0b1100L, 0b1110L, -1L}),
                new long[]{0b1100L, 0b1010L});
    }
    ...
    public void testIntersectMultipleWords() {
        Assert.assertEquals(
                LongArrayAckSets.intersect(new long[]{0b1111L, -1L}, new long[]{0b1010L, 0b0011L}),
    ...
    public void testIntersectTrimsTrailingZeroWords() {
        ...
        Assert.assertEquals(
                LongArrayAckSets.intersect(new long[]{-1L, 0b01L}, new long[]{-1L, 0b10L}),
                new long[]{-1L});
        ...
        Assert.assertEquals(LongArrayAckSets.intersect(new long[]{-1L, 0b01L}, new long[]{-1L, 0b10L}),
                bitSet.toLongArray());
    }
    ...
    public void testIntersectTrimsAllZeroResultToEmpty() {
        Assert.assertEquals(
                LongArrayAckSets.intersect(new long[]{0b1010L, 0b01L}, new long[]{0b0101L, 0b10L}),
                new long[0]);
    }
}
