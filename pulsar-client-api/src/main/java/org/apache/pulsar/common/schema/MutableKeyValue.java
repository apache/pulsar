...
public class MutableKeyValue<K, V> {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof MutableKeyValue)) {
            return false;
        }
        MutableKeyValue<K, V> another = (MutableKeyValue<K, V>) obj;
    ...
    public interface KeyValueDecoder<K, V> {
        ...
        /**
         * Decode key and value bytes into a {@link MutableKeyValue} pair.
         *
         * @param keyData key data
         * @param valueData value data
         * @return the decoded {@link MutableKeyValue} pair
         */
        MutableKeyValue<K, V> decode(byte[] keyData, byte[] valueData);
     ...
     */
    public static <K, V> MutableKeyValue<K, V> decode(byte[] data, MutableKeyValue.KeyValueDecoder<K, V> decoder) {
