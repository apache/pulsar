...
public interface Reader<T> extends Closeable {
   ...
   * <ul>
   * <li><code>MessageId.earliest</code> : Reset the reader on the earliest message available in the topic</li>
   * <li><code>MessageId.latest</code> : Reset the reader on the latest message in the topic</li>
   * </ul>
   *
   * <p>Note: this operation can only be done on non-partitioned topics. For these,
