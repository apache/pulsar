...
//
//    public List<PulsarColumnHandle> columnHandles;
//    public PulsarSplit pulsarSplit;
//    public PulsarConnectorConfig pulsarConnectorConfig;
//    public ReadOnlyCursor cursor;
//    public ArrayBlockingQueue<Message> messageQueue;
//    public ArrayBlockingQueue<Entry> entryQueue;
//    public Object currentRecord;
//    public Message currentMessage;
//    public Map<String, PulsarInternalColumn> internalColumnMap = PulsarInternalColumn.getInternalFieldsMap();
//    public SchemaHandler schemaHandler;
//    public int maxBatchSize;
//    public AtomicLong completedBytes = new AtomicLong(0L);
//    public ReadEntries readEntries;
//    public DeserializeEntries deserializeEntries;
//    public TopicName topicName;
//    public PulsarConnectorMetricsTracker metricsTracker;
//
//    // Stats total execution time of split
//    public long startTime;
//
//    public static final Logger log = Logger.get(PulsarRecordCursor.class);
//
...
//    }
//
//    public void initialize(List<PulsarColumnHandle> columnHandles, PulsarSplit pulsarSplit, PulsarConnectorConfig
//            pulsarConnectorConfig, ManagedLedgerFactory managedLedgerFactory,
...
//    }
//
//    public SchemaHandler getSchemaHandler(Schema schema, SchemaType schemaType,
...
//    }
//
//    public ReadOnlyCursor getCursor(TopicName topicName, Position startPosition, ManagedLedgerFactory
...
//        public final AtomicLong outstandingReadsRequests = new AtomicLong(1);
//
//        public void run() {
//
...
//            this.metricsTracker.register_TOTAL_EXECUTION_TIME(executionTime);
//            this.metricsTracker.close();
//
//            log.info("/***** Stats ******/");
//            log.info("total execution time: %s", executionTime);
//            log.info("read time: %s", this.metricsTracker.getReadLatency());
//        }
//    }
//
//    public void checkFieldType(int field, Class<?> expected) {
