...
public class TestJsonDecoder extends AbstractDecoderTester {
    ...
    public void testPrimitiveType() {
        ...
        PulsarColumnHandle intFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "intField",
                INTEGER,
                false,
        ...
        PulsarColumnHandle floatFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "floatField",
                REAL,
                false,
        ...
        PulsarColumnHandle booleanFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "booleanField",
                BOOLEAN,
                false,
        ...
        PulsarColumnHandle longFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "longField",
                BIGINT,
                false,
        ...
        checkValue(
                decodedRow,
                timestampFieldColumnHandle,
                message.timestampField * Timestamps.MICROSECONDS_PER_MILLISECOND);

        PulsarColumnHandle timeFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "timeField",
                TIME_MILLIS,
                false,
                ...
                PulsarColumnHandle.HandleKeyValueType.NONE);
        checkValue(
                decodedRow, timeFieldColumnHandle, (long) message.timeField * Timestamps.PICOSECONDS_PER_MILLISECOND);
    }
    ...
    public void testDecimal() {
        ...
        PulsarColumnHandle decimalFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "decimalField",
                DecimalType.createDecimalType(4, 2),
                false,
                false,
                "decimalField",
                null,
        ...
        PulsarColumnHandle longDecimalFieldColumnHandle = new PulsarColumnHandle(
                getPulsarConnectorId().toString(),
                "longDecimalField",
                DecimalType.createDecimalType(30, 2),
                false,
                false,
                "longDecimalField",
                null,
    ...
    public void testArray() {
        ...
        GenericJsonRecord genericRecord =
                (GenericJsonRecord) GenericJsonSchema.of(schemaInfo).decode(bytes);
    ...
    public void testCompositeType() {
        ...
        RowType columnType = RowType.from(ImmutableList.<RowType.Field>builder()
                .add(RowType.field(
                        "arrayField",
                        new ArrayType(RowType.from(ImmutableList.<RowType.Field>builder()
                                .add(RowType.field("longField", BIGINT))
                                .add(RowType.field("stringField", VARCHAR))
                                .build()))))
                .add(RowType.field(
                        ...
                        decoderFactory
                                ...
                                .getParameterizedType(
                                        StandardTypes.MAP,
                                        ImmutableList.of(
                                                TypeSignatureParameter.typeParameter(
                                                        VarcharType.VARCHAR.getTypeSignature()),
                                                TypeSignatureParameter.typeParameter(RowType.from(
    ...
    public void testCyclicDefinitionDetect() {
        ...
        TrinoException exception = expectThrows(TrinoException.class, () -> {
            decoderFactory.extractColumnMetadata(
                    topicName, cyclicSchema.getSchemaInfo(), PulsarColumnHandle.HandleKeyValueType.NONE);
        });

        assertEquals(
                "Topic " + topicName.toString() + " schema may contains cyclic definitions.", exception.getMessage());
    }
}
