...
Где `X` - номер ревизии из `debian/changelog` (текущая версия: 4.1.2-10).

## Известные исправления в версии 4.1.2-10

- Исправлено разрешение симлинков для скрипта `pulsar` (исправляет ClassNotFoundException)
- Исправлена структура установки конфигурационных файлов (файлы напрямую в `/etc/apache-pulsar/`)
- Добавлена автоматическая проверка установки конфигурационных файлов при сборке
