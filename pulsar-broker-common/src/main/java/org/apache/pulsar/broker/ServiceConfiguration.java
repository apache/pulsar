...
public class ServiceConfiguration implements PulsarConfiguration {
    ...
    @Category
    public static final String CATEGORY_STORAGE_ML = "Storage (Managed Ledger)";
    @Category
    public static final String CATEGORY_STORAGE_OFFLOADING = "Storage (Ledger Offloading)";
    private ServerManagedLedgerConfiguration managedLedgerConfiguration;
    @Category
