...
public class ServiceConfiguration implements PulsarConfiguration {
    ...
    @FieldContext(
            category = CATEGORY_SERVER,
            doc = "Control the tick time for when retrying on delayed delivery, "
    ...
    @FieldContext(
            category = CATEGORY_SERVER,
            doc = "Whether the deliverAt time is strictly followed. "
    ...
    @FieldContext(
            category = CATEGORY_SERVER,
            doc = "Size of the lookahead window to use "
    ...
    @FieldContext(category = CATEGORY_WEBSOCKET, doc = "Enable the WebSocket API service in broker")
    private boolean webSocketServiceEnabled = false;

    @FieldContext(category = CATEGORY_WEBSOCKET, doc = "Flag indicates whether to run broker in standalone mode")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Metadata store operation timeout in seconds.")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Whether we should enable metadata operations batching")
    private boolean metadataStoreBatchingEnabled = true;

    @FieldContext(category = CATEGORY_SERVER, doc = "Maximum delay to impose on batching grouping")
    private int metadataStoreBatchingMaxDelayMillis = 5;

    @FieldContext(category = CATEGORY_SERVER, doc = "Maximum number of operations to include in a singular batch")
    private int metadataStoreBatchingMaxOperations = 1_000;

    @FieldContext(category = CATEGORY_SERVER, doc = "Maximum size of a batch")
    ...
    @FieldContext(dynamic = true, doc = "Factory class-name to create topic with custom workflow")
    ...
    @Deprecated
    @FieldContext(category = CATEGORY_POLICIES, doc = "@deprecated - Use backlogQuotaDefaultLimitByte instead.")
    ...
    @FieldContext(
            ...
            dynamic = true,
            doc =
                    "Allow schema to be auto updated at broker level. User can override this by 'is_allow_auto_update_schema'"
    ...
    @FieldContext(category = CATEGORY_POLICIES, doc = "Maximum size of Consumer metadata")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Enable precise rate limit for topic publish")
    ...
    @FieldContext(dynamic = false, category = CATEGORY_POLICIES, doc = "Max length of subscription pattern")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Number of worker threads to serve topic ordered executor")
    private int topicOrderedExecutorThreadNum = Runtime.getRuntime().availableProcessors();

    @FieldContext(category = CATEGORY_SERVER, doc = "Enable broker to load persistent topics")
    private boolean enablePersistentTopics = true;

    @FieldContext(category = CATEGORY_SERVER, doc = "Enable broker to load non-persistent topics")
    private boolean enableNonPersistentTopics = true;

    @FieldContext(category = CATEGORY_SERVER, doc = "Enable to run bookie along with broker")
    private boolean enableRunBookieTogether = false;

    @FieldContext(category = CATEGORY_SERVER, doc = "Enable to run bookie autorecovery along with broker")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Enforce producer to publish encrypted messages.(default disable).")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Frequency of snapshots for replicated subscriptions tracking.")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Max number of snapshot to be cached per subscription.")
    ...
    private int maxMessagePublishBufferSizeInMB =
            Math.max(64, (int) (DirectMemoryUtils.jvmMaxDirectMemory() / 2 / (1024 * 1024)));
    ...
    @FieldContext(
            category = CATEGORY_SERVER,
            doc = "Whether to recover cursors lazily when trying to recover a "
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "The directory to locate broker interceptors")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "List of interceptors for payload processing.")
    private Set<String> brokerEntryPayloadProcessors = new LinkedHashSet<>();

    @FieldContext(
            doc =
                    "There are two policies to apply when broker metadata session expires: session expired happens, "
    ...
    /**** --- Messaging Protocol. --- ****/
    @FieldContext(category = CATEGORY_PROTOCOLS, doc = "The directory to locate messaging protocol handlers")
    private String protocolHandlerDirectory = "./protocols";

    @FieldContext(category = CATEGORY_PROTOCOLS, doc = "Use a separate ThreadPool for each Protocol Handler")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "Enable or disable system topic.")
    ...
    @FieldContext(category = CATEGORY_SCHEMA, doc = "The schema compatibility strategy to use for system topics")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "List of interceptors for entry metadata.")
    private Set<String> brokerEntryMetadataInterceptors = new HashSet<>();

    @FieldContext(category = CATEGORY_SERVER, doc = "Enable or disable exposing broker entry metadata to client.")
    ...
    /***** --- TLS. --- ****/
    @FieldContext(category = CATEGORY_TLS, doc = "Enable TLS")
    @Deprecated
    ...
    @FieldContext(category = CATEGORY_AUTHORIZATION, doc = "Enforce authorization")
    private boolean authorizationEnabled = false;

    @FieldContext(category = CATEGORY_AUTHORIZATION, doc = "Authorization provider fully qualified class-name")
    ...
    @FieldContext(category = CATEGORY_SASL_AUTH, doc = "how often the broker expires the inflight SASL context.")
    private long inflightSaslContextExpiryMs = 30_000L;

    @FieldContext(category = CATEGORY_SASL_AUTH, doc = "Maximum number of inflight sasl context.")
    ...
    @FieldContext(category = CATEGORY_STORAGE_BK, doc = "Number of channels per bookie")
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Enable/disable having read operations for a ledger to be "
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Set the client security provider factory class name. "
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Path to file containing keystore password, " + "if the client keystore is password protected.")
    private String bookkeeperTLSKeyStorePasswordPath;

    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Path to file containing truststore password, " + "if the client truststore is password protected.")
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Tls cert refresh duration at bookKeeper-client in seconds (0 " + "to disable check)")
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_BK,
            doc = "Set the interval to check the need for sending an explicit " + "LAC")
    private int bookkeeperExplicitLacIntervalInMills = 0;

    @FieldContext(category = CATEGORY_STORAGE_BK, doc = "whether expose managed ledger client stats to prometheus")
    ...
    @FieldContext(category = CATEGORY_STORAGE_BK, doc = "Throttle value for bookkeeper client")
    ...
    private int managedLedgerCacheSizeMB =
            Math.max(64, (int) (DirectMemoryUtils.jvmMaxDirectMemory() / 5 / (1024 * 1024)));

    @FieldContext(
            category = CATEGORY_STORAGE_ML,
            doc = "Whether we should make a copy of the entry payloads when " + "inserting in cache")
    private boolean managedLedgerCacheCopyEntries = false;

    @FieldContext(
            category = CATEGORY_STORAGE_ML,
            doc = "Maximum buffer size for bytes read from storage."
    ...
    @FieldContext(category = CATEGORY_STORAGE_ML, doc = "The class of the managed ledger storage")
    ...
    @FieldContext(
            category = CATEGORY_STORAGE_ML,
            doc = "Read entries timeout when broker tries to read messages from bookkeeper " + "(0 to disable it)")
    ...
    @FieldContext(category = CATEGORY_STORAGE_ML, doc = "Managed ledger prometheus stats latency rollover seconds")
    ...
    @FieldContext(category = CATEGORY_LOAD_BALANCER, doc = "load balance placement strategy")
    ...
    @FieldContext(category = CATEGORY_LOAD_BALANCER, dynamic = true, doc = "Frequency of report to collect, in minutes")
    ...
    @FieldContext(dynamic = true, category = CATEGORY_LOAD_BALANCER, doc = "enable/disable distribute bundles evenly")
    ...
    @FieldContext(dynamic = true, category = CATEGORY_LOAD_BALANCER, doc = "BandwithIn Resource Usage Weight")
    private double loadBalancerBandwithInResourceWeight = 1.0;

    @FieldContext(dynamic = true, category = CATEGORY_LOAD_BALANCER, doc = "BandwithOut Resource Usage Weight")
    private double loadBalancerBandwithOutResourceWeight = 1.0;

    @FieldContext(dynamic = true, category = CATEGORY_LOAD_BALANCER, doc = "CPU Resource Usage Weight")
    ...
    @FieldContext(dynamic = true, category = CATEGORY_LOAD_BALANCER, doc = "Direct Memory Resource Usage Weight")
    ...
    @FieldContext(category = CATEGORY_LOAD_BALANCER, dynamic = true, doc = "maximum number of bundles in a namespace")
    ...
    private List<String> supportedNamespaceBundleSplitAlgorithms = Lists.newArrayList(
    ...
    @FieldContext(
            category = CATEGORY_LOAD_BALANCER,
            dynamic = true,
            doc = "Max number of bundles to split to per cycle. " + "(only used in load balancer extension logics)")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "How often to check pulsar connection is still alive")
    ...
    @FieldContext(category = CATEGORY_SERVER, doc = "A comma-separated list of namespaces to bootstrap")
    ...
    @FieldContext(category = CATEGORY_SCHEMA, doc = "The schema compatibility strategy in broker level")
    private SchemaCompatibilityStrategy schemaCompatibilityStrategy = SchemaCompatibilityStrategy.FULL;

    /**** --- WebSocket. --- ****/
    @FieldContext(category = CATEGORY_WEBSOCKET, doc = "Number of IO threads in Pulsar Client used in WebSocket proxy")
    private int webSocketNumIoThreads = Runtime.getRuntime().availableProcessors();

    @FieldContext(category = CATEGORY_WEBSOCKET, doc = "Number of threads used by Websocket service")
    ...
    @FieldContext(category = CATEGORY_WEBSOCKET, doc = "Time in milliseconds that idle WebSocket session times out")
    ...
    @FieldContext(category = CATEGORY_METRICS, doc = "If true, export buffered metrics")
    ...
    @FieldContext(category = CATEGORY_METRICS, doc = "If true, export producer level metrics otherwise namespace level")
    private boolean exposeProducerLevelMetricsInPrometheus = false;

    @FieldContext(category = CATEGORY_METRICS, doc = "If true, export managed ledger metrics (aggregated by namespace)")
    private boolean exposeManagedLedgerMetricsInPrometheus = true;

    @FieldContext(category = CATEGORY_METRICS, doc = "If true, export managed cursor metrics")
    ...
    @FieldContext(dynamic = true, category = CATEGORY_METRICS, doc = "Enable expose the broker bundles metrics.")
    ...
    @FieldContext(category = CATEGORY_FUNCTIONS, doc = "The nar package for the function worker service")
    ...
    @FieldContext(category = CATEGORY_METRICS, minValue = 1, doc = "Stats update frequency in seconds")
    ...
    @FieldContext(category = CATEGORY_TRANSACTION, doc = "Enable transaction coordinator in broker")
    private boolean transactionCoordinatorEnabled = false;

    @FieldContext(category = CATEGORY_TRANSACTION, doc = "Class name for transaction metadata store provider")
    ...
    @FieldContext(category = CATEGORY_TRANSACTION, doc = "Class name for transaction buffer provider")
    ...
    @FieldContext(category = CATEGORY_TRANSACTION, doc = "Class name for transaction pending ack store provider")
    ...
    @FieldContext(category = CATEGORY_TRANSACTION, doc = "The max concurrent requests for transaction buffer client.")
    ...
    @FieldContext(
            ...
            dynamic = true,
            doc =
                    "Provide a mechanism allowing the Transaction Log Store to aggregate multiple records into a batched"
    ...
    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "Enable TLS with KeyStore type configuration in broker")
    ...
    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "TLS KeyStore type configuration in broker: JKS, PKCS12")
    private String tlsKeyStoreType = "JKS";

    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "TLS KeyStore path in broker")
    private String tlsKeyStore = null;

    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "TLS KeyStore password for broker")
    @ToString.Exclude
    private String tlsKeyStorePassword = null;

    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "TLS TrustStore type configuration in broker: JKS, PKCS12")
    private String tlsTrustStoreType = "JKS";

    @FieldContext(category = CATEGORY_KEYSTORE_TLS, doc = "TLS TrustStore path in broker")
    ...
    @FieldContext(category = CATEGORY_PACKAGES_MANAGEMENT, doc = "Enable the packages management service or not")
    ...
    private String packagesManagementStorageProvider =
    ...
    @FieldContext(category = CATEGORY_PACKAGES_MANAGEMENT, doc = "The bookkeeper ledger root path")
    private String packagesManagementLedgerRootPath = "/ledgers";

    /* packages management service configurations (end) */

    @FieldContext(category = CATEGORY_PLUGIN, doc = "The directory to locate broker additional servlet")
    ...
    public int getMetadataStoreOperationTimeoutSeconds() {
        return zooKeeperOperationTimeoutSeconds > 0
