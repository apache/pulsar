...
public class TopicResourcesTest {
    ...
    public void testListenerInvokedWhenTopicCreated() {
        ...
        topicResources.handleNotification(
                new Notification(NotificationType.Created, "/managed-ledgers/tenant/namespace/persistent/topic"));
    ...
    public void testListenerInvokedWhenTopicV1Created() {
        ...
        topicResources.handleNotification(new Notification(
                NotificationType.Created, "/managed-ledgers/tenant/cluster/namespace/persistent/topic"));
    ...
    public void testListenerInvokedWhenTopicDeleted() {
        ...
        topicResources.registerPersistentTopicListener(NamespaceName.get("tenant/namespace"), listener);
        topicResources.handleNotification(
                new Notification(NotificationType.Deleted, "/managed-ledgers/tenant/namespace/persistent/topic"));
    ...
    public void testListenerNotInvokedWhenSubscriptionCreated() {
        ...
        topicResources.registerPersistentTopicListener(NamespaceName.get("tenant/namespace"), listener);
        topicResources.handleNotification(new Notification(
                NotificationType.Created, "/managed-ledgers/tenant/namespace/persistent/topic/subscription"));
    ...
    public void testListenerNotInvokedWhenTopicCreatedInOtherNamespace() {
        ...
        topicResources.registerPersistentTopicListener(NamespaceName.get("tenant/namespace"), listener);
        topicResources.handleNotification(
                new Notification(NotificationType.Created, "/managed-ledgers/tenant/namespace2/persistent/topic"));
        verifyNoInteractions(listener);
    }
    ...
    public void testListenerNotInvokedWhenTopicModified() {
        ...
        topicResources.registerPersistentTopicListener(NamespaceName.get("tenant/namespace"), listener);
        topicResources.handleNotification(
                new Notification(NotificationType.Modified, "/managed-ledgers/tenant/namespace/persistent/topic"));
        verifyNoInteractions(listener);
    }
    ...
    public void testListenerNotInvokedAfterDeregistered() {
        ...
        topicResources.handleNotification(
                new Notification(NotificationType.Created, "/managed-ledgers/tenant/namespace/persistent/topic2"));
