...
description = "Pulsar Client (Shaded)"
...
tasks.shadowJar {
    // Netty native library relocation
    relocate("META-INF/native/libnetty", "META-INF/native/liborg_apache_pulsar_shade_netty") {
        // Regex-based relocation for native libraries
    }
    ...
    // Exclude Bouncy Castle (must not be shaded to preserve signatures)
    dependencies {
        exclude(dependency("org.bouncycastle:.*"))
    }

    // Additional META-INF exclusions
