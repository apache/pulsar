...
public class ManagedLedgerConfig {
    ...
    public boolean isEnableMultiEntriesToPersistUnackedRanges() {
        return enableMultiEntriesToPersistUnackedRanges;
    }

    public void setEnableMultiEntriesToPersistUnackedRanges(boolean enableMultiEntriesToPersistUnackedRanges) {
        this.enableMultiEntriesToPersistUnackedRanges = enableMultiEntriesToPersistUnackedRanges;
    }
