...
public abstract class AbstractHdfsConnector {
    ...
    protected HdfsResources resetHDFSResources(HdfsSinkConfig hdfsSinkConfig) throws IOException {
        ...
        getConfigurationFromResources(config, hdfsSinkConfig.getHdfsConfigResources());
        ...
        synchronized (RESOURCES_LOCK) {
            if (SecurityUtil.isSecurityEnabled(config)) {
                ugi = SecurityUtil.loginKerberos(config, hdfsSinkConfig.getKerberosUserPrincipal(), hdfsSinkConfig.getKeytab());
