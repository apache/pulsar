...
public final class EncryptionKey extends Table {
    public static EncryptionKey getRootAsEncryptionKey(ByteBuffer _bb) {
        return getRootAsEncryptionKey(_bb, new EncryptionKey());
    }
    ...
    public KeyValue metadata(int j) {
        return metadata(new KeyValue(), j);
    }
    ...
    public static int createEncryptionKey(
            FlatBufferBuilder builder, int keyOffset, int valueOffset, int metadataOffset) {
    ...
    public static int createMetadataVector(FlatBufferBuilder builder, int[] data) {
