...
public final class Message extends Table {
    ...
    public KeyValue properties(int j) {
        return properties(new KeyValue(), j);
    }

    public KeyValue properties(KeyValue obj, int j) {
        int o = __offset(6);
    ...
    public static int createMessage(
            FlatBufferBuilder builder, int encryptionCtxOffset, int propertiesOffset, int payloadOffset) {
    ...
    public static void addEncryptionCtx(FlatBufferBuilder builder, int encryptionCtxOffset) {
        builder.addOffset(0, encryptionCtxOffset, 0);
    }
