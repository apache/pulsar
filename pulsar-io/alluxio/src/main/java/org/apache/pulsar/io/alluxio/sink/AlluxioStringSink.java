...
@Connector(
    name = "alluxio",
    type = IOType.SINK,
    help = "The AlluxioStringSink is used for moving records from Pulsar to Alluxio.",
    configClass = AlluxioSinkConfig.class)
public class AlluxioStringSink extends AlluxioAbstractSink<String, String> implements Sink<String> {
    @Override
