...
dependencies {
    ...
    implementation("com.amazonaws:dynamodb-streams-kinesis-adapter:1.5.1")
    implementation("software.amazon.awssdk:regions:${libs.versions.aws.sdk2.get()}")
