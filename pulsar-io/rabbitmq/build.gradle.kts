...
description = "Pulsar IO :: RabbitMQ"

dependencies {
    implementation(project(":pulsar-io:common"))
    implementation(project(":pulsar-io-core"))
    implementation(project(":pulsar-functions:instance")) {
    ...
    implementation("com.rabbitmq:amqp-client:${libs.versions.rabbitmq.client.get()}")
