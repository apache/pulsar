...
public class NamespacesImpl extends BaseResource implements Namespaces {
    ...
    public CompletableFuture<List<String>> getTopicsAsync(String namespace, ListNamespaceTopicsOptions options) {
        ...
        path = path.queryParam("mode", options.getMode())
    ...
    public CompletableFuture<Void> createNamespaceAsync(String namespace, int numBundles) {
        return createNamespaceAsync(
                namespace, BundlesData.builder().numBundles(numBundles).build());
    }
    ...
    @Override
    public void revokePermissionOnSubscription(String namespace, String subscription, String role)
            throws PulsarAdminException {
    ...
    public CompletableFuture<List<String>> getAntiAffinityNamespacesAsync(
        ...
        WebTarget path = adminNamespaces
                .path(cluster)
                .path("antiAffinity")
                .path(namespaceAntiAffinityGroup)
                .queryParam("property", tenant);
        return asyncGetRequest(path, new FutureCallback<List<String>>() {});
    }
    ...
    @Override
    public void setAutoTopicCreation(String namespace, AutoTopicCreationOverride autoTopicCreationOverride)
            throws PulsarAdminException {
    ...
    public CompletableFuture<AutoTopicCreationOverride> getAutoTopicCreationAsync(String namespace) {
        return asyncGetNamespaceParts(
                new FutureCallback<AutoTopicCreationOverride>() {}, namespace, "autoTopicCreation");
    }
    ...
    @Override
    public void setSubscriptionTypesEnabled(String namespace, Set<SubscriptionType> subscriptionTypesEnabled)
            throws PulsarAdminException {
    ...
    public CompletableFuture<Void> setSubscriptionTypesEnabledAsync(
            String namespace, Set<SubscriptionType> subscriptionTypes) {
        NamespaceName ns = NamespaceName.get(namespace);
    ...
    @Override
    public CompletableFuture<Void> setBacklogQuotaAsync(
            String namespace, BacklogQuota backlogQuota, BacklogQuota.BacklogQuotaType backlogQuotaType) {
        NamespaceName ns = NamespaceName.get(namespace);
        WebTarget path = namespacePath(ns, "backlogQuota");
        return asyncPostRequest(
                path.queryParam("backlogQuotaType", backlogQuotaType.toString()),
    ...
    @Override
    public CompletableFuture<Void> removeBacklogQuotaAsync(
            String namespace, BacklogQuota.BacklogQuotaType backlogQuotaType) {
        NamespaceName ns = NamespaceName.get(namespace);
        WebTarget path = namespacePath(ns, "backlogQuota").queryParam("backlogQuotaType", backlogQuotaType.toString());
        return asyncDeleteRequest(path);
    }
    ...
    @Override
    public void setBookieAffinityGroup(String namespace, BookieAffinityGroupData bookieAffinityGroup)
            throws PulsarAdminException {
    ...
    @Override
    public void unloadNamespaceBundle(String namespace, String bundle, String destinationBroker)
            throws PulsarAdminException {
    ...
    public CompletableFuture<Void> unloadNamespaceBundleAsync(
            String namespace, String bundle, String destinationBroker) {
        NamespaceName ns = NamespaceName.get(namespace);
    ...
    @Override
    public CompletableFuture<TopicHashPositions> getTopicHashPositionsAsync(
    ...
    @Override
    public CompletableFuture<Void> clearNamespaceBundleBacklogForSubscriptionAsync(
    ...
    @Override
    public CompletableFuture<Void> unsubscribeNamespaceBundleAsync(
            String namespace, String bundle, String subscription) {
        NamespaceName ns = NamespaceName.get(namespace);
    ...
    @Override
    public void setDelayedDeliveryMessages(String namespace, DelayedDeliveryPolicies delayedDeliveryPolicies)
            throws PulsarAdminException {
    ...
    public CompletableFuture<InactiveTopicPolicies> getInactiveTopicPoliciesAsync(String namespace) {
        return asyncGetNamespaceParts(
                new FutureCallback<InactiveTopicPolicies>() {}, namespace, "inactiveTopicPolicies");
    }

    @Override
    public void setInactiveTopicPolicies(String namespace, InactiveTopicPolicies inactiveTopicPolicies)
            throws PulsarAdminException {
    ...
    public CompletableFuture<Void> setOffloadDeleteLagAsync(String namespace, long lag, TimeUnit unit) {
        ...
        return asyncPutRequest(
                path, Entity.entity(TimeUnit.MILLISECONDS.convert(lag, unit), MediaType.APPLICATION_JSON));
    }
    ...
    public void setSchemaAutoUpdateCompatibilityStrategy(
            String namespace, SchemaAutoUpdateCompatibilityStrategy strategy) throws PulsarAdminException {
        try {
            NamespaceName ns = NamespaceName.get(namespace);
            WebTarget path = namespacePath(ns, "schemaAutoUpdateCompatibilityStrategy");
            request(path).put(Entity.entity(strategy, MediaType.APPLICATION_JSON), ErrorData.class);
        } catch (Exception e) {
            throw getApiException(e);
        }
    }
    ...
    private <T> CompletableFuture<T> asyncGetNamespaceParts(
            FutureCallback<T> callback, String namespace, String... parts) {
        NamespaceName ns = NamespaceName.get(namespace);
    ...
    @Override
    public void setNamespaceEntryFilters(String namespace, EntryFilters entryFilters) throws PulsarAdminException {
