...
public class FunctionsImpl extends ComponentResource implements Functions {
    ...
    public CompletableFuture<Void> createFunctionAsync(FunctionConfig functionConfig, String fileName) {
        ...
        try {
            RequestBuilder builder =
                    ...
                    .addBodyPart(new StringPart("functionConfig", ObjectMapperFactory.getInstance()
    ...
    public CompletableFuture<Void> updateFunctionAsync(
        ...
        try {
            ...
            if (options != null) {
                builder.addBodyPart(new StringPart("updateOptions", ObjectMapperFactory.getInstance()
    ...
    public CompletableFuture<Void> updateFunctionWithUrlAsync(
        ...
        try {
            ...
            mp.bodyPart(new FormDataBodyPart(
                    "functionConfig",
                    ObjectMapperFactory.getInstance().writeValueAsString(functionConfig),
    ...
    public CompletableFuture<Void> putFunctionStateAsync(
        ...
        try {
            ...
            builder.addBodyPart(new StringPart("state", ObjectMapperFactory.getInstance()
