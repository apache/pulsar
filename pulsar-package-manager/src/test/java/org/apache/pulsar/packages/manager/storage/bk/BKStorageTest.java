...
public class BKStorageTest {
    ...
    private BKPackageStorage bkStorage;
    ...
    public void setup() throws Exception {
        ...
        this.bkStorage = new BKPackageStorage(namespace);
    ...
    public void testWriteBytes() throws Exception {
        bkStorage.writeAsync("/test/write-path", testFileString.getBytes()).get();
        verify(namespace, times(1)).openLog(eq("/test/write-path"));
        verify(distributedLogManager, times(1)).getAppendOnlyStreamWriter();
    ...
    public void testReadBytes() throws Exception {
        bkStorage.readAsync("/test/read-path").get();
        verify(namespace, times(1)).openLog(eq("/test/read-path"));
    ...
    public void testList() throws Exception {
        ...
        bkStorage.listAsync("/test/list-path").get();
        verify(namespace, times(1)).getLogs(eq("/test/list-path"));
    }

    @Test
    public void testExist() throws Exception {
        bkStorage.existAsync("/test/exist-path").get();
