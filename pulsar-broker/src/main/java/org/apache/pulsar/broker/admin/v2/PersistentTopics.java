...
public class PersistentTopics extends PersistentTopicsBase {
    ...
    @ApiOperation(
            value = "Get the list of topics under a namespace.",
    ...
    public void getList(
            ...
            @ApiParam(value = "Specify the bundle name", required = false) @QueryParam("bundle") String bundle,
            @ApiParam(value = "Include system topic") @QueryParam("includeSystemTopic") boolean includeSystemTopic) {
    ...
    @ApiOperation(
            value = "Get the list of partitioned topics under a namespace.",
            response = String.class,
            responseContainer = "List")
    @ApiResponses(
            value = {
    ...
    public void getPartitionedTopicList(
        ...
        internalGetPartitionedTopicListAsync()
                .thenAccept(partitionedTopicList ->
                        asyncResponse.resume(filterSystemTopic(partitionedTopicList, includeSystemTopic)))
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
    ...
    @ApiOperation(
            value = "Get permissions on a topic.",
    ...
    public void getPermissionsOnTopic(
        ...
        try {
            ...
            internalGetPermissionsOnTopic()
                    .thenAccept(permissions -> asyncResponse.resume(permissions))
                    .exceptionally(ex -> {
    ...
    public void grantPermissionsOnTopic(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Client role to which grant permissions", required = true) @PathParam("role") String role,
            @ApiParam(
                            value = "Actions to be granted (produce,functions,consume)",
    ...
    @Path("/{tenant}/{namespace}/{topic}/permissions/{role}")
    @ApiOperation(
            value = "Revoke permissions on a topic.",
    ...
    public void revokePermissionsOnTopic(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Client role to which grant permissions", required = true) @PathParam("role")
                    String role) {
        try {
            validateTopicName(tenant, namespace, encodedTopic);
    ...
    public void createPartitionedTopic(
            ...
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(
                            value = "The number of partitions for the topic",
                            required = true,
                            type = "int",
                            defaultValue = "0")
                    int numPartitions,
    ...
    @ApiOperation(
            value = "Create a non-partitioned topic.",
    ...
    public void setOffloadPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void removeOffloadPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void getMaxUnackedMessagesOnConsumer(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void deleteMaxUnackedMessagesOnConsumer(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setDeduplicationSnapshotInterval(
            ...
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Interval to take deduplication snapshot for the specified topic") Integer interval,
            @QueryParam("isGlobal") @DefaultValue("false") boolean isGlobal,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
    ...
    public void getInactiveTopicPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void deleteInactiveTopicPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void getMaxUnackedMessagesOnSubscription(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void deleteMaxUnackedMessagesOnSubscription(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void getDelayedDeliveryPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void deleteDelayedDeliveryPolicies(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    @Path("/{tenant}/{namespace}/{topic}/partitions")
    @ApiOperation(
            value = "Increment partitions of an existing partitioned topic.",
    ...
    public void updatePartitionedTopic(
        ...
        if (topicName.isPartitioned()) {
            throw new RestException(
                    Response.Status.PRECONDITION_FAILED, "Partitioned Topic Name should not contain '-partition-'");
        }
    ...
    public void getPartitionedMetadata(
            ...
            @ApiParam(value = "Is check configuration required to automatically create topic")
                    @QueryParam("checkAllowAutoCreation")
                    @DefaultValue("false")
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        code = 401,
                        message = "Don't have permission to administrate resources on this tenant or"
    ...
    public void removeProperties(
        ...
        internalRemovePropertiesAsync(authoritative, key)
                ...
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to remove key {} in properties on topic {}",
                                clientAppId(),
                                key,
                                topicName,
                                ex);
    ...
    @Path("/{tenant}/{namespace}/{topic}/partitions")
    @ApiOperation(
            value = "Delete a partitioned topic.",
    ...
    public void deletePartitionedTopic(
            ...
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(
                            value = "Stop all producer/consumer/replicator and delete topic forcefully",
                            defaultValue = "false",
                            type = "boolean")
                    @QueryParam("force")
                    @DefaultValue("false")
        ...
        internalDeleteTopicAsync(authoritative, force)
                ...
                .exceptionally(ex -> {
                    ...
                    if (!force && (t instanceof BrokerServiceException.TopicBusyException)) {
                        ex = new RestException(Response.Status.PRECONDITION_FAILED, t.getMessage());
                    }
                    if (t instanceof IllegalStateException) {
                        ...
                        ex = new RestException(
                                Response.Status.NOT_FOUND, getTopicNotFoundErrorMessage(topicName.toString()));
    ...
    public void getStats(
            ...
            @ApiParam(
                            value =
                                    "If return backlog size for each subscription, require locking on ledger so be careful "
    ...
    public void getPartitionedStats(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Get per partition stats") @QueryParam("perPartition") @DefaultValue("true")
    ...
    public void deleteSubscription(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription to be deleted") @PathParam("subName") String encodedSubName,
            @ApiParam(
                            value = "Disconnect and close all consumers and delete subscription forcefully",
                            defaultValue = "false",
                            type = "boolean")
                    @QueryParam("force")
                    @DefaultValue("false")
    ...
    @ApiOperation(
            value = "Skip all messages on a topic subscription.",
    ...
    public void skipAllMessages(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Name of subscription") @PathParam("subName") String encodedSubName,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative) {
    ...
    public void skipMessages(
            ...
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Name of subscription") @PathParam("subName") String encodedSubName,
            @ApiParam(value = "The number of messages to skip", defaultValue = "0") @PathParam("numMessages")
                    int numMessages,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
    ...
    public void expireTopicMessages(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription to be Expiry messages on") @PathParam("subName") String encodedSubName,
        ...
        try {
            ...
            internalExpireMessagesByTimestamp(
                    asyncResponse, decode(encodedSubName), expireTimeInSeconds, authoritative);
        } catch (WebApplicationException wae) {
            asyncResponse.resume(wae);
        } catch (Exception e) {
            asyncResponse.resume(new RestException(e));
    ...
    @ApiOperation(
            value = "Create a subscription on the topic.",
    ...
    public void createSubscription(
            ...
            @ApiParam(value = "Specify the tenant", required = true) @PathParam("tenant") String tenant,
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String topic,
            @ApiParam(value = "Name of subscription to be created", required = true) @PathParam("subscriptionName")
            ...
            @ApiParam(
                            name = "messageId",
                            value = "messageId where to create the subscription. "
                                    + "It can be 'latest', 'earliest' or (ledgerId:entryId)",
                            defaultValue = "latest",
                            allowableValues = "latest, earliest, ledgerId:entryId")
                    ResetCursorData resetCursorData,
            @ApiParam(value = "Is replicated required to perform this operation") @QueryParam("replicated")
                    boolean replicated) {
        try {
            ...
            Map<String, String> subscriptionProperties =
                    resetCursorData == null ? null : resetCursorData.getProperties();
            MessageIdImpl messageId = resetCursorData == null
                    ? null
                    : new MessageIdImpl(
                            resetCursorData.getLedgerId(),
                            resetCursorData.getEntryId(),
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        code = 412,
                        message = "Failed to reset cursor on subscription or "
    ...
    public void resetCursor(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription to reset position on", required = true) @PathParam("subName")
                    String encodedSubName,
            @ApiParam(value = "the timestamp to reset back") @PathParam("timestamp") long timestamp,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative) {
        ...
        internalResetCursorAsync(decode(encodedSubName), timestamp, authoritative)
                ...
                .exceptionally(ex -> {
                    ...
                    if (!isRedirectException(t)) {
                        log.error(
                                "[{}][{}] Failed to reset cursor on subscription {} to time {}",
                                clientAppId(),
                                topicName,
                                encodedSubName,
                                timestamp,
                    ...
                    if (t instanceof BrokerServiceException.SubscriptionInvalidCursorPosition) {
                        ...
                        t = new RestException(
                                Response.Status.PRECONDITION_FAILED, "Failed for Subscription Busy: " + t.getMessage());
                    }
    ...
    public void updateSubscriptionProperties(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription to update", required = true) @PathParam("subName") String encodedSubName,
        ...
        try {
            ...
            internalUpdateSubscriptionProperties(
                    asyncResponse, decode(encodedSubName), subscriptionProperties, authoritative);
        } catch (WebApplicationException wae) {
            asyncResponse.resume(wae);
        } catch (Exception e) {
            asyncResponse.resume(new RestException(e));
    ...
    public void getSubscriptionProperties(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription", required = true) @PathParam("subName") String encodedSubName,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative) {
        try {
            validateTopicName(tenant, namespace, encodedTopic);
            internalGetSubscriptionProperties(asyncResponse, decode(encodedSubName), authoritative);
        } catch (WebApplicationException wae) {
            asyncResponse.resume(wae);
        } catch (Exception e) {
            asyncResponse.resume(new RestException(e));
    ...
    public void analyzeSubscriptionBacklog(
            ...
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Subscription", required = true) @PathParam("subName") String encodedSubName,
            @ApiParam(name = "position", value = "messageId to start the analysis") ResetCursorData position,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative) {
        try {
            ...
            if (position != null) {
                positionImpl = Optional.of(new PositionImpl(position.getLedgerId(), position.getEntryId()));
            } else {
                positionImpl = Optional.empty();
            }
            validateTopicName(tenant, namespace, encodedTopic);
            internalAnalyzeSubscriptionBacklog(asyncResponse, decode(encodedSubName), positionImpl, authoritative);
        } catch (WebApplicationException wae) {
            asyncResponse.resume(wae);
        } catch (Exception e) {
            asyncResponse.resume(new RestException(e));
    ...
    @ApiOperation(
            value = "Reset subscription to message position closest to given position.",
            notes = "It fence cursor and disconnects all active consumers before resetting cursor.")
    @ApiResponses(
            value = {
                @ApiResponse(code = 307, message = "Current broker doesn't serve the namespace of this topic"),
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        code = 404,
                        message = "Namespace or topic, subscription or the message position does not" + " exist"),
    ...
    public void peekNthMessage(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(name = "subName", value = "Subscribed message expired", required = true) @PathParam("subName")
                    String encodedSubName,
            @ApiParam(value = "The number of messages (default 1)", defaultValue = "1") @PathParam("messagePosition")
                    int messagePosition,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
        ...
        internalPeekNthMessageAsync(decode(encodedSubName), messagePosition, authoritative)
                ...
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to get peek nth message for topic {} subscription {}",
                                clientAppId(),
                                topicName,
                                decode(encodedSubName),
                                ex);
    ...
    @ApiOperation(
            value = "Examine a specific message on a topic by position relative to the earliest or the latest message.")
    @ApiResponses(
            value = {
                @ApiResponse(code = 307, message = "Current broker doesn't serve the namespace of this topic"),
                @ApiResponse(code = 403, message = "Don't have admin permission"),
    ...
    public void examineMessage(
            ...
            @ApiParam(
                            ...
                            value = "Relative start position to examine message." + "It can be 'latest' or 'earliest'",
                            defaultValue = "latest",
        ...
        internalExamineMessageAsync(initialPosition, messagePosition, authoritative)
                ...
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to examine a specific message on the topic {}",
                                clientAppId(),
                                topicName,
                                ex);
                    }
    ...
    public void getMessageById(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "The ledger id", required = true) @PathParam("ledgerId") long ledgerId,
        ...
        internalGetMessageById(ledgerId, entryId, authoritative)
                ...
                .exceptionally(ex -> {
                    ...
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to get message with ledgerId {} entryId {} from {}",
                                clientAppId(),
                                ledgerId,
                                entryId,
                                topicName,
    ...
    public void getMessageIdByTimestamp(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Specify the timestamp", required = true) @PathParam("timestamp") long timestamp,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative) {
        ...
        internalGetMessageIdByTimestampAsync(timestamp, authoritative)
                ...
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to get message ID by timestamp {} from {}",
                                clientAppId(),
                                timestamp,
                                topicName,
                                ex);
    ...
    public void getBacklog(
            ...
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    ...
                    boolean authoritative) {
        validateTopicName(tenant, namespace, encodedTopic);
        internalGetBacklogAsync(authoritative).thenAccept(asyncResponse::resume).exceptionally(ex -> {
            Throwable t = FutureUtil.unwrapCompletionException(ex);
    ...
    public void getReplicationClusters(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenAccept(op -> {
                    asyncResponse.resume(
                            op.map(TopicPolicies::getReplicationClustersSet).orElseGet(() -> {
                                if (applied) {
    ...
    public void removeReplicationClusters(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void getMessageTTL(
        ...
        preValidation(authoritative)
                ...
                .thenAccept(op -> asyncResponse.resume(
                        op.map(TopicPolicies::getMessageTTLInSeconds).orElseGet(() -> {
                            if (applied) {
    ...
    @ApiResponses(
            value = {
                @ApiResponse(code = 403, message = "Not authenticate to perform the request or policy is read only"),
                @ApiResponse(code = 404, message = "Namespace or topic doesn't exist"),
                @ApiResponse(
                        code = 405,
                        message = "Topic level policy is disabled, enable the topic level policy and retry"),
    ...
    public void setMessageTTL(
            ...
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "TTL in seconds for the specified topic", required = true) @QueryParam("messageTTL")
                    Integer messageTTL,
            @QueryParam("isGlobal") @DefaultValue("false") boolean isGlobal,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
    ...
    public void setRetention(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully updated retention: namespace={}, topic={}, retention={}",
                                clientAppId(),
                                namespaceName,
    ...
    public void removeRetention(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove retention: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void setPersistence(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully updated persistence policies: "
    ...
    public void removePersistence(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove persistence policies: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void getMaxSubscriptionsPerTopic(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenAccept(op -> asyncResponse.resume(
                        op.isPresent() ? op.get() : Response.noContent().build()))
                .exceptionally(ex -> {
    ...
    public void setMaxSubscriptionsPerTopic(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully updated maxSubscriptionsPerTopic: namespace={}, topic={}"
    ...
    public void removeMaxSubscriptionsPerTopic(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove maxSubscriptionsPerTopic: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void setReplicatorDispatchRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully updated replicatorDispatchRate: namespace={}, topic={}"
    ...
    public void removeReplicatorDispatchRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove replicatorDispatchRate limit: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void setMaxProducers(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully updated max producers: namespace={}, topic={}, maxProducers={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName(),
                            maxProducers);
    ...
    public void removeMaxProducers(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove max producers: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void setMaxConsumers(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully updated max consumers: namespace={}, topic={}, maxConsumers={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName(),
                            maxConsumers);
    ...
    public void removeMaxConsumers(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove max consumers: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void removeMaxMessageSize(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove max message size: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    @ApiOperation(
            value = "Terminate a topic. A topic that is terminated will not accept any more "
    ...
    public void terminate(
            ...
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    ...
                    boolean authoritative) {
        validatePersistentTopicName(tenant, namespace, encodedTopic);
        internalTerminateAsync(authoritative).thenAccept(asyncResponse::resume).exceptionally(ex -> {
            if (!isRedirectException(ex)) {
    ...
    public void compactionStatus(
        ...
        internalCompactionStatusAsync(authoritative)
                ...
                .exceptionally(ex -> {
                    if (!isRedirectException(ex)) {
                        log.error(
                                "[{}] Failed to get the status of a compaction operation for the topic {}",
                                clientAppId(),
                                topicName,
                                ex);
                    }
    ...
    public void setDispatchRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic dispatch rate:"
    ...
    public void removeDispatchRate(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove topic dispatch rate: tenant={}, namespace={}, topic={}",
                            clientAppId(),
                            tenant,
                            namespace,
                            topicName.getLocalName());
    ...
    public void getSubscriptionDispatchRate(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setSubscriptionDispatchRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic subscription dispatch rate:"
                                        + " tenant={}, namespace={}, topic={}, dispatchRate={}",
                                clientAppId(),
                                tenant,
                                namespace,
    ...
    public void removeSubscriptionDispatchRate(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove topic subscription dispatch rate: tenant={}, namespace={}, topic={}",
                            clientAppId(),
                            tenant,
                            namespace,
                            topicName.getLocalName());
    ...
    public void getSubscriptionLevelDispatchRate(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setSubscriptionLevelDispatchRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully set subscription level dispatch rate:"
    ...
    public void removeSubscriptionLevelDispatchRate(
        ...
        preValidation(authoritative)
                .thenCompose(__ ->
                        internalRemoveSubscriptionLevelDispatchRate(Codec.decode(encodedSubscriptionName), isGlobal))
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove subscription level dispatch rate: "
    ...
    public void setCompactionThreshold(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic compaction threshold:"
    ...
    public void removeCompactionThreshold(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove topic compaction threshold: tenant={}, namespace={}, topic={}",
                            clientAppId(),
                            tenant,
                            namespace,
                            topicName.getLocalName());
    ...
    public void setMaxConsumersPerSubscription(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic max consumers per subscription:"
    ...
    public void removeMaxConsumersPerSubscription(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove topic max consumers per subscription:"
    ...
    public void setPublishRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic publish rate:"
    ...
    public void removePublishRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove topic publish rate: tenant={}, namespace={}, topic={}, isGlobal={}",
                            clientAppId(),
                            tenant,
                            namespace,
                            topicName.getLocalName(),
    ...
    public void setSubscriptionTypesEnabled(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic is enabled sub types :"
    ...
    public void removeSubscriptionTypesEnabled(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    log.info(
                            "[{}] Successfully remove subscription types enabled: namespace={}, topic={}",
                            clientAppId(),
                            namespaceName,
                            topicName.getLocalName());
                    asyncResponse.resume(Response.noContent().build());
    ...
    public void setSubscribeRate(
        ...
        preValidation(authoritative)
                ...
                .thenRun(() -> {
                    try {
                        log.info(
                                "[{}] Successfully set topic subscribe rate:"
    ...
    public void removeSubscribeRate(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setReplicatedSubscriptionStatus(
            ...
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @ApiParam(value = "Name of subscription", required = true) @PathParam("subName") String encodedSubName,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
                    @DefaultValue("false")
                    boolean authoritative,
            @ApiParam(value = "Whether to enable replicated subscription", required = true) boolean enabled) {
        try {
            validateTopicName(tenant, namespace, encodedTopic);
    ...
    public void getSchemaCompatibilityStrategy(
            @Suspended AsyncResponse asyncResponse,
            @ApiParam(value = "Specify the tenant", required = true) @PathParam("tenant") String tenant,
            @ApiParam(value = "Specify the cluster", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
            @QueryParam("applied") @DefaultValue("false") boolean applied,
            @ApiParam(value = "Whether leader broker redirected this call to this broker. For internal use.")
                    @QueryParam("authoritative")
    ...
    public void getSchemaValidationEnforced(
            @Suspended AsyncResponse asyncResponse,
            @ApiParam(value = "Specify the tenant", required = true) @PathParam("tenant") String tenant,
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setSchemaValidationEnforced(
            @Suspended AsyncResponse asyncResponse,
            @ApiParam(value = "Specify the tenant", required = true) @PathParam("tenant") String tenant,
            @ApiParam(value = "Specify the namespace", required = true) @PathParam("namespace") String namespace,
            @ApiParam(value = "Specify topic name", required = true) @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void setEntryFilters(
            ...
            @ApiParam(value = "Whether leader broker redirected this" + "call to this broker. For internal use.")
                    ...
                    @DefaultValue("false")
                    boolean authoritative,
            @ApiParam(value = "Entry filters for the specified topic") EntryFilters entryFilters) {
        validateTopicName(tenant, namespace, encodedTopic);
        preValidation(authoritative)
    ...
    public void removeEntryFilters(
            @Suspended final AsyncResponse asyncResponse,
            @PathParam("tenant") String tenant,
            @PathParam("namespace") String namespace,
            @PathParam("topic") @Encoded String encodedTopic,
    ...
    public void getShadowTopics(
        ...
        preValidation(authoritative)
                ...
                .thenCompose(__ -> getTopicPoliciesAsyncWithRetry(topicName))
                .thenAccept(op -> asyncResponse.resume(
                        op.map(TopicPolicies::getShadowTopics).orElse(null)))
                .exceptionally(ex -> {
