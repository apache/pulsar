...
public class ProtobufNativeNeverCompatibleValidator implements ProtobufNativeSchemaValidator {
    private static final Logger log = LoggerFactory.getLogger(ProtobufNativeNeverCompatibleValidator.class);
