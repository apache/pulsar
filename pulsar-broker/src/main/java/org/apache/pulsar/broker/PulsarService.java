...
import org.apache.pulsar.broker.stats.NamespaceMetrics;
...
public class PulsarService implements AutoCloseable, ShutdownService {
    ...
    @Getter
    private final Map<NamespaceName, NamespaceMetrics> namespaceMetrics = new ConcurrentHashMap<>();
    ...
    public CompletableFuture<Void> closeAsync() {
        ...
        try {
            ...
            if (openTelemetryNamespaceStats != null) {
                openTelemetryNamespaceStats.close();
