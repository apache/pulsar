...
/**
 * A value with the metadata-store version it was read at. Pass {@link #version} as the
 * {@code IfVersionEquals} option on a subsequent {@code put} to perform an atomic CAS update.
 *
