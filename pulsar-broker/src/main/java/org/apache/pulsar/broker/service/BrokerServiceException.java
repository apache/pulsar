...
public class BrokerServiceException extends Exception {
    ...
    private static PulsarApi.ServerError getClientErrorCode(Throwable t, boolean checkCauseIfUnknown) {
        ...
        } else if (t instanceof TransactionAckConflictException) {
            return ServerError.TransactionAckConflictException;
        } else if (t instanceof TransactionAbortConflictException) {
            return ServerError.TransactionAbortConflictException;
        } else if (t instanceof TransactionCommitConflictException) {
            return ServerError.TransactionCommitConflictException;
        } else {
