...
public class MessageDeduplication {
    ...
    @VisibleForTesting
    final ConcurrentHashMap<String, Long> highestSequencedPushed = new ConcurrentHashMap<>();
    ...
    @VisibleForTesting
    final ConcurrentHashMap<String, Long> highestSequencedPersisted = new ConcurrentHashMap<>();
