...
public class ConsumerMetrics implements OutputMetrics {
    ...
    public ConsumerMetrics(Subscription subscription) {
        this.subscriptionMetrics = subscription.getMetrics();
    }

    @Override
    public void recordMessageOut(long messageCount, long byteCount) {
        subscriptionMetrics.recordMessageOut(messageCount, byteCount);
    ...
    public void recordMessageAck(long ackCount) {
        subscriptionMetrics.recordMessageAck(ackCount);
