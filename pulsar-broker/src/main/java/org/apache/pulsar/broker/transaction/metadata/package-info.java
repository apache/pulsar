...
/**
 * Metadata-store data layer for PIP-473 transactions: schema-versioned JSON records
 * ({@link org.apache.pulsar.broker.transaction.metadata.TxnHeader},
 * {@link org.apache.pulsar.broker.transaction.metadata.TxnOp},
 * {@link org.apache.pulsar.broker.transaction.metadata.TxnEvent}), path/index constants
 * ({@link org.apache.pulsar.broker.transaction.metadata.TxnPaths}), and a typed façade over
