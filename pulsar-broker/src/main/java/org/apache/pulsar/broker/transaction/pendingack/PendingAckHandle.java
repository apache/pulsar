...
public interface PendingAckHandle {
    ...
    void redeliverUnacknowledgedMessages(Consumer consumer, Dispatcher dispatcher);

    void redeliverUnacknowledgedMessages(Consumer consumer, List<PositionImpl> positions, Dispatcher dispatcher);
