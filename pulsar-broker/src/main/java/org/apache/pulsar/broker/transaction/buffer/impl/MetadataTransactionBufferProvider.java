...
/**
 * Provider that builds a {@link MetadataTransactionBuffer} backed by the broker's local
 * {@code MetadataStore}. Intended for {@code segment://} topics. The dispatching provider routes
 * here when the topic is a segment topic.
 */
public class MetadataTransactionBufferProvider implements TransactionBufferProvider {
