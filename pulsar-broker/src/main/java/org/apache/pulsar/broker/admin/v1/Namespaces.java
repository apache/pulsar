...
public class Namespaces extends NamespacesBase {
    ...
    @GET
    @Path("/{tenant}/{cluster}/{namespace}/bundles")
    ...
    public List<String> getBundles(@PathParam("tenant") String tenant, @PathParam("cluster") String cluster,
        ...
        try {
            ...
            log.warn("Failed to get bundles for {}/{}/{}", tenant, cluster, namespace, e);
            new RestException(e);
        }
        return null;
    }
