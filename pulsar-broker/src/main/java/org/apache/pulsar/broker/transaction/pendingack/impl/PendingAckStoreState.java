...
public abstract class PendingAckStoreState {

    /**
     * The state of the transactionMetadataStore {@link PendingAckStore}.
     */
    public enum State {
        None,
        Initializing,
    ...
    private static final AtomicReferenceFieldUpdater<PendingAckStoreState, State> STATE_UPDATER =
            AtomicReferenceFieldUpdater.newUpdater(PendingAckStoreState.class, State.class, "state");

    @SuppressWarnings("unused")
    private volatile State state = null;

    public PendingAckStoreState(State state) {
