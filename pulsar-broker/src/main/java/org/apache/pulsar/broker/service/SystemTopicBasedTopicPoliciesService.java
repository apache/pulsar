...
public class SystemTopicBasedTopicPoliciesService implements TopicPoliciesService {
    ...
    protected CompletableFuture<SystemTopicClient.Reader> createSystemTopicClientWithRetry(
            NamespaceName namespace) {
        CompletableFuture<SystemTopicClient.Reader> result = new CompletableFuture<>();
        createSystemTopicFactoryIfNeeded();
