...
public class InMemoryPendingAckStore implements PendingAckStore {
    ...
    @Override
    public CompletableFuture<Void> append(TxnID txnID, PositionImpl position, PulsarApi.CommandAck.AckType ackType) {
        return CompletableFuture.completedFuture(null);
    }

    @Override
    public CompletableFuture<Void> deleteTxn(TxnID txnID, PulsarApi.CommandAck.AckType ackType) {
        return CompletableFuture.completedFuture(null);
    }
}
