...
public class DispatcherDelayedDeliveryContext implements DelayedDeliveryContext {

    private final AbstractPersistentDispatcherMultipleConsumers dispatcher;

    public DispatcherDelayedDeliveryContext(AbstractPersistentDispatcherMultipleConsumers dispatcher) {
