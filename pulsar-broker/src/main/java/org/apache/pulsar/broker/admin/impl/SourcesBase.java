...
public class SourcesBase extends AdminResource {
    ...
    public SourceStatus.SourceInstanceStatus.SourceInstanceStatusData getSourceInstanceStatus(
            ...
            @ApiParam(value = "The name of a Pulsar Source") final @PathParam("sourceName") String sourceName,
            @ApiParam(
                            value = "The instanceId of a Pulsar Source"
                                    + " (if instance-id is not provided, the stats of all instances is returned).")
                    final @PathParam("instanceId") String instanceId)
            throws IOException {
        return sources()
                .getSourceInstanceStatus(tenant, namespace, sourceName, instanceId, uri.getRequestUri(), authParams());
    }
    ...
    public void restartSource(
            ...
            @ApiParam(
                            value = "The instanceId of a Pulsar Source"
                                    + " (if instance-id is not provided, the stats of all instances is returned).")
                    final @PathParam("instanceId") String instanceId) {
        sources().restartFunctionInstance(tenant, namespace, sourceName, instanceId, uri.getRequestUri(), authParams());
    }
    ...
    public void stopSource(
            ...
            @ApiParam(value = "The name of a Pulsar Source") final @PathParam("sourceName") String sourceName,
            @ApiParam(
                            value = "The instanceId of a Pulsar Source (if instance-id is not provided,"
                                    + " the stats of all instances is returned).")
                    final @PathParam("instanceId") String instanceId) {
        sources().stopFunctionInstance(tenant, namespace, sourceName, instanceId, uri.getRequestUri(), authParams());
    }
    ...
    public void startSource(
            ...
            @ApiParam(
                            value = "The instanceId of a Pulsar Source (if instance-id is not provided,"
                                    + " the stats of all instances is returned).")
                    final @PathParam("instanceId") String instanceId) {
        sources().startFunctionInstance(tenant, namespace, sourceName, instanceId, uri.getRequestUri(), authParams());
    }
