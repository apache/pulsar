...
public class PersistentTopics extends PersistentTopicsBase {
    ...
    public void getPartitionedTopicList(
            ...
            @PathParam("namespace") String namespace) {
        validateNamespaceName(property, cluster, namespace);
        internalGetPartitionedTopicListAsync().thenAccept(asyncResponse::resume).exceptionally(ex -> {
            if (!isRedirectException(ex)) {
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        code = 406,
                        message = "The number of partitions should be "
    ...
    public void createNonPartitionedTopic(
            ...
            @ApiParam(value = "Specify the cluster", required = true) @PathParam("cluster") String cluster,
    ...
    public void createSubscription(
        ...
        try {
            ...
            internalCreateSubscription(
                    asyncResponse, decode(encodedSubName), messageId, authoritative, replicated, null);
        } catch (WebApplicationException wae) {
            asyncResponse.resume(wae);
        } catch (Exception e) {
            asyncResponse.resume(new RestException(e));
    ...
    @ApiResponses(
            value = {
                ...
                @ApiResponse(
                        code = 404,
                        message = "Namespace or topic or subscription or the message position does not" + " exist")
            })
