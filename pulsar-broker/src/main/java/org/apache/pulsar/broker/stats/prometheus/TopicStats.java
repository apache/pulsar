...
class TopicStats {
    ...
    public static void printTopicStats(
        ...
        writeMetric(
                stream, "pulsar_rate_in", stats.rateIn, cluster, namespace, topic, splitTopicAndPartitionIndexLabel);
        writeMetric(
                stream, "pulsar_rate_out", stats.rateOut, cluster, namespace, topic, splitTopicAndPartitionIndexLabel);
        writeMetric(
                stream,
        ...
        writeMetric(
                stream,
                "pulsar_txn_tb_active_total",
                stats.ongoingTxnCount,
                cluster,
                namespace,
                topic,
                splitTopicAndPartitionIndexLabel);
        writeMetric(
                stream,
                "pulsar_txn_tb_aborted_total",
                stats.abortedTxnCount,
                cluster,
                namespace,
                topic,
                splitTopicAndPartitionIndexLabel);
        ...
        stats.producerStats.forEach((p, producerStats) -> {
            ...
            writeProducerMetric(
                    stream,
                    "pulsar_producer_msg_throughput_in",
            ...
            writeProducerMetric(
                    stream,
                    "pulsar_producer_msg_average_Size",
        ...
        stats.subscriptionStats.forEach((sub, subsStats) -> {
            ...
            writeSubscriptionMetric(
                    ...
                    subsStats.filterProcessedMsgCount,
                    cluster,
                    namespace,
                    topic,
                    sub,
            ...
            writeSubscriptionMetric(
                    ...
                    subsStats.filterAcceptedMsgCount,
                    cluster,
                    namespace,
                    topic,
                    sub,
        ...
        boolean hasCompaction = compactorMXBean
                .flatMap(mxBean -> mxBean.getCompactionRecordForTopic(topic))
                .isPresent();
        if (hasCompaction) {
            writeMetric(
                    stream,
    ...
    private static void writeProducerMetric(
            PrometheusMetricStreams stream,
            String metricName,
            Number value,
            String cluster,
    ...
    private static void writeSubscriptionMetric(
            PrometheusMetricStreams stream,
            String metricName,
            Number value,
            String cluster,
    ...
    private static void writeConsumerMetric(
            PrometheusMetricStreams stream,
            String metricName,
            Number value,
            String cluster,
        ...
        writeTopicMetric(
                ...
                "consumer_id",
                String.valueOf(consumer.consumerId()));
    }

    static void writeTopicMetric(
            PrometheusMetricStreams stream,
            String metricName,
            Number value,
            String cluster,
