...
class TopicStats {
    ...
    public static void printTopicStats(PrometheusMetricStreams stream, TopicStats stats,
        ...
        for (TopicMetricBean topicMetricBean : stats.bucketDelayedIndexStats.values()) {
            String[] extraLabels = mergeArrays(customMetricLabels, topicMetricBean.labelsAndValues);
            writeTopicMetric(stream, topicMetricBean.name, topicMetricBean.value, cluster, namespace,
                topic, splitTopicAndPartitionIndexLabel, extraLabels);
        }
        ...
        stats.subscriptionStats.forEach((sub, subsStats) -> {
            ...
            String[] throttledLabels1 = mergeArrays(customMetricLabels, "subscription", sub, "reason", "subscription");
            String[] throttledLabels2 = mergeArrays(customMetricLabels, "subscription", sub, "reason", "topic");
            String[] throttledLabels3 = mergeArrays(customMetricLabels, "subscription", sub, "reason", "broker");
            ...
            writeTopicMetric(stream, "pulsar_subscription_dispatch_throttled_msg_events",
                ...
                splitTopicAndPartitionIndexLabel, throttledLabels1);
            ...
            writeTopicMetric(stream, "pulsar_subscription_dispatch_throttled_msg_events",
                ...
                splitTopicAndPartitionIndexLabel, throttledLabels2);
            writeTopicMetric(stream, "pulsar_subscription_dispatch_throttled_bytes_events",
            ...
            writeTopicMetric(stream, "pulsar_subscription_dispatch_throttled_msg_events",
                ...
                splitTopicAndPartitionIndexLabel, throttledLabels3);
            writeTopicMetric(stream, "pulsar_subscription_dispatch_throttled_bytes_events",
            ...
            for (TopicMetricBean topicMetricBean : subsStats.bucketDelayedIndexStats.values()) {
                ...
                String[] extraLabels = mergeArrays(customMetricLabels, labelsAndValues);
                writeTopicMetric(stream, topicMetricBean.name, topicMetricBean.value, cluster, namespace,
                    topic, splitTopicAndPartitionIndexLabel, extraLabels);
            }
    ...
    private static void writeBacklogQuotaMetric(PrometheusMetricStreams stream, String metricName, Number value,
        ...
        String[] extraLabels = mergeArrays(customMetricLabels, "quota_type", quotaTypeLabelValue);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeMetric(PrometheusMetricStreams stream, String metricName, Number value, String cluster,
                                    ...
                                    boolean splitTopicAndPartitionIndexLabel,
                                    String[] customMetricLabels) {
        String[] extraLabels = mergeArrays(customMetricLabels, "remote_cluster", remoteCluster);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeProducerMetric(PrometheusMetricStreams stream, String metricName, Number value,
                                            ...
                                            String[] customMetricLabels) {
        String[] extraLabels =
            mergeArrays(customMetricLabels, "producer_name", producer, "producer_id", String.valueOf(producerId));
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeSubscriptionMetric(PrometheusMetricStreams stream, String metricName, Number value,
                                                ...
                                                boolean splitTopicAndPartitionIndexLabel,
                                                String[] customMetricLabels) {
        String[] extraLabels = mergeArrays(customMetricLabels, "subscription", subscription);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeConsumerMetric(PrometheusMetricStreams stream, String metricName, Number value,
                                            ...
                                            String[] customMetricLabels) {
        String[] extraLabels =
            mergeArrays(customMetricLabels, "subscription", subscription, "consumer_name", consumer.consumerName(),
    ...
    /**
     * Merge custom metric labels array with extra labels.
     */
    private static String[] mergeArrays(String[] customLabels, String... extraLabels) {
        ...
        String[] merged = new String[customLabels.length + extraLabels.length];
        System.arraycopy(customLabels, 0, merged, 0, customLabels.length);
        System.arraycopy(extraLabels, 0, merged, customLabels.length, extraLabels.length);
        return merged;
    }
    ...
    static void writeTopicMetric(PrometheusMetricStreams stream, String metricName, Number value, String cluster,
        ...
        String[] labelsAndValues = new String[baseLabelCount + extraLabelsCount];
        ...
        // Add extra labels (including custom metric labels)
        if (extraLabelsAndValues != null) {
            System.arraycopy(extraLabelsAndValues, 0, labelsAndValues, baseLabelCount, extraLabelsAndValues.length);
        }
