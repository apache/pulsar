...
public class TopicStats {
    ...
    public static void printTopicStats(PrometheusMetricStreams stream, TopicStats stats,
        ...
        writeMetric(stream, "pulsar_storage_logical_size",
            ...
            splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        ...
        writeMetric(stream, "pulsar_storage_offloaded_size", stats.managedLedgerStats
            .offloadedStorageUsed, cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        ...
        writeBacklogQuotaMetric(stream, "pulsar_storage_backlog_quota_exceeded_evictions_total",
            ...
            splitTopicAndPartitionIndexLabel, BacklogQuotaType.destination_storage, customLabelsAndValues);
        writeBacklogQuotaMetric(stream, "pulsar_storage_backlog_quota_exceeded_evictions_total",
            stats.timeBasedBacklogQuotaExceededEvictionCount, cluster, namespace, topic,
            splitTopicAndPartitionIndexLabel, BacklogQuotaType.message_age, customLabelsAndValues);
        ...
        for (TopicMetricBean topicMetricBean : stats.bucketDelayedIndexStats.values()) {
            String[] extraLabels = mergeArrays(customLabelsAndValues, topicMetricBean.labelsAndValues);
        ...
        writeMetric(stream, "pulsar_storage_write_latency_le_0_5",
            latencyBuckets[0], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_1",
            latencyBuckets[1], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_5",
            latencyBuckets[2], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_10",
            latencyBuckets[3], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_20",
            latencyBuckets[4], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_50",
            latencyBuckets[5], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_100",
            latencyBuckets[6], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_200",
            latencyBuckets[7], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_le_1000",
            latencyBuckets[8], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        writeMetric(stream, "pulsar_storage_write_latency_overflow",
            latencyBuckets[9], cluster, namespace, topic, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        ...
        stats.subscriptionStats.forEach((sub, subsStats) -> {
            writeSubscriptionMetric(stream, "pulsar_subscription_back_log", subsStats.msgBacklog,
                cluster, namespace, topic, sub, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
            ...
            String[] throttledLabels1 =
                mergeArrays(customLabelsAndValues, "subscription", sub, "reason", "subscription");
            String[] throttledLabels2 = mergeArrays(customLabelsAndValues, "subscription", sub, "reason", "topic");
            String[] throttledLabels3 = mergeArrays(customLabelsAndValues, "subscription", sub, "reason", "broker");
            ...
            for (TopicMetricBean topicMetricBean : subsStats.bucketDelayedIndexStats.values()) {
                ...
                String[] extraLabels = mergeArrays(customLabelsAndValues, labelsAndValues);
                writeTopicMetric(stream, topicMetricBean.name, topicMetricBean.value, cluster, namespace,
                    topic, splitTopicAndPartitionIndexLabel, extraLabels);
            }
            ...
            subsStats.consumerStat.forEach((c, consumerStats) -> {
                writeConsumerMetric(stream, "pulsar_consumer_msg_rate_redeliver", consumerStats.msgRateRedeliver,
                    cluster, namespace, topic, sub, c, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
        ...
        if (!stats.replicationStats.isEmpty()) {
            stats.replicationStats.forEach((remoteCluster, replStats) -> {
                writeMetric(stream, "pulsar_replication_rate_in", replStats.msgRateIn,
                    cluster, namespace, topic, remoteCluster, splitTopicAndPartitionIndexLabel, customLabelsAndValues);
    ...
    private static void writeBacklogQuotaMetric(PrometheusMetricStreams stream, String metricName, Number value,
        ...
        String[] extraLabels = mergeArrays(customLabelsAndValues, "quota_type", quotaTypeLabelValue);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeMetric(PrometheusMetricStreams stream, String metricName, Number value, String cluster,
                                    ...
                                    boolean splitTopicAndPartitionIndexLabel,
                                    String[] customLabelsAndValues) {
        String[] extraLabels = mergeArrays(customLabelsAndValues, "remote_cluster", remoteCluster);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeProducerMetric(PrometheusMetricStreams stream, String metricName, Number value,
                                            ...
                                            String[] customLabelsAndValues) {
        String[] extraLabels =
            mergeArrays(customLabelsAndValues, "producer_name", producer, "producer_id", String.valueOf(producerId));
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
    ...
    private static void writeSubscriptionMetric(PrometheusMetricStreams stream, String metricName, Number value,
                                                ...
                                                boolean splitTopicAndPartitionIndexLabel,
                                                String[] customLabelsAndValues) {
        String[] extraLabels = mergeArrays(customLabelsAndValues, "subscription", subscription);
        writeTopicMetric(stream, metricName, value, cluster, namespace, topic, splitTopicAndPartitionIndexLabel,
            extraLabels);
    }
