...
@Getter
class RawEntryMetadataImpl implements RawEntryMetadata {
    private PositionImpl position;
    private MessageMetadata messageMetadata;
    private BrokerEntryMetadata brokerEntryMetadata;

    static RawEntryMetadataImpl parseFrom(long ledgerId, long entryId, ByteBuf headersAndPayload) {
        RawEntryMetadataImpl rawEntryMetadata = new RawEntryMetadataImpl();
