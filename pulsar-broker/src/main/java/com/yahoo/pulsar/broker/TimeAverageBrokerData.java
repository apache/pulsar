...
/**
 * Data class aggregating the short term and long term data across all bundles
 * belonging to a broker.
 */
public class TimeAverageBrokerData extends JSONWritable {
	 ...
	 * @param defaultStats
	 *            The stats to use when a bundle belonging to this broker is not
	 *            found in the bundle data map.
	 */
