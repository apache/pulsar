...
/**
 * Data class comprising the short term and long term historical data for this
 * bundle.
 */
public class BundleData extends JSONWritable {
	...
	/**
	 * Initialize this bundle data and have its histories default to the given
	 * stats before the first sample is received.
	 * 
	 * @param numShortSamples
	 *            Number of short term samples to use.
	 * @param numLongSamples
