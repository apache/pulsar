...
public class TimeAverageMessageData {
    ...
    // The number of samples that are currently available for this data. Always at most maxSamples.
    ...
    // Update the average of a sample using the number of samples, the previous average, and a new sample.
    private double getUpdatedValue(final double oldAverage, final double newSample) {
        ...
        // This ensures that default stats get overwritten after the first update.
