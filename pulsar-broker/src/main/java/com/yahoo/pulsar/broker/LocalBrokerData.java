...
public class LocalBrokerData extends JSONWritable implements ServiceLookupData {
	...
	/**
	 * Broker data constructor which takes in four URLs to satisfy the contract
	 * of ServiceLookupData.
	 */
	...
	/**
	 * Using the system resource usage and bundle stats acquired from the Pulsar
	 * client, update this LocalBrokerData.
	 * 
