 ...
 */
public class TimeAverageBundleData extends JSONWritable {
    ...
    // Common bundle data for this bundle.
    private BundleData bundleData;

    // For JSON only.
    public TimeAverageBundleData() {
     ...
     */
    public TimeAverageBundleData(final int numShortSamples, final int numLongSamples) {
        this();
