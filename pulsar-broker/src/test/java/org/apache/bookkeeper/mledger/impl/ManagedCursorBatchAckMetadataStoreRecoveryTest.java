...
public class ManagedCursorBatchAckMetadataStoreRecoveryTest extends ProducerConsumerBase {
    ...
    private Optional<Topic> getTopicReference(String topic) {
    ...
    public void testSharedConsumerSkipsPartiallyAcknowledgedBatchAfterTopicUnload() throws Exception {
        ...
        assertThat(persisted.getBatchedEntryDeletionIndexInfoCount())
                ...
                .isEqualTo(1);
        assertThat(persisted.getBatchedEntryDeletionIndexInfo(0).getPosition().getLedgerId())
                .isEqualTo(batchPosition.getLedgerId());
        assertThat(persisted.getBatchedEntryDeletionIndexInfo(0).getPosition().getEntryId())
                .isEqualTo(batchPosition.getEntryId());

        try (PulsarClient newClient = PulsarClient.builder().serviceUrl(pulsar.getBrokerServiceUrl()).build();
