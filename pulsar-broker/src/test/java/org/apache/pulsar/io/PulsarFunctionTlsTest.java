...
public class PulsarFunctionTlsTest {
  ...
  void setup(Method method) throws Exception {
    ...
    AuthorizationService authorizationService =
        new AuthorizationService(config, mock(PulsarResources.class));
  ...
  private PulsarWorkerService createPulsarFunctionWorker(
      ServiceConfiguration config, PulsarAdmin mockPulsarAdmin) {
    ...
    PulsarWorkerService workerService =
        new PulsarWorkerService(
            new PulsarClientCreator() {
              @Override
              public PulsarAdmin newPulsarAdmin(
                  String pulsarServiceUrl, WorkerConfig workerConfig) {
                return mockPulsarAdmin;
              }

              @Override
              public PulsarClient newPulsarClient(
                  String pulsarServiceUrl, WorkerConfig workerConfig) {
                return null;
              }
            });
  ...
  public void testWorkerServerNonTlsNotStarted() {
    assertFalse(
        workerServer.getListenPortHTTP().isPresent(), "Non-TLS worker service should not be set.");
  }
