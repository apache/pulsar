...
public class ServiceUnitStateCompactionTest extends MockedPulsarServiceBaseTest {
  ...
  public void testReadCompactedBeforeCompaction() throws Exception {
    ...
    String key = "key0";
    var testValues =
        Arrays.asList(testValue("content0"), testValue("content1"), testValue("content2"));
  ...
  public void testSlowTableviewAfterCompaction() throws Exception {
    ...
    var fastTV =
        pulsar
            ...
            .loadConf(
                Map.of(strategyClassName, ServiceUnitStateDataConflictResolver.class.getName()))
            .create();

    var defaultConf = getDefaultConf();
    @Cleanup var additionalPulsarTestContext = createAdditionalPulsarTestContext(defaultConf);
  ...
  public void testSlowReceiveTableviewAfterCompaction() throws Exception {
    ...
    var reader =
        ((CompletableFuture<ReaderImpl<ServiceUnitStateData>>)
  ...
  public void testAllEmptyCompactionLedger() throws Exception {
    ...
    ProducerBuilder<ServiceUnitStateData> builder =
        pulsarClient.newProducer(schema).compressionType(MSG_COMPRESSION_TYPE).topic(topic);
  ...
  public void testReadUnCompacted()
      throws PulsarClientException, ExecutionException, InterruptedException {
    final String topic =
        "persistent://my-property/use/my-ns/testReadUnCompacted" + UUID.randomUUID().toString();
