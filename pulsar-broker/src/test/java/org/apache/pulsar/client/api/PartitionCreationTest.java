...
public class PartitionCreationTest extends ProducerConsumerBase {
  ...
  public void testCreateConsumerForPartitionedTopicWhenDisableTopicAutoCreation(TopicDomain domain)
    ...
    final String topic =
        domain.value() + "://public/default/testCreateConsumerWhenDisableTopicAutoCreation";
  ...
  @Test(dataProvider = "topicDomainProvider", timeOut = 60000)
  public void testCreateConsumerForNonPartitionedTopicWhenDisableTopicAutoCreation(
      TopicDomain domain) throws PulsarClientException {
    ...
    try {
      ...
      if (domain == TopicDomain.persistent) {
        ...
        // passed non persistent topic here since we can not avoid auto creation on non persistent
        // topic now.
  ...
  @Test(dataProvider = "topicDomainProvider", timeOut = 60000)
  public void testCreateConsumerForNonPartitionedTopicWhenEnableTopicAutoCreation(
      TopicDomain domain) throws PulsarClientException {
    conf.setAllowAutoTopicCreation(true);
    final String topic =
        domain.value()
  ...
  @Test(timeOut = 60000)
  public void testCreateConsumerForPartitionedTopicUpdateWhenDisableTopicAutoCreation()
      throws Exception {
    conf.setAllowAutoTopicCreation(false);
    final String topic =
  ...
  public void testCreateMissedPartitions(boolean useRestApi)
    ...
    pulsar
        ...
        .createPartitionedTopicAsync(
            TopicName.get(topic), new PartitionedTopicMetadata(numPartitions));
