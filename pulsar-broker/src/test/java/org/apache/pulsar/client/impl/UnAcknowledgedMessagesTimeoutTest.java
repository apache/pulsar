...
public class UnAcknowledgedMessagesTimeoutTest extends BrokerTestBase {
      ...
      consumer =
          pulsarClient
              ...
              .ackTimeoutRedeliveryBackoff(
                  MultiplierRedeliveryBackoff.builder().minDelayMs(1000).maxDelayMs(20000).build())
              .subscribe();
    } else {
      consumer =
          pulsarClient
  ...
  @Test(dataProvider = "variationsRedeliveryTracker")
  public void testExclusiveCumulativeAckedNormalTopic(boolean isRedeliveryTracker)
      throws Exception {
  ...
  @Test(dataProvider = "variationsRedeliveryTracker")
  public void testFailoverSingleAckedPartitionedTopic(boolean isRedeliveryTracker)
      throws Exception {
  ...
  public void testAckTimeoutMinValue() {
    try {
      ...
      Assert.fail(
          "Exception should have been thrown since the set timeout is less than min timeout.");
      pulsarClient
          .newConsumer()
  ...
  @Test
  public void testCheckUnAcknowledgedMessageTimer()
  ...
  public void testSingleMessageBatch() throws Exception {
    ...
    consumer =
        pulsarClient
            ...
            .ackTimeout(1, TimeUnit.HOURS)
            .ackTimeoutRedeliveryBackoff(
                MultiplierRedeliveryBackoff.builder().minDelayMs(1000).maxDelayMs(60000).build())
            .subscribe();
    // Force the creation of a batch with a single message
    producer.sendAsync("hello");
    producer.flush();
