...
public class PatternTopicsConsumerImplAuthTest extends ProducerConsumerBase {
  ...
  private static final Logger log =
      LoggerFactory.getLogger(PatternTopicsConsumerImplAuthTest.class);
  ...
  public void testBinaryProtoToGetTopicsOfNamespace() throws Exception {
    ...
    admin
        ...
        .grantPermissionOnNamespace(
            "my-property/my-ns", clientRole, EnumSet.allOf(AuthAction.class));
  ...
  public static class TestAuthorizationProvider implements AuthorizationProvider {
    ...
    @Override
    public void initialize(ServiceConfiguration conf, PulsarResources resources)
        throws IOException {
      this.conf = conf;
      // No-op
    }
