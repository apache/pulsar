...
public class NonDurableSubscriptionTest extends ProducerConsumerBase {
    ...
    public void testInitReaderAtSpecifiedPosition() throws Exception {
        ...
        assertEquals(p1.getLedgerId(), ledgers.get(0).longValue());
        ...
        assertEquals(p2.getLedgerId(), ledgers.get(0).longValue());
        ...
        assertEquals(p6.getLedgerId(), ledgers.get(ledgers.size() - 1).longValue());
        ...
        assertEquals(p8.getLedgerId(), ledgers.get(2).longValue());
        ...
        assertEquals(p9.getLedgerId(), ledgers.get(3).longValue());
        ...
        assertEquals(p10.getLedgerId(), ledgers.get(2).longValue());
