...
public class ExposeMessageRedeliveryCountTest extends ProducerConsumerBase {
  ...
  @Test(timeOut = 30000)
  public void testRedeliveryCountWithPartitionedTopic()
  ...
  public void testRedeliveryCountWhenConsumerDisconnected() throws PulsarClientException {
    ...
    Assert.assertEquals(
        receivedMessagesForConsumer0.size() + receivedMessagesForConsumer1.size(), messages);
