...
public class V1_ProducerConsumerTest extends V1_ProducerConsumerBase {
    ...
    public void testConcurrentConsumerReceiveWhileReconnect(int batchMessageDelayMs) throws Exception {
        ...
        barrier.await();
        // there will be 10 threads calling receive(5, TimeUnit.SECONDS) from the same consumer and will block
        Thread.sleep(100);
        ...
        // publish 100 messages so that the consumers blocked on receive(5, TimeUnit.SECONDS) will now get the messages
        Producer<byte[]> producer = pulsarClient.newProducer()
                .topic(topic)
                .batchingMaxPublishDelay(BATCHING_MAX_PUBLISH_DELAY_THRESHOLD, TimeUnit.MILLISECONDS)
                .batchingMaxMessages(5)
        ...
        barrier.await();
        // we again make 10 threads call receive(5, TimeUnit.SECONDS) and get blocked
        Thread.sleep(100);
