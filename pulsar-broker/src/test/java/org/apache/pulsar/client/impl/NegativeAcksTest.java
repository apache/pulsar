...
public class NegativeAcksTest extends ProducerConsumerBase {
    ...
    public static Object[][] variations() {
        return new Object[][] {
                ...
                { false, false, SubscriptionType.Shared, 100, 20 },
                { false, false, SubscriptionType.Failover, 100, 20 },
                { false, true, SubscriptionType.Shared, 100, 20 },
                { false, true, SubscriptionType.Failover, 100, 20 },
                { true, false, SubscriptionType.Shared, 100, 20 },
                { true, false, SubscriptionType.Failover, 100, 20 },
                { true, true, SubscriptionType.Shared, 100, 20 },
                { true, true, SubscriptionType.Failover, 100, 20 },

                { false, false, SubscriptionType.Shared, 0, 20 },
                { false, false, SubscriptionType.Failover, 0, 20 },
                { false, true, SubscriptionType.Shared, 0, 20 },
                { false, true, SubscriptionType.Failover, 0, 20 },
                { true, false, SubscriptionType.Shared, 0, 20 },
                { true, false, SubscriptionType.Failover, 0, 20 },
                { true, true, SubscriptionType.Shared, 0, 20 },
                { true, true, SubscriptionType.Failover, 0, 20 },
        };
    }
