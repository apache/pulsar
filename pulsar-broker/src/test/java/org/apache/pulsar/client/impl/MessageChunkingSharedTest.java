...
public class MessageChunkingSharedTest extends ProducerConsumerBase {
  ...
  public void testMultiConsumers() throws Exception {
    ...
    @Cleanup
    final Consumer<String> consumer1 =
        consumerBuilder
            .messageListener(
                (MessageListener<String>) (consumer, msg) -> receivedValues1.add(msg.getValue()))
            .subscribe();
    final List<String> receivedValues2 = Collections.synchronizedList(new ArrayList<>());
    @Cleanup
    final Consumer<String> consumer2 =
        consumerBuilder
            .messageListener(
                (MessageListener<String>) (consumer, msg) -> receivedValues2.add(msg.getValue()))
            .subscribe();
  ...
  protected static void sendChunk(
      final PersistentTopic persistentTopic,
    ...
    final ByteBuf buf =
        Commands.serializeMetadataAndPayload(
            Commands.ChecksumType.Crc32c, metadata, Unpooled.wrappedBuffer("a".getBytes()));
