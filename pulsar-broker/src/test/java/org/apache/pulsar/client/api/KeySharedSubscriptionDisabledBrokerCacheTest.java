...
public class KeySharedSubscriptionDisabledBrokerCacheTest extends ProducerConsumerBase {
  private static final Logger log =
      LoggerFactory.getLogger(KeySharedSubscriptionDisabledBrokerCacheTest.class);
  ...
  public static Object[] createTestInstances() {
    return KeySharedImplementationType.generateTestInstances(
        KeySharedSubscriptionDisabledBrokerCacheTest::new);
  }
  ...
  public void testMessageOrderInSingleConsumerReconnect(KeySharedImplementationType impl)
      throws Exception {
          ...
          synchronized (this) {
            try {
              ...
              CompletableFuture.delayedExecutor(delayMillis, TimeUnit.MILLISECONDS)
                  .execute(() -> consumer.acknowledgeAsync(msg));
    ...
    // resume c2 so that permits are while hashes are unblocked so that possible race conditions
    // would
