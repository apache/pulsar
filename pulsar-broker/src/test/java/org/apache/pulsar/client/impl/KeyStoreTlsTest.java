...
public class KeyStoreTlsTest {
  ...
  public void testValidate() throws Exception {
    KeyStoreSSLContext serverSSLContext =
    ...
    KeyStoreSSLContext clientSSLContext =
        new KeyStoreSSLContext(
            ...
            false,
            null,
            // set client's protocol to TLSv1.2 since SSLContextValidatorEngine.validate doesn't
            // handle TLSv1.3
            Collections.singleton("TLSv1.2"));
    clientSSLContext.createSSLContext();

    SSLContextValidatorEngine.validate(
        clientSSLContext::createSSLEngine, serverSSLContext::createSSLEngine);
  }
