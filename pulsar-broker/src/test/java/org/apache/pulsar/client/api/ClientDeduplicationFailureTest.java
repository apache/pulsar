...
public class ClientDeduplicationFailureTest {
    ...
    void setup(Method method) throws Exception {
        ...
        ClusterData clusterData =
                ClusterData.builder().serviceUrl(url.toString()).build();
        ...
        ClientBuilder clientBuilder =
                PulsarClient.builder().serviceUrl(pulsar.getBrokerServiceUrl()).maxBackoffInterval(1, TimeUnit.SECONDS);
    ...
    public void testClientDeduplicationCorrectnessWithFailure() throws Exception {
        ...
        // send last message
        producer.newMessage()
                .sequenceId(producerThread.getLastSeqId() + 1)
                .value("end")
                .send();
        producer.close();
