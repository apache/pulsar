...
/** Test Mutual Authentication. Test connect set success, and producer consumer works well. */
...
public class MutualAuthenticationTest extends ProducerConsumerBase {
  ...
  public void testAuthentication() throws Exception {
    ...
    Consumer<byte[]> consumer =
        pulsarClient.newConsumer().topic(topic).subscriptionName("my-subscriber-name").subscribe();
