...
public class PatternTopicsConsumerImplTest extends ProducerConsumerBase {
    ...
    @Test(timeOut = 20000)
    public void testRecheckTopicsAfterTopicConsumerClosed() throws Exception {
        String baseTopicName = "persistent://my-property/my-ns/testRecheckTopicsAfterTopicConsumerClosed-"
    ...
    public void testCloseUnExistsTopicConsumer() throws Exception {
        ...
        Producer<String> producer2 = pulsarClient.newProducer(Schema.STRING)
                ...
                .create();
        Thread.sleep(2000);
        // Will ignore the block request. At this time, messages can still be consumed.
        sendMessage(producer2, "msg2-1", consumer);
    }
