...
public class PatternTopicsConsumerImplTest extends ProducerConsumerBase {
    ...
    public void testStartEmptyPatternConsumer() throws Exception {
        ...
        assertSame(pattern, ((PatternMultiTopicsConsumerImpl<?>) consumer).getPattern());
        assertEquals(
                ((PatternMultiTopicsConsumerImpl<?>) consumer).getPartitions().size(), 5);
        assertEquals(
                ((PatternMultiTopicsConsumerImpl<?>) consumer).getConsumers().size(), 5);
        assertEquals(
                ((PatternMultiTopicsConsumerImpl<?>) consumer)
                        .getPartitionedTopics()
                        .size(),
    ...
    public void testAutoSubscribePatternConsumer() throws Exception {
        ...
        assertEquals(
                ((PatternMultiTopicsConsumerImpl<?>) consumer).getConsumers().size(), 6);
        assertEquals(
                ((PatternMultiTopicsConsumerImpl<?>) consumer)
                        .getPartitionedTopics()
                        .size(),
    ...
    public void testTopicDeletion() throws Exception {
        ...
        assertTrue(pulsar.getBrokerService()
                .getTopicIfExists(baseTopicName + "-2")
                .join()
                .isPresent());
    }
}
