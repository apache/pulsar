...
public class ProducerEmptySchemaCacheTest {
  ...
  public void testProducerShouldCacheEmptySchema() throws Exception {
    ...
    mockBrokerService.setHandleGetOrCreateSchema(
        (ctx, commandGetOrCreateSchema) -> {
    ...
    for (int i = 10; i > 0; i--) {
      TypedMessageBuilder<byte[]> typedMessageBuilderNew =
          dlqProducer.newMessage(Schema.AUTO_PRODUCE_BYTES(readerSchema)).value("hello".getBytes());
