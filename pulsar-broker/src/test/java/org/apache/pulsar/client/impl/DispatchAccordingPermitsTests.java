...
public class DispatchAccordingPermitsTests extends ProducerConsumerBase {
  ...
  /**
   * The test case is to simulate dispatch batches with different batch size to the consumer. 1. The
   * consumer has 1000 available permits 2. The producer send batches with different batch size
   *
   * <p>According the batch average size dispatching, the broker will dispatch all the batches to
   * the consumer
   */
  @Test
  public void testFlowPermitsWithMultiBatchesDispatch()
