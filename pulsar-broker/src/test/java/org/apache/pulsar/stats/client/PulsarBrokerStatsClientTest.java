...
public class PulsarBrokerStatsClientTest extends ProducerConsumerBase {
  ...
  public void testServiceException() throws Exception {
    ...
    @Cleanup PulsarAdmin admin = PulsarAdmin.builder().serviceHttpUrl(url.toString()).build();
    ...
    assertTrue(
        client.getApiException(new ClientErrorException(403)) instanceof NotAuthorizedException);
    ...
    assertTrue(
        client.getApiException(new ClientErrorException(412))
            instanceof PreconditionFailedException);
    assertTrue(
        client.getApiException(new ClientErrorException(400)) instanceof PulsarAdminException);
    assertTrue(
        client.getApiException(new ServerErrorException(500)) instanceof ServerSideErrorException);
    assertTrue(
        client.getApiException(new ServerErrorException(503)) instanceof PulsarAdminException);
  ...
  public void testTopicInternalStats() throws Exception {
    ...
    assertTrue(
        cursor.totalNonContiguousDeletedMessagesRange > 0
