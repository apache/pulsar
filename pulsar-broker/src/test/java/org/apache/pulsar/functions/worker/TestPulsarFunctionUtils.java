...
public class TestPulsarFunctionUtils {
  ...
  void testParseMetrics() throws IOException {
    String sampleMetrics =
        IOUtils.toString(
            getClass().getClassLoader().getResourceAsStream("prometheus_metrics_sample.txt"),
   ...
   *
   * <p>This parser doesn't handle parsing multiple lines for a single metric key. There another
   * implementation in {@link org.apache.pulsar.broker.stats.PrometheusMetricsTest} that supports
