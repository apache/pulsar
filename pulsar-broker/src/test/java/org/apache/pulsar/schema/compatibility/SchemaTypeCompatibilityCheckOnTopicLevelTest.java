...
public class SchemaTypeCompatibilityCheckOnTopicLevelTest extends MockedPulsarServiceBaseTest {
  ...
  public void setup() throws Exception {
    ...
    admin
        .clusters()
        .createCluster(
            CLUSTER_NAME, ClusterData.builder().serviceUrl(pulsar.getWebServiceAddress()).build());
  ...
  public void testSetAlwaysInCompatibleStrategyOnTopicLevelAndCheckAlwaysInCompatible()
            ...
            () ->
                assertEquals(
                    pulsar
                        .getAdminClient()
                        .topicPolicies()
                        .getSchemaCompatibilityStrategy(topicName, true),
                    SchemaCompatibilityStrategy.ALWAYS_INCOMPATIBLE));

    pulsarClient
        .newProducer(
            Schema.AVRO(
                SchemaDefinition.<Schemas.PersonOne>builder()
    ...
    ProducerBuilder<Schemas.PersonThree> producerBuilder =
        pulsarClient
            .newProducer(
                Schema.AVRO(
                    SchemaDefinition.<Schemas.PersonThree>builder()
                        .withAlwaysAllowNull(true)
    ...
    Throwable t =
        expectThrows(
            PulsarClientException.IncompatibleSchemaException.class, producerBuilder::create);
    assertTrue(
        t.getMessage()
            .contains("org.apache.avro.SchemaValidationException: Unable to read schema"));
  }
  ...
  public void testSetAlwaysCompatibleOnNamespaceLevelAndCheckAlwaysInCompatible()
    ...
    admin
        ...
        .setSchemaCompatibilityStrategy(
            namespaceName, SchemaCompatibilityStrategy.ALWAYS_COMPATIBLE);
  ...
  public void testDisableTopicPoliciesAndSetAlwaysInCompatibleOnNamespaceLevel()
    ...
    admin
        .namespaces()
        .setSchemaCompatibilityStrategy(
            namespaceName, SchemaCompatibilityStrategy.ALWAYS_INCOMPATIBLE);
  ...
  public void testDefaultConfig()
      throws PulsarClientException, PulsarServerException, PulsarAdminException {
    String topicName =
        TopicName.get(TopicDomain.persistent.value(), PUBLIC_TENANT, namespace, "testDefaultConfig")
            .toString();
  ...
  public void testUpdateSchemaCompatibilityStrategyRepeatedly()
    ...
    // Set SchemaCompatibilityStrategy.ALWAYS_INCOMPATIBLE to
    // schema_auto_update_compatibility_strategy on
    // namespace level.
    admin
        .namespaces()
    ...
    // Set SchemaCompatibilityStrategy.ALWAYS_COMPATIBLE to schema_compatibility_strategy on
    // namespace level.
    admin
        .namespaces()
        .setSchemaCompatibilityStrategy(
    ...
    admin
        .namespaces()
        .setSchemaCompatibilityStrategy(namespaceName, SchemaCompatibilityStrategy.UNDEFINED);
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
