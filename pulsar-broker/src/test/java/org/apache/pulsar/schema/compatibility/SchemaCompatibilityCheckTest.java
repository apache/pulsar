...
public class SchemaCompatibilityCheckTest extends MockedPulsarServiceBaseTest {
  ...
  public void testConsumerCompatibilityCheckCanReadLastTest(
      SchemaCompatibilityStrategy schemaCompatibilityStrategy) throws Exception {
    final String tenant = PUBLIC_TENANT;
    final String topic = "test-consumer-compatibility";

    String namespace = "test-namespace-" + randomName(16);
    String fqtn =
        TopicName.get(TopicDomain.persistent.value(), tenant, namespace, topic).toString();
    ...
    admin
        .namespaces()
        .setSchemaCompatibilityStrategy(namespaceName.toString(), schemaCompatibilityStrategy);
    ...
    Consumer<Schemas.PersonThree> consumerThree =
        pulsarClient
            .newConsumer(
                Schema.AVRO(
    ...
    Producer<Schemas.PersonOne> producerOne =
        pulsarClient.newProducer(Schema.AVRO(Schemas.PersonOne.class)).topic(fqtn).create();
    ...
    Producer<Schemas.PersonTwo> producerTwo =
        pulsarClient
            .newProducer(
                Schema.AVRO(
                    SchemaDefinition.<Schemas.PersonTwo>builder()
                        .withAlwaysAllowNull(false)
                        .withSupportSchemaVersioning(true)
                        .withPojo(Schemas.PersonTwo.class)
                        .build()))
  ...
  public void testConsumerCompatibilityReadAllCheckTest(
      SchemaCompatibilityStrategy schemaCompatibilityStrategy) throws Exception {
    final String tenant = PUBLIC_TENANT;
    final String topic = "test-consumer-compatibility";
    String namespace = "test-namespace-" + randomName(16);
  ...
  public void testBrokerAllowAutoUpdateSchemaDisabled(
      SchemaCompatibilityStrategy schemaCompatibilityStrategy) throws Exception {
    ...
    ProducerBuilder<Schemas.PersonTwo> producerThreeBuilder =
        pulsarClient
            .newProducer(
                Schema.AVRO(
                    SchemaDefinition.<Schemas.PersonTwo>builder()
    ...
    try {
      ...
      Assert.assertTrue(
          e.getMessage().contains("Schema not found and schema auto updating is disabled."));
    }
  ...
  @Test(dataProvider = "AllCheckSchemaCompatibilityStrategy")
  public void testIsAutoUpdateSchema(SchemaCompatibilityStrategy schemaCompatibilityStrategy)
      throws Exception {
    final String tenant = PUBLIC_TENANT;
    final String topic = "test-consumer-compatibility";
  ...
  public void testSchemaComparison() throws Exception {
    ...
    assertEquals(
        admin.namespaces().getSchemaCompatibilityStrategy(namespaceName.toString()),
        SchemaCompatibilityStrategy.UNDEFINED);
    byte[] changeSchemaBytes =
        (new String(Schema.AVRO(Schemas.PersonOne.class).getSchemaInfo().getSchema(), UTF_8)
                + "\n   \n   \n")
            .getBytes();
  ...
  @Test(dataProvider = "AllCheckSchemaCompatibilityStrategy")
  public void testProducerSendWithOldSchemaAndConsumerCanRead(
      SchemaCompatibilityStrategy schemaCompatibilityStrategy) throws Exception {
    final String tenant = PUBLIC_TENANT;
    final String topic = "test-consumer-compatibility";
    String namespace = "test-namespace-" + randomName(16);
    ...
    Consumer<Schemas.PersonOne> consumerOne =
        pulsarClient
            .newConsumer(
                Schema.AVRO(
              ...
              SchemaDefinition.builder()
                  .withJsonDef(
                      String.format(
                          ...
                          i))
                  .build());
      Producer producer = pulsarClient.newProducer(schema).topic(topicName).create();
      producer.close();
    }
    // The other ledgers are about 5.
    Assert.assertTrue(
        pulsarTestContext.getMockBookKeeper().getLedgerMap().values().stream()
  ...
  @Test(dataProvider = "CanReadLastSchemaCompatibilityStrategy")
  public void testConsumerWithNotCompatibilitySchema(
      SchemaCompatibilityStrategy schemaCompatibilityStrategy) throws Exception {
    final String tenant = PUBLIC_TENANT;
    final String topic = "test-consumer-compatibility";
    ...
    try {
      pulsarClient
          .newConsumer(
              Schema.AVRO(
                  SchemaDefinition.<Schemas.PersonFour>builder()
                      .withAlwaysAllowNull(false)
                      .withSupportSchemaVersioning(true)
