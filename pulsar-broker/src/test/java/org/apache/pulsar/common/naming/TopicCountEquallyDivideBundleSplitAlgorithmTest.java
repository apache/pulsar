...
public class TopicCountEquallyDivideBundleSplitAlgorithmTest {
  ...
  public void testWrongArg() {
    TopicCountEquallyDivideBundleSplitAlgorithm algorithm =
        new TopicCountEquallyDivideBundleSplitAlgorithm();
    assertThrows(
        NullPointerException.class, () -> algorithm.getSplitBoundary(new BundleSplitOption()));
  }
  ...
  public void testTopicsSizeLessThan1() {
    ...
    assertNull(
        algorithm
            .getSplitBoundary(
                new BundleSplitOption(mockNamespaceService, mockNamespaceBundle, null))
            .join());
  }
