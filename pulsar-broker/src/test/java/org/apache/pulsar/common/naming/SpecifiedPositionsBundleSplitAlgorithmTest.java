...
public class SpecifiedPositionsBundleSplitAlgorithmTest {
  ...
  public void testEmptyTopicWithForce() {
    SpecifiedPositionsBundleSplitAlgorithm algorithm =
    ...
    List<Long> splitPositions =
        algorithm
            .getSplitBoundary(
                new BundleSplitOption(
                    mockNamespaceService, mockNamespaceBundle, Arrays.asList(1L, 2L)))
            .join();
    ...
    try {
      assertNull(
          algorithm
              .getSplitBoundary(
                  new BundleSplitOption(
                      mockNamespaceService, mockNamespaceBundle, new ArrayList<>()))
              .join());
  ...
  public void testAlgorithmReturnCorrectResult() {
    ...
    List<Long> splitPositions =
        algorithm
            .getSplitBoundary(
                new BundleSplitOption(mockNamespaceService, mockNamespaceBundle, positions))
            .join();
