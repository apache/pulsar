...
public class ProducerBatchSendTest extends ProducerConsumerBase {
    ...
    public void testNoEnoughMemSend(List<Integer> flushSend, CompressionType compressionType) throws Exception {
        ...
        // 6 KB payloads give the ZLIB cases a batch that is really compressed (and stay above the
        // compressMinMsgBodySize threshold on branches that have one) even when a single message is flushed.
