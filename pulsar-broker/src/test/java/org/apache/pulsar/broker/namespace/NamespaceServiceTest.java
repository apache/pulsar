...
public class NamespaceServiceTest extends BrokerTestBase {
    ...
    public void testModularLoadManagerRemoveInactiveBundleFromLoadData() throws Exception {
        ...
        pulsar.getNamespaceService().splitAndOwnBundle(oldBundle, false, NamespaceBundleSplitAlgorithm.RANGE_EQUALLY_DIVIDE_ALGO).get();
    ...
    public void testModularLoadManagerRemoveBundleAndLoad() throws Exception {
        ...
        NamespaceBundle bundle =
                pulsar.getNamespaceService().getNamespaceBundleFactory().getFullBundle(TopicName.get(topic1).getNamespaceObject());
