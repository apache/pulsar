...
public class ReplicatorTopicPoliciesTest extends ReplicatorTestBase {
  ...
  public void testReplicateMaxMessageSizePolicies() throws Exception {
    ...
    untilRemoteClustersAsserted(
        admin -> assertNull(admin.topicPolicies().getMaxMessageSize(topic)));
    // global
    ...
    untilRemoteClustersAsserted(
        admin ->
            assertEquals(
                admin.topicPolicies(true).getMaxMessageSize(topic), Integer.valueOf(1000)));
  ...
  public void testReplicateDeduplicationSnapshotIntervalPolicies() throws Exception {
    ...
    untilRemoteClustersAsserted(
        admin ->
            assertEquals(
                admin.topicPolicies(true).getDeduplicationSnapshotInterval(topic),
                Integer.valueOf(100)));
  ...
  public void testReplicatePersistentPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getPersistence(topic)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getPersistence(topic)));
    // global
  ...
  public void testReplicateDeduplicationStatusPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getDeduplicationStatus(topic)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getDeduplicationStatus(topic)));
    // global
  ...
  public void testReplicatorMaxProducer() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getMaxProducers(topic)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getMaxProducers(topic)));
    // global
  ...
  public void testReplicatorMaxConsumerPerSubPolicies() throws Exception {
    ...
    Awaitility.await()
        ...
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getMaxConsumersPerSubscription(topic).intValue(),
                    100));
    Awaitility.await()
        .ignoreExceptions()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getMaxConsumersPerSubscription(topic).intValue(),
                    100));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertEquals(
                  admin1.topicPolicies(true).getMaxConsumersPerSubscription(topic).intValue(), 100);
            });
  ...
  public void testReplicateMaxUnackedMsgPerConsumer() throws Exception {
    ...
    Awaitility.await()
        ...
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getMaxUnackedMessagesOnConsumer(topic).intValue(),
                    100));
    Awaitility.await()
        .ignoreExceptions()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getMaxUnackedMessagesOnConsumer(topic).intValue(),
                    100));
  ...
  public void testReplicatorTopicPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getRetention(persistentTopicName)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getRetention(persistentTopicName)));
    // global
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getRetention(persistentTopicName),
                    retentionPolicies));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getRetention(persistentTopicName),
                    retentionPolicies));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertEquals(
                  admin1.topicPolicies(true).getRetention(persistentTopicName), retentionPolicies);
            });
  ...
  public void testReplicateSubscriptionTypesPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getSubscriptionTypesEnabled(topic),
                    subscriptionTypes));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getSubscriptionTypesEnabled(topic),
                    subscriptionTypes));
    // remove subscription types policies
  ...
  public void testReplicateMaxConsumers() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getMaxConsumers(topic)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getMaxConsumers(topic)));
    // global
  ...
  public void testReplicatorMessageDispatchRatePolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getDispatchRate(persistentTopicName), dispatchRate));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getDispatchRate(persistentTopicName), dispatchRate));
  ...
  public void testReplicateDelayedDelivery() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin2.topicPolicies().getDelayedDeliveryPolicy(topic)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin3.topicPolicies().getDelayedDeliveryPolicy(topic)));
    // global
  ...
  public void testReplicatorSubscriptionDispatchRatePolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertNull(
                    admin2.topicPolicies().getSubscriptionDispatchRate(persistentTopicName)));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertNull(
                    admin3.topicPolicies().getSubscriptionDispatchRate(persistentTopicName)));
    // global
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getSubscriptionDispatchRate(persistentTopicName),
                    dispatchRate));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getSubscriptionDispatchRate(persistentTopicName),
                    dispatchRate));
  ...
  public void testReplicateReplicatorDispatchRatePolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getReplicatorDispatchRate(persistentTopicName),
                    dispatchRate));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getReplicatorDispatchRate(persistentTopicName),
                    dispatchRate));
  ...
  public void testReplicatorCompactionThresholdPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getCompactionThreshold(persistentTopicName),
                    Long.valueOf(1)));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getCompactionThreshold(persistentTopicName),
                    Long.valueOf(1)));
  ...
  public void testReplicateMaxSubscriptionsPerTopic() throws Exception {
    ...
    untilRemoteClustersAsserted(
        admin ->
            assertEquals(
                admin.topicPolicies(true).getMaxSubscriptionsPerTopic(persistentTopicName),
    ...
    untilRemoteClustersAsserted(
        admin ->
            assertNull(admin.topicPolicies(true).getMaxSubscriptionsPerTopic(persistentTopicName)));
  }
  ...
  public void testReplicatorOffloadPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin2.topicPolicies(true).getOffloadPolicies(persistentTopicName),
                    offloadPolicies));
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin3.topicPolicies(true).getOffloadPolicies(persistentTopicName),
                    offloadPolicies));
        ...
        .untilAsserted(
            () -> {
              List<String> replicaClusters =
                  topicRef.getReplicators().keySet().stream().sorted().toList();
  ...
  private void init(String namespace, String topic) throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> assertEquals(admin2.topics().getPartitionedTopicList(namespace).get(0), topic));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> assertEquals(admin3.topics().getPartitionedTopicList(namespace).get(0), topic));
