...
public class TopicGCTest extends ProducerConsumerBase {
  ...
  public Object[][] subTopicTypes() {
    return new Object[][] {
      {SubscribeTopicType.MULTI_PARTITIONED_TOPIC}, {SubscribeTopicType.REGEX_TOPIC}
    };
  }
  ...
  public void testRecreateConsumerAfterOnePartGc(SubscribeTopicType subscribeTopicType)
      throws Exception {
    ...
    Producer<String> producer0 =
        pulsarClient.newProducer(Schema.STRING).topic(partition0).enableBatching(false).create();
    Producer<String> producer1 =
        pulsarClient.newProducer(Schema.STRING).topic(partition1).enableBatching(false).create();
  ...
  @Test(dataProvider = "subscribeTopicTypes", timeOut = 300 * 1000)
  public void testAppendCreateConsumerAfterOnePartGc(SubscribeTopicType subscribeTopicType)
      throws Exception {
    final String topic = BrokerTestUtil.newUniqueName("persistent://public/default/tp");
    final String topicPattern = "persistent://public/default/tp.*";
    final String partition0 = topic + "-partition-0";
    ...
    PatternMultiTopicsConsumerImpl<String> c1 =
        (PatternMultiTopicsConsumerImpl<String>)
            pulsarClient
                ...
                .isAckReceiptEnabled(true)
                .subscriptionType(SubscriptionType.Shared)
                .topicsPattern(Pattern.compile(topicPattern))
                .subscribe();
    // Check subscriptions.
    Awaitility.await()
        .untilAsserted(
