...
public class MetadataStoreStatsTest extends BrokerTestBase {
  ...
  protected ServiceConfiguration getDefaultConf() {
    ...
    // org.apache.pulsar.metadata.impl.stats.BatchMetadataStoreStats.close method which unregisters
    // metrics
    // asynchronously. This impacts the execution of the next test method if this would be
    // happening.
  ...
  public void testMetadataStoreStats() throws Exception {
    ...
    Consumer<String> consumer =
        pulsarClient.newConsumer(Schema.STRING).topic(topic).subscriptionName(subName).subscribe();
