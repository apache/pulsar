...
public class NamespacesTest extends MockedPulsarServiceBaseTest {
    ...
    public void testSetIncorrectPersistentPolicies(int ensembleSize, int writeQuorum, int ackQuorum) throws Exception {
        ...
        try {
            ...
            Assert.assertEquals(rex.getResponse().getStatus(), Status.BAD_REQUEST.getStatusCode());
        }
    }
    ...
    public void testFinallyDeleteSystemTopicWhenDeleteNamespace() throws Exception {
        ...
        Field policesService = PulsarService.class.getDeclaredField("topicPoliciesService");
        ...
        Field namespaceServiceField = PulsarService.class.getDeclaredField("nsService");
