...
public class AdminApiGetMessageCountTest extends MockedPulsarServiceBaseTest {
    ...
    protected void setup() throws Exception {
        ...
        admin.namespaces().setNamespaceReplicationClusters("my-tenant/my-ns", Sets.newHashSet("test"));
    ...
    public void testGetMessageCount() throws Exception {
        ...
        final String topicName = "persistent://my-tenant/my-ns/my-topic";
        final String messageStr = "my-message-";
        ...
        for (int i = 0; i < numberOfMessages; i++) {
            String message = messageStr + i;
            producer.send(message.getBytes());
        }

        // Get message count
        long count = persistentTopics.getMessageCount("my-tenant", "my-ns", "my-topic", true);
        Assert.assertEquals(numberOfMessages, count);
    }
}
