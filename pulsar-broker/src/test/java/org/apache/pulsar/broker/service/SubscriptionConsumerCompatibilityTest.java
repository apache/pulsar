...
public class SubscriptionConsumerCompatibilityTest {
  ...
  public Object[][] incompatibleKeySharedPolicies() {
    ...
    KeySharedMeta ksmStickyAllowOutOfOrder =
        new KeySharedMeta().setKeySharedMode(KeySharedMode.STICKY).setAllowOutOfOrderDelivery(true);
    ...
    KeySharedMeta ksmAutoSplitAllowOutOfOrder =
        new KeySharedMeta()
    ...
    String errorMessageSubscriptionModeSticky =
        errorMessagePrefix
            + "Active subscription key_shared mode of "
            + "'STICKY' is different than the connecting consumer's key_shared mode 'AUTO_SPLIT'.";
    String errorMessageSubscriptionModeAutoSplit =
        errorMessagePrefix
            + "Active subscription key_shared mode of "
            + "'AUTO_SPLIT' is different than the connecting consumer's key_shared mode 'STICKY'.";
    String errorMessageOutOfOrderNotAllowed =
        errorMessagePrefix
            + "Active subscription does not allow out of "
            + "order delivery while the connecting consumer allows it.";
    String errorMessageOutOfOrderAllowed =
        errorMessagePrefix
            + "Active subscription allows out of order delivery "
  ...
  public void testIncompatibleKeySharedPoliciesNotAllowedInNonPersistentSub(
      KeySharedMeta consumer1Ksm, KeySharedMeta consumer2Ksm, String expectedErrorMessage)
      throws Exception {
    NonPersistentTopic topic =
        new NonPersistentTopic(successTopicName, pulsarTestContext.getBrokerService());
    ...
    // first consumer defines key_shared mode of subscription and whether out of order delivery is
    // allowed
  ...
  @Test(dataProvider = "incompatibleKeySharedPolicies")
  public void testIncompatibleKeySharedPoliciesNotAllowedInPersistentSub(
      KeySharedMeta consumer1Ksm, KeySharedMeta consumer2Ksm, String expectedErrorMessage)
      throws Exception {
