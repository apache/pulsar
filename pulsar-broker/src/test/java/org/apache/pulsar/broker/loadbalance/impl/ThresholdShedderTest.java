...
public class ThresholdShedderTest {
  ...
  public void testBrokerWithMultipleBundles() {
    ...
    Multimap<String, String> bundlesToUnload =
        thresholdShedder.findBundlesForUnloading(loadData, conf);
  ...
  public void testFilterRecentlyUnloaded() {
    ...
    assertFalse(bundlesToUnload.isEmpty());
    assertEquals(
        bundlesToUnload.get("broker-1"), List.of("bundle-8", "bundle-7", "bundle-6", "bundle-5"));
  }
  ...
  public void testLowerBoundaryShedding() {
    ...
    // At this time, the average load is 80*10/11 = 72.73, and the threshold for rebalancing is
    // 72.73 + 10 = 82.73.
