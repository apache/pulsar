...
public class TopicPoliciesTest extends MockedPulsarServiceBaseTest {
  ...
  public void updatePropertiesForAutoCreatedTopicTest() throws Exception {
    ...
    @Cleanup Producer<byte[]> producer = pulsarClient.newProducer().topic(testTopic).create();
  ...
  public void testTopicPolicyInitialValueWithNamespaceAlreadyLoaded() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              AbstractTopic topic1 =
                  (AbstractTopic) pulsar.getBrokerService().getTopic(topic, true).get().get();
              assertEquals(
                  topic1.getHierarchyTopicPolicies().getMaxSubscriptionsPerTopic().get(),
                  Integer.valueOf(10));
            });
    // unload the topic
    pulsar
        .getNamespaceService()
        .unloadNamespaceBundle(pulsar.getNamespaceService().getBundle(topicName))
        .get();
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertTrue(
                  policyService.getPoliciesCacheInit(topicName.getNamespaceObject()).isDone());
            });
  ...
  public void testSetSizeBasedBacklogQuota() throws Exception {
    ...
    admin
        .topicPolicies()
        .setBacklogQuota(
            testTopic, backlogQuota, BacklogQuota.BacklogQuotaType.destination_storage);
    ...
    for (int i = 0; i < testTopicPartitions; i++) {
      ...
      BacklogQuota backlogQuotaInTopic =
          topic.getBacklogQuota(BacklogQuota.BacklogQuotaType.destination_storage);
      log.info(
          "Backlog quota {} in backlog quota manager on topic: {}", backlogQuotaInTopic, testTopic);
  ...
  public void testSetTimeBasedBacklogQuota() throws Exception {
    ...
    admin
        .topicPolicies()
        .setBacklogQuota(testTopic, backlogQuota, BacklogQuota.BacklogQuotaType.message_age);
    ...
    for (int i = 0; i < testTopicPartitions; i++) {
      ...
      Topic topic = pulsar.getBrokerService().getTopic(partition, false).get().get();
      BacklogQuota backlogQuotaInTopic =
          topic.getBacklogQuota(BacklogQuota.BacklogQuotaType.message_age);
      Assert.assertEquals(backlogQuota, backlogQuotaInTopic);
    }
  ...
  public void testRemoveSizeBasedBacklogQuota() throws Exception {
    ...
    for (int i = 0; i < testTopicPartitions; i++) {
      ...
      BacklogQuota defaultBacklogQuota =
          topic.getBacklogQuota(BacklogQuota.BacklogQuotaType.destination_storage);
    ...
    partitions.forEach(
        topic -> {
          BacklogQuota backlogQuotaInTopic =
              topic.getBacklogQuota(BacklogQuota.BacklogQuotaType.destination_storage);
          log.info(
              "Backlog quota {} in backlog quota manager on topic: {}",
              backlogQuotaInTopic,
              testTopic);
          Assert.assertEquals(backlogQuota, backlogQuotaInTopic);
        });
    ...
    admin
        .topicPolicies()
        .removeBacklogQuota(testTopic, BacklogQuota.BacklogQuotaType.destination_storage);
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertNull(
    ...
    for (int i = 0; i < partitions.size(); i++) {
      ...
      log.info(
          "Backlog quota {} in backlog quota manager on topic: {} after remove",
          backlogQuotaInTopic,
          testTopic);
  ...
  public void testCheckSizeBasedBacklogQuota() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(admin.namespaces().getRetention(namespace), retentionPolicies));
  ...
  public Object[][] clientRequestType() {
    return new Object[][] {{"PULSAR_ADMIN"}, {"HTTP"}};
  }
            ...
            () -> {
              assertEquals(
                  topicPoliciesService
                      .getTopicPoliciesAsync(topicName, LOCAL_ONLY)
                      .join()
                      .get()
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              ...
              assertEquals(
                  topicPoliciesService
                      .getTopicPoliciesAsync(topicName, GLOBAL_ONLY)
                      .join()
                      .get()
                      .getMaxConsumerPerTopic(),
                  20);
  ...
  public void testGetSizeBasedBacklogQuotaApplied() throws Exception {
    ...
    admin
        .topicPolicies()
        .setBacklogQuota(topic, topicQuota, BacklogQuota.BacklogQuotaType.destination_storage);
    Awaitility.await()
        .untilAsserted(
            () -> assertFalse(admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
            ...
            () ->
                assertTrue(
                    admin
                        ...
                        == null));
    Awaitility.await()
        .untilAsserted(() -> assertTrue(admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
    assertTrue(
        admin
                .topicPolicies()
                .getBacklogQuotaMap(topic, true)
                .get(BacklogQuota.BacklogQuotaType.destination_storage)
            == null);
  }
  ...
  public void testGetTimeBasedBacklogQuotaApplied() throws Exception {
    ...
    admin
        .namespaces()
        .setBacklogQuota(myNamespace, namespaceQuota, BacklogQuota.BacklogQuotaType.message_age);
    Awaitility.await()
        .untilAsserted(
            () -> assertFalse(admin.namespaces().getBacklogQuotaMap(myNamespace).isEmpty()));
    Map<BacklogQuota.BacklogQuotaType, BacklogQuota> namespaceQuotaMap = new HashMap<>();
    ...
    admin
        .topicPolicies()
        .setBacklogQuota(topic, topicQuota, BacklogQuota.BacklogQuotaType.message_age);
    Awaitility.await()
        .untilAsserted(
            () -> assertFalse(admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
    Map<BacklogQuota.BacklogQuotaType, BacklogQuota> topicQuotaMap = new HashMap<>();
  ...
  public void testCheckRetentionSizeBasedQuota() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(admin.topicPolicies().getRetention(testTopic), finalRetention));
  ...
  private void assertInvalidRetentionPolicy(
      String topicName, int retentionTimeInMinutes, int retentionSizeInMB) {
    try {
      RetentionPolicies retention =
          new RetentionPolicies(retentionTimeInMinutes, retentionSizeInMB);
  ...
  public void testRetentionAppliedApi() throws Exception {
    ...
    RetentionPolicies brokerPolicies =
        new RetentionPolicies(
            conf.getDefaultRetentionTimeInMinutes(), conf.getDefaultRetentionSizeInMB());
  ...
  public void testGetSubDispatchRateApplied() throws Exception {
    ...
    DispatchRate brokerDispatchRate =
        DispatchRate.builder()
            ...
            .build();
    assertEquals(
        admin.topicPolicies().getSubscriptionDispatchRate(topic, true), brokerDispatchRate);
    ...
    assertEquals(
        admin.topicPolicies().getSubscriptionDispatchRate(topic, true), namespaceDispatchRate);
    ...
    Awaitility.await()
        .untilAsserted(
            () -> assertNotNull(admin.topicPolicies().getSubscriptionDispatchRate(topic)));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> assertNull(admin.namespaces().getSubscriptionDispatchRate(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getSubscriptionDispatchRate(topic)));
    assertEquals(
        admin.topicPolicies().getSubscriptionDispatchRate(topic, true), brokerDispatchRate);
  ...
  public void testRetentionPriority() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.namespaces().getRetention(myNamespace)));
    assertFalse((boolean) shouldTopicBeRetained.invoke(persistentTopic));
    // set topic-level policy
    admin.topicPolicies().setRetention(topic, new RetentionPolicies(3, 1));
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getRetention(topic)));
    ...
    admin.topicPolicies().removeRetention(topic);
    Awaitility.await().untilAsserted(() -> assertNull(admin.topicPolicies().getRetention(topic)));
    assertFalse((boolean) shouldTopicBeRetained.invoke(persistentTopic));
    ...
    admin.namespaces().removeRetention(myNamespace);
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getRetention(myNamespace)));
    // the default value of the broker-level is 0, so it is not retained by default
    assertFalse((boolean) shouldTopicBeRetained.invoke(persistentTopic));
  }
  ...
  public void testGetPersistenceApplied() throws Exception {
    ...
    PersistencePolicies namespacePolicy = new PersistencePolicies(5, 4, 3, 2);

    admin.namespaces().setPersistence(myNamespace, namespacePolicy);
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.namespaces().getPersistence(myNamespace)));
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getPersistence(topic)));
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getPersistence(myNamespace)));
  ...
  public void testSetPersistence() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getPersistence(myNamespace),
                    persistencePoliciesForNamespace));

    PersistencePolicies persistencePolicies = new PersistencePolicies(3, 3, 3, 0.1);
    log.info(
        "PersistencePolicies: {} will set to the topic: {}", persistencePolicies, persistenceTopic);
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getPersistence(persistenceTopic), persistencePolicies));
    Consumer<byte[]> consumer =
        pulsarClient.newConsumer().topic(persistenceTopic).subscriptionName("test").subscribe();
    ...
    PersistencePolicies getPersistencePolicies =
        admin.topicPolicies().getPersistence(persistenceTopic);
    log.info(
        "PersistencePolicies: {} will set to the topic: {}", persistencePolicies, persistenceTopic);
  ...
  public void testSetIncorrectPersistentPolicies(int ensembleSize, int writeQuorum, int ackQuorum)
      throws Exception {
    admin.topics().createNonPartitionedTopic(persistenceTopic);
    PersistencePolicies persistence1 =
        new PersistencePolicies(ensembleSize, writeQuorum, ackQuorum, 0.0);
  ...
  public void testGetDispatchRateApplied() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.namespaces().getDispatchRate(myNamespace)));
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getDispatchRate(topic)));
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getDispatchRate(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getDispatchRate(topic)));
    assertEquals(admin.topicPolicies().getDispatchRate(topic, true), brokerDispatchRate);
  }
  ...
  public void testRemovePersistence() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getPersistence(persistenceTopic)));
  ...
  public void testGetMaxProducerApplied() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getMaxProducersPerTopic(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getMaxProducers(topic)));
    assertEquals(
        admin.topicPolicies().getMaxProducers(topic, true).intValue(),
        conf.getMaxProducersPerTopic());
  }

  private void waitTopicPoliciesApplied(
      String topic, int partitions, java.util.function.Consumer<HierarchyTopicPolicies> condition) {
  ...
  public void testSetMaxProducers() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getMaxProducers(persistenceTopic), maxProducers));
  ...
  public void testRemoveMaxProducers() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getMaxProducers(persistenceTopic)));
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getMaxProducersPerTopic(myNamespace).intValue(), 3));
  ...
  public void testGetSetDispatchRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getDispatchRate(testTopic), dispatchRate));
  ...
  public void testRestart() throws Exception {
    ...
    InactiveTopicPolicies inactiveTopicPolicies =
        new InactiveTopicPolicies(
            InactiveTopicDeleteMode.delete_when_subscriptions_caught_up, 100, true);
        ...
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin
                        .namespaces()
                        .getInactiveTopicPolicies(myNamespace)
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getRetention(myNamespace), retentionPolicies));
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getRetention(topic), finalRetentionPolicies));
        ...
        .untilAsserted(
            () -> {
              ...
              ManagedLedgerConfig managedLedgerConfig =
                  persistentTopic.getManagedLedger().getConfig();
              Assert.assertEquals(
                  persistentTopic.getInactiveTopicPolicies(), finalInactiveTopicPolicies);
              Assert.assertEquals(
                  managedLedgerConfig.getRetentionSizeInMB(),
                  finalRetentionPolicies.getRetentionSizeInMB());
              Assert.assertEquals(
                  managedLedgerConfig.getRetentionTimeMillis(),
  ...
  public void testGetSetSubscriptionDispatchRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscriptionDispatchRate(topic), dispatchRate));
    ...
    Assert.assertEquals(
        dispatchRateLimiter.getDispatchRateOnMsg(), dispatchRate.getDispatchThrottlingRateInMsg());
  ...
  public void testSubscriptionLevelDispatchRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscriptionDispatchRate(topic), topicLevelRate));

    // topic level is set, applied value should be topic level setting.
    Assert.assertEquals(
        admin.topicPolicies().getSubscriptionDispatchRate(topic, subscriptionName, true),
        topicLevelRate);
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscriptionDispatchRate(topic, subscriptionName),
                    subLevelRate));
    ...
    DispatchRateLimiter dispatchRateLimiter =
        abstractTopic.getSubscription(subscriptionName).getDispatcher().getRateLimiter().get();
    Assert.assertNotNull(dispatchRateLimiter);
    Assert.assertEquals(
        dispatchRateLimiter.getDispatchRateOnByte(),
        subLevelRate.getDispatchThrottlingRateInByte());
    Assert.assertEquals(
        dispatchRateLimiter.getDispatchRateOnMsg(), subLevelRate.getDispatchThrottlingRateInMsg());
        ...
        .untilAsserted(
            () -> {
              ...
              Assert.assertNotEquals(
                  drl.getDispatchRateOnMsg(), dispatchRate.getDispatchThrottlingRateInMsg());
              Assert.assertNotEquals(
                  drl.getDispatchRateOnByte(), dispatchRate.getDispatchThrottlingRateInByte());
            });
  ...
  public void testSubscriptionDispatchRatePolicyOverwrittenNamespaceLevel() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getSubscriptionDispatchRate(myNamespace),
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscriptionDispatchRate(topic), topicDispatchRate));
    ...
    Assert.assertEquals(
        dispatchRateLimiter.getDispatchRateOnByte(),
        topicDispatchRate.getDispatchThrottlingRateInByte());
    Assert.assertEquals(
        dispatchRateLimiter.getDispatchRateOnMsg(),
        topicDispatchRate.getDispatchThrottlingRateInMsg());
  ...
  public void testGetSetCompactionThreshold() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getCompactionThreshold(testTopic), compactionThreshold));
  ...
  public void testRemoveCompactionThreshold() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getCompactionThreshold(testTopic)));
  ...
  public void testGetSetMaxConsumersPerSubscription() throws Exception {
    ...
    log.info(
        "MaxConsumersPerSubscription: {} will set to the topic: {}",
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getMaxConsumersPerSubscription(testTopic),
                    maxConsumersPerSubscription));
  ...
  public void testRemoveMaxConsumersPerSubscription() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin.namespaces().getMaxConsumersPerSubscription(myNamespaceV1).intValue(),
                    20));
  ...
  public void testGetSetPublishRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(admin.topicPolicies().getPublishRate(testTopic), publishRate));
  ...
  public void testGetMaxConsumersApplied() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getMaxConsumersPerTopic(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getMaxConsumers(topic)));
    assertEquals(
        admin.topicPolicies().getMaxConsumers(topic, true).intValue(),
        conf.getMaxConsumersPerTopic());
  }
  ...
  public void testSetMaxConsumers() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getMaxConsumersPerTopic(myNamespace).intValue(), 1));
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getMaxConsumers(persistenceTopic), maxConsumers));
  ...
  public void testRemoveMaxConsumers() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getMaxConsumers(persistenceTopic)));
    ...
    try {
      consumer4 =
          pulsarClient.newConsumer().subscriptionName("sub4").topic(persistenceTopic).subscribe();
      Assert.fail();
    } catch (PulsarClientException e) {
  ...
  public void testDisableSubscribeRate() throws Exception {
    ...
    PersistentTopic topic =
        (PersistentTopic) pulsar.getBrokerService().getTopicIfExists(persistenceTopic).get().get();
  ...
  public void testGetSetSubscribeRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.namespaces().getSubscribeRate(myNamespace), subscribeRate1));
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscribeRate(persistenceTopic), subscribeRate2));
  ...
  public void testGetSubscribeRateApplied() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.namespaces().getSubscribeRate(myNamespace)));
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getSubscribeRate(topic)));
    assertEquals(admin.topicPolicies().getSubscribeRate(topic, true), topicPolicy);

    admin.namespaces().removeSubscribeRate(myNamespace);
    admin.topicPolicies().removeSubscribeRate(topic);
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getSubscribeRate(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getSubscribeRate(topic)));
    assertEquals(admin.topicPolicies().getSubscribeRate(topic, true), brokerPolicy);
  }
  ...
  public void testPriorityAndDisableMaxConsumersOnSub() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin.namespaces().getMaxConsumersPerSubscription(myNamespace).intValue(), 0));
    consumerList.add(builder.subscribe());
    // set topic-level
  ...
  public void testRemoveSubscribeRate() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topicPolicies().getSubscribeRate(persistenceTopic), subscribeRate));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getSubscribeRate(persistenceTopic)));
  ...
  public void testPublishRateInDifferentLevelPolicy() throws Exception {
    ...
    PublishRateLimiterImpl publishRateLimiter =
        (PublishRateLimiterImpl) topic.getTopicPublishRateLimiter();
        ...
        .until(
            () ->
                TopicPolicyTestUtils.getTopicPolicies(
                        pulsar.getTopicPoliciesService(), TopicName.get(persistenceTopic))
                    != null);
  ...
  public void testTopicMaxMessageSize(TopicDomain topicDomain, boolean isPartitioned)
      throws Exception {
    final String topic =
        TopicName.get(
                topicDomain.value(), NamespaceName.get(myNamespace), "test-" + UUID.randomUUID())
            .toString();
    ...
    Awaitility.await()
        .until(
            () ->
                TopicPolicyTestUtils.getTopicPolicies(
                        pulsar.getTopicPoliciesService(), TopicName.get(topic))
                    != null);
    if (isPartitioned) {
      for (int i = 0; i < 3; i++) {
            ...
            .untilAsserted(
                () -> {
                  AbstractTopic partition =
                      (AbstractTopic)
                          pulsar.getBrokerService().getTopicIfExists(partitionName).get().get();
                  assertEquals(
                      partition.getHierarchyTopicPolicies().getTopicMaxMessageSize().get(),
                      Integer.valueOf(10));
                });
      }
    } else {
          ...
          .untilAsserted(
              () -> {
                AbstractTopic abstractTopic =
                    (AbstractTopic) pulsar.getBrokerService().getTopicIfExists(topic).get().get();
                assertEquals(
                    abstractTopic.getHierarchyTopicPolicies().getTopicMaxMessageSize().get(),
                    Integer.valueOf(10));
              });
    }
  ...
  public void testMaxUnackedMessagesOnSubscriptionPriority() throws Exception {
    ...
    final String topic = "persistent://" + myNamespace + "/test-" + UUID.randomUUID();
    // init cache
    @Cleanup Producer producer = pulsarClient.newProducer().topic(topic).create();
    ...
    int defaultMaxUnackedMsgOnBroker =
        pulsar.getConfiguration().getMaxUnackedMessagesPerSubscription();
    produceMsg(producer, msgNum);
    // set namespace-level policy, the restriction should take effect
    admin
        .namespaces()
        .setMaxUnackedMessagesPerSubscription(myNamespace, maxUnackedMsgNumOnNamespace);
    Awaitility.await()
        .untilAsserted(
            () ->
                assertEquals(
                    admin.namespaces().getMaxUnackedMessagesPerSubscription(myNamespace).intValue(),
  ...
  private List<Message<?>> getMsgReceived(Consumer<byte[]> consumer1, int msgNum)
  ...
  public void testMaxSubscriptionsPerTopic() throws Exception {
    ...
    Awaitility.await()
        .until(
            () ->
                Integer.valueOf(namespaceLevelMaxSub)
                    .equals(
                        persistentTopic
                            .getHierarchyTopicPolicies()
  ...
  public void testReplicatorRateApi() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getReplicatorDispatchRate(topic)));
  }
  ...
  public void testGetReplicatorRateApplied() throws Exception {
    ...
    assertEquals(
        admin.topicPolicies().getReplicatorDispatchRate(topic, true), namespaceDispatchRate);
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getReplicatorDispatchRate(topic)));
    ...
    admin.topicPolicies().removeReplicatorDispatchRate(topic);
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getReplicatorDispatchRate(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getReplicatorDispatchRate(topic)));
    assertEquals(admin.topicPolicies().getReplicatorDispatchRate(topic, true), brokerDispatchRate);
  }
  ...
  public void testSubscriptionTypesWithPartitionedTopic() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> assertNotNull(admin.topicPolicies().getSubscriptionTypesEnabled(topic)));

    PersistentTopic persistentTopic =
        (PersistentTopic)
            pulsar
                .getBrokerService()
                .getTopicReference(TopicName.get(topic).getPartition(0).toString())
                .get();
  ...
  public void testSubscriptionTypesEnabled() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertTrue(
                  pulsar.getConfiguration().getSubscriptionTypesEnabled().contains("Shared"));
            });
    pulsarClient
        .newConsumer()
        .topic(topic)
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertNotNull(admin.namespaces().getMaxConsumersPerSubscription(myNamespace));
              assertEquals(
                  admin.namespaces().getMaxConsumersPerSubscription(myNamespace).intValue(),
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertNotNull(admin.topicPolicies().getMaxConsumersPerSubscription(topic));
              assertEquals(
                  admin.topicPolicies().getMaxConsumersPerSubscription(topic).intValue(),
  ...
  public void testGetCompactionThresholdApplied() throws Exception {
    ...
    assertEquals(
        admin.topicPolicies().getCompactionThreshold(topic, true).longValue(), brokerPolicy);
    long namespacePolicy = 10L;

    admin.namespaces().setCompactionThreshold(myNamespace, namespacePolicy);
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.namespaces().getCompactionThreshold(myNamespace)));
    assertEquals(
        admin.topicPolicies().getCompactionThreshold(topic, true).longValue(), namespacePolicy);

    long topicPolicy = 20L;
    admin.topicPolicies().setCompactionThreshold(topic, topicPolicy);
    Awaitility.await()
        .untilAsserted(() -> assertNotNull(admin.topicPolicies().getCompactionThreshold(topic)));
    assertEquals(
        admin.topicPolicies().getCompactionThreshold(topic, true).longValue(), topicPolicy);

    admin.namespaces().removeCompactionThreshold(myNamespace);
    admin.topicPolicies().removeCompactionThreshold(topic);
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.namespaces().getCompactionThreshold(myNamespace)));
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topicPolicies().getCompactionThreshold(topic)));
    assertEquals(
        admin.topicPolicies().getCompactionThreshold(topic, true).longValue(), brokerPolicy);
  }
  ...
  public void testProduceConsumeOnTopicPolicy() {
    ...
    try {
      ...
      Producer<String> producer =
          pulsarClient.newProducer(Schema.STRING).topic(persistenceTopic).create();
  ...
  public void testTopicRetentionPolicySetInManagedLedgerConfig() throws Exception {
    ...
    Assert.assertEquals(
        managedLedgerConfig.getRetentionSizeInMB(), nsRetentionPolicies.getRetentionSizeInMB());
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              ...
              Assert.assertEquals(
                  config.getRetentionSizeInMB(), topicRetentionPolicies.getRetentionSizeInMB());
            });
  }
  ...
  public void testPolicyIsDeleteTogetherManually() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assertions.assertThat(
                        pulsar.getBrokerService().getTopic(topic, false).get().isPresent())
                    .isTrue());
    Awaitility.await()
        .untilAsserted(
            () ->
  ...
  public void testPoliciesCanBeDeletedWithTopic() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              ...
              Assertions.assertThat(
                      TopicPolicyTestUtils.getTopicPolicies(
                          pulsar.getTopicPoliciesService(), TopicName.get(topic2)))
                  .isNull();
            });
    // Init Topic Policies. Send 4 messages in a row, there should be only 2 messages left after
    // compression
    ...
    String topicPoliciesTopic =
        "persistent://" + myNamespace + "/" + SystemTopicNames.NAMESPACE_EVENTS_LOCAL_NAME;
    PersistentTopic persistentTopic =
        (PersistentTopic)
    ...
    pulsar
        ...
        .forEach(
            (k, v) -> {
              ...
              assertNull(
                  NamespaceService.checkHeartbeatNamespaceV2(topicName.getNamespaceObject()));
            });
  }
  ...
  public void testReplicatorClusterApi() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(() -> assertNull(admin.topics().getReplicationClusters(topic, false)));

    assertThrows(
        PulsarAdminException.PreconditionFailedException.class,
        () -> admin.topics().setReplicationClusters(topic, List.of()));
    assertThrows(
        PulsarAdminException.PreconditionFailedException.class,
        () -> admin.topics().setReplicationClusters(topic, null));
  }
  ...
  public void testGlobalTopicPolicies() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                assertNotNull(
                    TopicPolicyTestUtils.getGlobalTopicPolicies(
                        topicPoliciesService, TopicName.get(topic))));
    TopicPolicies topicPolicies =
        TopicPolicyTestUtils.getGlobalTopicPolicies(topicPoliciesService, TopicName.get(topic));
    assertNull(
        TopicPolicyTestUtils.getLocalTopicPolicies(topicPoliciesService, TopicName.get(topic)));
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              TopicPolicies tempPolicies =
                  TopicPolicyTestUtils.getGlobalTopicPolicies(
                      topicPoliciesService, TopicName.get(topic));
              assertNull(
                  TopicPolicyTestUtils.getLocalTopicPolicies(
                      topicPoliciesService, (TopicName.get(topic))));
  ...
  public void testMaxMessageSizeWithChunking() throws Exception {
    ...
    @Cleanup PulsarClient pulsarClient = newPulsarClient(lookupUrl.toString(), 0);
    ...
    PersistentTopic topic =
        (PersistentTopic) pulsar.getBrokerService().getTopic(persistenceTopic, false).join().get();
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              Assert.assertEquals(
                  (int) topic.getHierarchyTopicPolicies().getTopicMaxMessageSize().get(), 500);
            });
  ...
  public void testShadowTopics() throws Exception {
    ...
    final String shadowTopic1 =
        "persistent://" + myNamespace + "/shadow-test1-" + UUID.randomUUID();
    final String shadowTopic2 =
        "persistent://" + myNamespace + "/shadow-test2-" + UUID.randomUUID();
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertNull(
                    TopicPolicyTestUtils.getTopicPolicies(
                        pulsar.getTopicPoliciesService(), TopicName.get(sourceTopic))));
        ...
        () ->
            admin
                ...
                .setShadowTopics(
                    sourceTopic,
                    List.of(
                        "non-persistent://" + myNamespace + "/shadow-test1-" + UUID.randomUUID())));
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topics().getShadowTopics(sourceTopic), List.of(shadowTopic1)));
    admin.topics().setShadowTopics(sourceTopic, List.of(shadowTopic1, shadowTopic2));
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(
                    admin.topics().getShadowTopics(sourceTopic),
  ...
  public void testGetTopicPoliciesWhenDeleteTopicPolicy() throws Exception {
    ...
    Integer maxConsumerPerTopic =
        TopicPolicyTestUtils.getTopicPoliciesBypassCache(
                pulsar.getTopicPoliciesService(), TopicName.get(persistenceTopic))
            .orElseThrow()
            .getMaxConsumerPerTopic();
  ...
  public void testDelayedDeliveryPolicy() throws Exception {
    ...
    Awaitility.await()
        .untilAsserted(
            () ->
                Assert.assertEquals(admin.topicPolicies().getDelayedDeliveryPolicy(topic), policy));

    admin.topicPolicies().removeDelayedDeliveryPolicy(topic);
    Awaitility.await()
        .untilAsserted(
            () -> Assert.assertNull(admin.topicPolicies().getDelayedDeliveryPolicy(topic)));
  ...
  public void testUpdateRetentionWithPartialFailure() throws Exception {
    ...
    Mockito.when(mockedSubscription.getDispatcher())
        .thenThrow(new RuntimeException("Mocked error: getDispatcher"));
  ...
  public void testTopicPoliciesGetSubscriptionPolicies() throws Exception {
    TopicPolicies topicPolicies =
        TopicPolicies.builder().maxProducerPerTopic(10).subscriptionPolicies(null).build();
    ...
    topicPolicies
        ...
        .computeIfAbsent("sub", k -> new SubscriptionPolicies())
        .setDispatchRate(new DispatchRateImpl());
    Assert.assertEquals(
        topicPolicies
            .getSubscriptionPolicies()
            .get("sub")
