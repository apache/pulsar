...
public class TopicPoliciesTest extends MockedPulsarServiceBaseTest {
    ...
    public void updatePropertiesForAutoCreatedTopicTest() throws Exception {
        TopicName topicName = TopicName.get(
                TopicDomain.persistent.value(), NamespaceName.get(myNamespace), "test-" + UUID.randomUUID());
    ...
    public void testTopicPolicyInitialValueWithNamespaceAlreadyLoaded() throws Exception {
        ...
        AbstractTopic topic1 = (AbstractTopic)
                pulsar.getBrokerService().getTopic(topic, true).get().get();
        assertEquals(
                topic1.getHierarchyTopicPolicies().getMaxSubscriptionsPerTopic().get(), Integer.valueOf(10));
    }
    ...
    public void testSetSizeBasedBacklogQuota() throws Exception {
        ...
        admin.topicPolicies()
                .setBacklogQuota(testTopic, backlogQuota, BacklogQuota.BacklogQuotaType.destination_storage);
        ...
        for (int i = 0; i < testTopicPartitions; i++) {
            ...
            Topic topic =
                    pulsar.getBrokerService().getTopic(partition, false).get().get();
    ...
    public void testRemoveTimeBasedBacklogQuota() throws Exception {
        ...
        for (int i = 0; i < partitions.size(); i++) {
            Assert.assertEquals(
                    partitions.get(i).getBacklogQuota(BacklogQuota.BacklogQuotaType.message_age), backlogQuota);
    ...
    public void testGetSizeBasedBacklogQuotaApplied() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertFalse(
                        admin.namespaces().getBacklogQuotaMap(myNamespace).isEmpty()));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertFalse(
                        admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertTrue(admin.namespaces()
        ...
        Awaitility.await()
                .untilAsserted(() -> assertTrue(
                        admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
        assertTrue(admin.topicPolicies()
    ...
    public void testGetTimeBasedBacklogQuotaApplied() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertTrue(
                        admin.topicPolicies().getBacklogQuotaMap(topic).isEmpty()));
        assertTrue(admin.topicPolicies().getBacklogQuotaMap(topic, true).get(BacklogQuota.BacklogQuotaType.message_age)
                == null);
    }
    ...
    public void testCheckBacklogQuotaFailed() throws Exception {
        ...
        assertNull(admin.topicPolicies()
                .getBacklogQuotaMap(testTopic)
                .get(BacklogQuota.BacklogQuotaType.destination_storage));
    }
    ...
    public void testRetentionAppliedApi() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin.topicPolicies().getRetention(topic, true), namespacePolicies));

        RetentionPolicies topicPolicies = new RetentionPolicies(20, 30);
        admin.topicPolicies().setRetention(topic, topicPolicies);
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin.topicPolicies().getRetention(topic, true), topicPolicies));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin.topicPolicies().getRetention(topic, true), brokerPolicies));
    }
    ...
    public void testGetSubDispatchRateApplied() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.namespaces().getSubscriptionDispatchRate(myNamespace)));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.topicPolicies().getSubscriptionDispatchRate(topic)));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.namespaces().getSubscriptionDispatchRate(myNamespaceV1)));
        admin.namespaces().removeSubscriptionDispatchRate(myNamespaceV1);
        Awaitility.await()
                .untilAsserted(() -> assertNull(admin.namespaces().getSubscriptionDispatchRate(myNamespaceV1)));
    }
    ...
    public void testRetentionPriority() throws Exception {
        ...
        Awaitility.await().untilAsserted(() -> assertNotNull(admin.namespaces().getRetention(myNamespace)));
        assertFalse((boolean) shouldTopicBeRetained.invoke(persistentTopic));
        ...
        admin.namespaces().removeRetention(myNamespace);
        Awaitility.await().untilAsserted(() -> assertNull(admin.namespaces().getRetention(myNamespace)));
        // the default value of the broker-level is 0, so it is not retained by default
        assertFalse((boolean) shouldTopicBeRetained.invoke(persistentTopic));
    }
    ...
    public void testGetPersistenceApplied() throws Exception {
        ...
        PersistencePolicies brokerPolicy = new PersistencePolicies(
    ...
    public void testSetPersistence() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.namespaces().getPersistence(myNamespace), persistencePoliciesForNamespace));
    ...
    private void waitTopicPoliciesApplied(
        ...
        if (partitions > 0) {
            for (int i = 0; i < partitions; i++) {
                ...
                Awaitility.await().untilAsserted(() -> {
                    Topic t = pulsar.getBrokerService()
                            .getTopicIfExists(partition)
                            .get()
                            .get();
    ...
    public void testSetMaxProducers() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(admin.topicPolicies().getMaxProducers(persistenceTopic), maxProducers));
    ...
    public void testGetSetDispatchRate() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(
                        () -> Assert.assertEquals(admin.topicPolicies().getDispatchRate(testTopic), dispatchRate));
    ...
    public void testPolicyOverwrittenByNamespaceLevel() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.namespaces().getDispatchRate(myNamespace).getDispatchThrottlingRateInMsg(), 200));
        ...
        Awaitility.await().untilAsserted(() -> {
            DispatchRateLimiter limiter = pulsar.getBrokerService()
    ...
    public void testRestart() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.namespaces().getInactiveTopicPolicies(myNamespace).getInactiveTopicDeleteMode(),
        ...
        Awaitility.await()
                .untilAsserted(
                        () -> Assert.assertEquals(admin.namespaces().getRetention(myNamespace), retentionPolicies));
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.topicPolicies().getInactiveTopicPolicies(topic), finalInactiveTopicPolicies));
        ...
        Awaitility.await()
                .untilAsserted(
                        () -> Assert.assertEquals(admin.topicPolicies().getRetention(topic), finalRetentionPolicies));
        ...
        Awaitility.await().untilAsserted(() -> {
            ...
            Assert.assertEquals(
                    managedLedgerConfig.getRetentionSizeInMB(), finalRetentionPolicies.getRetentionSizeInMB());
            Assert.assertEquals(
    ...
    public void testGetSetSubscriptionDispatchRate() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(admin.topicPolicies().getSubscriptionDispatchRate(topic), dispatchRate));
        ...
        DispatchRateLimiter dispatchRateLimiter = pulsar.getBrokerService()
                .getTopicIfExists(topic)
                .get()
                .get()
        ...
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnByte(), dispatchRate.getDispatchThrottlingRateInByte());
    ...
    public void testSubscriptionLevelDispatchRate() throws Exception {
        ...
        Assert.assertEquals(
                admin.topicPolicies().getSubscriptionDispatchRate(topic, subscriptionName, true), topicLevelRate);
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.topicPolicies().getSubscriptionDispatchRate(topic, subscriptionName), subLevelRate));

        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(abstractTopic.getSubscriptionDispatchRate(subscriptionName), subLevelRate));

        DispatchRateLimiter dispatchRateLimiter = abstractTopic
                .getSubscription(subscriptionName)
                .getDispatcher()
                .getRateLimiter()
                .get();
        Assert.assertNotNull(dispatchRateLimiter);
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnByte(), subLevelRate.getDispatchThrottlingRateInByte());
    ...
    public void testRemoveSubscriptionDispatchRate() throws Exception {
        ...
        Awaitility.await().untilAsserted(() -> {
            DispatchRateLimiter drl = pulsar.getBrokerService()
                    .getTopicIfExists(topic)
                    .get()
                    .get()
                    .getSubscription(subscriptionName)
    ...
    public void testSubscriptionDispatchRatePolicyOverwrittenNamespaceLevel() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.namespaces().getSubscriptionDispatchRate(myNamespace), namespaceDispatchRate));
        ...
        DispatchRateLimiter dispatchRateLimiter = pulsar.getBrokerService()
                ...
                .get();
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnMsg(), namespaceDispatchRate.getDispatchThrottlingRateInMsg());
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnByte(), namespaceDispatchRate.getDispatchThrottlingRateInByte());
        ...
        // get subscription dispatch rate limiter
        dispatchRateLimiter = pulsar.getBrokerService()
                .getTopicIfExists(topic)
                .get()
                .get()
                .getSubscription(subscriptionName)
                ...
                .get();
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnByte(), topicDispatchRate.getDispatchThrottlingRateInByte());
        Assert.assertEquals(
                dispatchRateLimiter.getDispatchRateOnMsg(), topicDispatchRate.getDispatchThrottlingRateInMsg());
    ...
    public void testGetSetMaxConsumersPerSubscription() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.topicPolicies().getMaxConsumersPerSubscription(testTopic), maxConsumersPerSubscription));
    ...
    public void testRemoveMaxConsumersPerSubscription() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(
                        admin.namespaces()
                                .getMaxConsumersPerSubscription(myNamespaceV1)
                                .intValue(),
                        20));
        admin.namespaces().removeMaxConsumersPerSubscription(myNamespaceV1);
        Awaitility.await()
                .untilAsserted(() -> assertNull(admin.namespaces().getMaxConsumersPerSubscription(myNamespaceV1)));
    ...
    public void testSetMaxConsumers() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(admin.topicPolicies().getMaxConsumers(persistenceTopic), maxConsumers));
    ...
    public void testDisableSubscribeRate() throws Exception {
        ...
        PersistentTopic topic = (PersistentTopic) pulsar.getBrokerService()
                .getTopicIfExists(persistenceTopic)
                .get()
                .get();
    ...
    public void testGetSetSubscribeRate() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(
                        () -> Assert.assertEquals(admin.namespaces().getSubscribeRate(myNamespace), subscribeRate1));
        ...
        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(admin.topicPolicies().getSubscribeRate(persistenceTopic), subscribeRate2));
        ...
        Consumer consumer1 = pulsarClient1
                .newConsumer()
                .subscriptionName("sub1")
                .topic(persistenceTopic)
                .consumerName("test")
        ...
        Consumer consumer2 = pulsarClient2
                .newConsumer()
                .subscriptionName("sub1")
                .topic(persistenceTopic)
                .consumerName("test")
    ...
    public void testPriorityAndDisableMaxConsumersOnSub() throws Exception {
        ...
        ConsumerBuilder<String> builder = pulsarClient
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.namespaces().getMaxConsumersPerSubscription(myNamespace)));
        consumerList.add(builder.subscribe());
        try {
            builder.subscribe();
            fail("should fail");
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(
                        admin.namespaces()
                                .getMaxConsumersPerSubscription(myNamespace)
                                .intValue(),
                        0));
        consumerList.add(builder.subscribe());
        // set topic-level
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.topicPolicies().getMaxConsumersPerSubscription(topic)));
        consumerList.add(builder.subscribe());
        try {
            builder.subscribe();
            fail("should fail");
        ...
        Awaitility.await().untilAsserted(() -> assertNull(admin.topicPolicies().getMaxConsumersPerSubscription(topic)));
        consumerList.add(builder.subscribe());
        // remove namespace policies, then use broker-level
        admin.namespaces().removeMaxConsumersPerSubscription(myNamespace);
        Awaitility.await()
                .untilAsserted(() -> assertNull(admin.namespaces().getMaxConsumersPerSubscription(myNamespace)));
        try {
            builder.subscribe();
            fail("should fail");
        } catch (PulsarClientException ignored) {
    ...
    public void testRemoveSubscribeRate() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() ->
                        Assert.assertEquals(admin.topicPolicies().getSubscribeRate(persistenceTopic), subscribeRate));

        PulsarClient pulsarClient1 = newPulsarClient(lookupUrl.toString(), 0);
        PulsarClient pulsarClient2 = newPulsarClient(lookupUrl.toString(), 0);
        PulsarClient pulsarClient3 = newPulsarClient(lookupUrl.toString(), 0);

        Consumer<byte[]> consumer1 = pulsarClient1
                .newConsumer()
                .subscriptionName("sub1")
                .topic(persistenceTopic)
                .consumerName("test")
        ...
        Consumer<byte[]> consumer4 = pulsarClient4
                .newConsumer()
                .subscriptionName("sub2")
                .topic(persistenceTopic)
                .consumerName("test")
        ...
        Consumer<byte[]> consumer5 = pulsarClient5
                .newConsumer()
                .subscriptionName("sub2")
                .topic(persistenceTopic)
                .consumerName("test")
        ...
        Consumer<byte[]> consumer6 = pulsarClient6
                .newConsumer()
                .subscriptionName("sub2")
                .topic(persistenceTopic)
                .consumerName("test")
    ...
    public void testTopicMaxMessageSize(TopicDomain topicDomain, boolean isPartitioned) throws Exception {
        ...
        if (isPartitioned) {
            for (int i = 0; i < 3; i++) {
                ...
                Awaitility.await().untilAsserted(() -> {
                    AbstractTopic partition = (AbstractTopic) pulsar.getBrokerService()
                            .getTopicIfExists(partitionName)
                            .get()
                            .get();
                    assertEquals(
                            partition
    ...
    private void doTestMaxSubscriptionsFailFast(SubscriptionMode subMode) throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.namespaces().getMaxSubscriptionsPerTopic(myNamespace)));
    ...
    public void testMaxUnackedMessagesOnSubscriptionPriority() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(
                        admin.namespaces()
                                .getMaxUnackedMessagesPerSubscription(myNamespace)
                                .intValue(),
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.topicPolicies().getMaxUnackedMessagesOnSubscription(topic)));
        ...
        Awaitility.await()
                .until(() -> admin.namespaces().getMaxUnackedMessagesPerSubscription(myNamespace) == null
    ...
    public void testGetReplicatorRateApplied() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.namespaces().getReplicatorDispatchRate(myNamespace)));
    ...
    public void testSubscriptionTypesWithPartitionedTopic() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(admin.topicPolicies().getSubscriptionTypesEnabled(topic)));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertFalse(
                        admin.topics().getSubscriptionTypesEnabled(topic).isEmpty()));
    ...
    public void testSubscriptionTypesEnabled() throws Exception {
        ...
        waitTopicPoliciesApplied(topic, 0, hierarchyTopicPolicies -> {
            assertTrue(hierarchyTopicPolicies
    ...
    public void testNonPersistentMaxConsumerOnSub() throws Exception {
        ...
        ConsumerBuilder builder = pulsarClient
                .newConsumer()
                .subscriptionType(SubscriptionType.Shared)
                .subscriptionName(subName)
                .topic(topic);
        ...
        Awaitility.await().untilAsserted(() -> {
            ...
            assertEquals(
                    admin.topicPolicies().getMaxConsumersPerSubscription(topic).intValue(), maxConsumerPerSubInTopic);
        });
    ...
    public void testPoliciesCanBeDeletedWithTopic() throws Exception {
        ...
        Awaitility.await().untilAsserted(() -> {
            Assertions.assertThat(pulsar.getTopicPoliciesService().getTopicPolicies(TopicName.get(topic)))
                    .isNull();
            Assertions.assertThat(pulsar.getTopicPoliciesService().getTopicPolicies(TopicName.get(topic2)))
                    .isNull();
        });
        ...
        PersistentTopic persistentTopic = (PersistentTopic) pulsar.getBrokerService()
                .getTopicIfExists(topicPoliciesTopic)
                .get()
                .get();
    ...
    public void testReplicatorClusterApi() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin.topics().getReplicationClusters(topic, false), clusters));

        admin.topics().removeReplicationClusters(topic);
        Awaitility.await().untilAsserted(() -> assertNull(admin.topics().getReplicationClusters(topic, false)));
    }
    ...
    public void testGlobalTopicPolicies() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(topicPoliciesService.getTopicPolicies(TopicName.get(topic), true)));
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNotNull(topicPoliciesService.getTopicPolicies(TopicName.get(topic))));
        TopicPolicies tempPolicies = topicPoliciesService.getTopicPolicies(TopicName.get(topic), true);
        assertEquals(tempPolicies.getRetentionPolicies().getRetentionTimeInMinutes(), 3);
        assertEquals(tempPolicies.getRetentionPolicies().getRetentionSizeInMB(), 4);
        ...
        Awaitility.await()
                .untilAsserted(() -> assertNull(topicPoliciesService
                        .getTopicPolicies(TopicName.get(topic), true)
    ...
    public void testMaxMessageSizeWithChunking() throws Exception {
        ...
        PersistentTopic topic = (PersistentTopic) pulsar.getBrokerService()
                .getTopic(persistenceTopic, false)
                .join()
                .get();
        ...
        Awaitility.await().untilAsserted(() -> {
            Assert.assertEquals(
                    (int) topic.getHierarchyTopicPolicies()
                            .getTopicMaxMessageSize()
                            .get(),
                    500);
        });
    ...
    public void testShadowTopics() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> Assert.assertNull(
                        pulsar.getTopicPoliciesService().getTopicPolicies(TopicName.get(sourceTopic))));

        // shadow topic must exist
        Assert.expectThrows(PulsarAdminException.PreconditionFailedException.class, () -> admin.topics()
                .setShadowTopics(sourceTopic, List.of(shadowTopic1)));
        ...
        Awaitility.await()
                .untilAsserted(
                        () -> Assert.assertEquals(admin.topics().getShadowTopics(sourceTopic), List.of(shadowTopic1)));
        admin.topics().setShadowTopics(sourceTopic, List.of(shadowTopic1, shadowTopic2));
        Awaitility.await()
                .untilAsserted(() -> Assert.assertEquals(
                        admin.topics().getShadowTopics(sourceTopic), List.of(shadowTopic1, shadowTopic2)));
    ...
    public void testGetTopicPoliciesWhenDeleteTopicPolicy() throws Exception {
        ...
        Integer maxConsumerPerTopic = pulsar.getTopicPoliciesService()
                .getTopicPoliciesBypassCacheAsync(TopicName.get(persistenceTopic))
                .get()
