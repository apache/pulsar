...
public class ClientGetSchemaTest extends ProducerConsumerBase {
    ...
    protected void setup() throws Exception {
        ...
        producers.add(pulsarClient.newProducer(Schema.AVRO(new SchemaDefinition<>(MyClass.class).alwaysNull(false))).topic(topicAvroNotNull).create());
        producers.add(pulsarClient.newProducer(Schema.JSON(new SchemaDefinition<>(MyClass.class).alwaysNull(false))).topic(topicJsonNotNull).create());
