...
public class TransactionMetricsTest extends BrokerTestBase {
  ...
  public void testTransactionCoordinatorMetrics() throws Exception {
    ...
    Awaitility.await()
        .until(() -> pulsar.getTransactionMetadataStoreService().getStores().size() == 2);
    pulsar
  ...
  public void testTransactionCoordinatorRateMetrics() throws Exception {
    ...
    Awaitility.await()
        ...
        .until(() -> pulsar.getTransactionMetadataStoreService().getStores().size() == 1);
        ...
        pulsar
            ...
            .addAckedPartitionToTxn(
                ...
                Collections.singletonList(
                    TransactionSubscription.builder().topic(topic).subscription(subName).build()))
            .get();
      }
    }
