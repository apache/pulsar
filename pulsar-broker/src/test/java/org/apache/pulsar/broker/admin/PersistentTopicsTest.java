...
public class PersistentTopicsTest extends MockedPulsarServiceBaseTest {
  ...
  protected void setup() throws Exception {
    ...
    PulsarResources resources =
        spy(
            new PulsarResources(
                pulsar.getLocalMetadataStore(), pulsar.getConfigurationMetadataStore()));
    doReturn(spy(new TopicResources(pulsar.getLocalMetadataStore())))
        .when(resources)
        .getTopicResources();
    ...
    admin
        .clusters()
        .createCluster("use", ClusterData.builder().serviceUrl("http://127.0.0.3:8082").build());
    admin
        .clusters()
        .createCluster(
    ...
    admin
        .namespaces()
        .createNamespace(testTenant + "/" + testNamespace, Set.of(testLocalCluster, "test"));
  ...
  public void testGetSubscriptions() {
    ...
    persistentTopics.getSubscriptions(
        response, testTenant, testNamespace, testLocalTopicName, true);
    ...
    Assert.assertEquals(
        ...
        String.format("Topic %s not found", "persistent://my-tenant/my-namespace/topic-not-found"));

    // 2) Confirm that the partitioned topic does not exist
    response = mock(AsyncResponse.class);
    persistentTopics.getSubscriptions(
        response, testTenant, testNamespace, testLocalTopicName + "-partition-0", true);
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.getSubscriptions(
        response, testTenant, notExistNamespace, testLocalTopicName, true);
    errorCaptor = ArgumentCaptor.forClass(RestException.class);
    verify(response, timeout(5000).times(1)).resume(errorCaptor.capture());
    Assert.assertEquals(
        errorCaptor.getValue().getResponse().getStatus(),
    ...
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, testLocalTopicName, 3, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());

    // 4) Create a subscription
    response = mock(AsyncResponse.class);
    persistentTopics.createSubscription(
        response,
        testTenant,
        testNamespace,
        testLocalTopicName,
        "test",
        true,
        new ResetCursorData(MessageId.earliest),
        false);
    ...
    persistentTopics.deleteSubscription(
        response, testTenant, testNamespace, testLocalTopicName, "test", false, true);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    persistentTopics.createSubscription(
        ...
        testTenant,
        testNamespace,
        testLocalTopicName + "-partition-1",
        "test",
        true,
        new ResetCursorData(MessageId.earliest),
        false);
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.getSubscriptions(
        response, testTenant, testNamespace, testLocalTopicName + "-partition-1", true);
    verify(response, timeout(5000).times(1)).resume(Set.of("test"));
    //
    response = mock(AsyncResponse.class);
    persistentTopics.getSubscriptions(
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.deletePartitionedTopic(
        response, testTenant, testNamespace, testLocalTopicName, true, true);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
  ...
  public void testCreateSubscriptions() throws Exception {
    ...
    final String topicName =
        "persistent://" + testTenant + "/" + testNamespace + "/" + testLocalTopicName;
    ...
    persistentTopics.createSubscription(
        ...
        SUB_LATEST,
        true,
        new ResetCursorData(MessageId.latest),
        false);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
  ...
  public void testCreateSubscriptionForNonPersistentTopic() throws InterruptedException {
    ...
    AsyncResponse response = mock(AsyncResponse.class);
    ArgumentCaptor<WebApplicationException> responseCaptor =
        ArgumentCaptor.forClass(RestException.class);
    persistentTopics.createSubscription(
        response,
        testTenant,
        testNamespace,
        "testCreateSubscriptionForNonPersistentTopic",
        "sub",
        true,
        new ResetCursorData(MessageId.earliest),
        false);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getResponse().getStatus(),
  ...
  public void testTerminatePartitionedTopic() {
    ...
    AsyncResponse response = mock(AsyncResponse.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, testLocalTopicName, 1, true);
    ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.terminatePartitionedTopic(
        response, testTenant, testNamespace, testLocalTopicName, true);
  ...
  public void testTerminate() {
    ...
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, testLocalTopicName, true, null);
    ...
    try {
      nonPersistentTopic.terminate(
          response, testTenant, testNamespace, nonPersistentTopicName, true);
      Assert.fail("Should fail validation on non-persistent topic");
    } catch (RestException e) {
      Assert.assertEquals(
          Response.Status.NOT_ACCEPTABLE.getStatusCode(), e.getResponse().getStatus());
    }
  }
  ...
  public void testNonPartitionedTopics() {
    ...
    ArgumentCaptor<RestException> errorCaptor = ArgumentCaptor.forClass(RestException.class);
    persistentTopics.getSubscriptions(
        response, testTenant, testNamespace, nonPartitionTopic + "-partition-0", true);
    verify(response, timeout(5000).times(1)).resume(errorCaptor.capture());
    Assert.assertTrue(errorCaptor.getValue().getMessage().contains("zero partitions"));
    response = mock(AsyncResponse.class);
    final String nonPartitionTopic2 =
        BrokerTestUtil.newUniqueName("secondary-non-partitioned-topic");
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, nonPartitionTopic2, true, null);
    Awaitility.await()
        .untilAsserted(
            () -> {
              Assert.assertTrue(
                  admin
                      .topics()
                      .getList(testTenant + "/" + testNamespace)
                      .contains(
                          "persistent://"
                              + testTenant
                              + "/"
    ...
    persistentTopics.getPartitionedMetadata(
        metaResponse, testTenant, testNamespace, nonPartitionTopic, true, false);
    ...
    persistentTopics.getPartitionedMetadata(
        metaResponse, testTenant, testNamespace, nonPartitionTopic, true, true);
    verify(metaResponse, timeout(5000).times(1)).resume(metaResponseCaptor.capture());
    Assert.assertEquals(metaResponseCaptor.getValue().partitions, 0);
  }
  ...
  public void testCreateNonPartitionedTopic() {
    ...
    TopicName topicName =
        TopicName.get(TopicDomain.persistent.value(), testTenant, testNamespace, topic);
    AsyncResponse response = mock(AsyncResponse.class);
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, topic, true, null);
    Awaitility.await()
        .untilAsserted(
            () -> {
              Assert.assertTrue(
    ...
    ArgumentCaptor<PartitionedTopicMetadata> metaResponseCaptor =
        ArgumentCaptor.forClass(PartitionedTopicMetadata.class);
    persistentTopics.getPartitionedMetadata(
        metaResponse, testTenant, testNamespace, topic, true, false);
    verify(metaResponse, timeout(5000).times(1)).resume(metaResponseCaptor.capture());
    Assert.assertEquals(metaResponseCaptor.getValue().partitions, 0);
    ...
    metaResponseCaptor = ArgumentCaptor.forClass(PartitionedTopicMetadata.class);
    persistentTopics.getPartitionedMetadata(
        metaResponse, testTenant, testNamespace, topic, true, true);
    verify(metaResponse, timeout(5000).times(1)).resume(metaResponseCaptor.capture());
    Assert.assertEquals(metaResponseCaptor.getValue().partitions, 0);
    ...
    TopicName topicName2 =
        TopicName.get(TopicDomain.persistent.value(), testTenant, testNamespace, topic2);
    Map<String, String> topicMetadata = new HashMap<>();
    topicMetadata.put("key1", "value1");
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, topic2, true, topicMetadata);
    Awaitility.await()
        .untilAsserted(
            () -> {
              Assert.assertTrue(
                  admin
                      .topics()
                      .getList(testTenant + "/" + testNamespace)
                      .contains(topicName2.toString()));
            });
    persistentTopics.getPartitionedMetadata(
        metaResponse, testTenant, testNamespace, topic2, true, false);
    verify(metaResponse, timeout(5000).times(1)).resume(metaResponseCaptor.capture());
    ...
    persistentTopics.getProperties(metaResponse, testTenant, testNamespace, topic2, true);
  ...
  public void testCreatePartitionedTopic() {
    ...
    persistentTopics.createPartitionedTopic(
        mock(AsyncResponse.class), testTenant, testNamespace, topicName, 2, true);
    Awaitility.await()
        .untilAsserted(
            () -> {
              ...
              AsyncResponse response = mock(AsyncResponse.class);
              persistentTopics.getPartitionedMetadata(
                  response, testTenant, testNamespace, topicName, true, false);
    ...
    extPersistentTopics.createPartitionedTopic(
        response2, testTenant, testNamespace, topicName2, metadata, true);
    Awaitility.await()
        .untilAsserted(
            () -> {
              persistentTopics.getPartitionedMetadata(
                  response2, testTenant, testNamespace, topicName2, true, false);
  ...
  public void testCreateTopicWithReplicationCluster() {
    ...
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, topicName, 2, true);
    verify(response, timeout(5000).times(1)).resume(errCaptor.capture());
    Assert.assertEquals(
        errCaptor.getValue().getResponse().getStatus(),
        Response.Status.PRECONDITION_FAILED.getStatusCode());
    Assert.assertTrue(
        errCaptor
            .getValue()
            .getMessage()
            .contains("Namespace does not have any clusters configured"));
    ...
    verify(response, timeout(5000).times(1)).resume(errCaptor.capture());
    Assert.assertEquals(
        errCaptor.getValue().getResponse().getStatus(), Response.Status.NOT_FOUND.getStatusCode());
  ...
  public void testCreatePartitionedTopicHavingNonPartitionTopicWithPartitionSuffix()
    ...
    // Test the case in which user already has topic like topic-name-partition-123 created before we
    // enforce the
    // validation.
    ...
    ArgumentCaptor<RestException> errCaptor = ArgumentCaptor.forClass(RestException.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, partitionedTopicName, 5, true);
    verify(response, timeout(5000).times(1)).resume(errCaptor.capture());
    Assert.assertEquals(
        errCaptor.getValue().getResponse().getStatus(), Response.Status.CONFLICT.getStatusCode());
  }
  ...
  public void testUpdatePartitionedTopicHavingProperties() throws Exception {
    ...
    persistentTopics.updatePartitionedTopic(
        response2, tenant, namespace, topic, false, false, false, updatedPartition);
    Awaitility.await()
        .untilAsserted(
            () -> {
              persistentTopics.getPartitionedMetadata(
                  response2, tenant, namespace, topic, true, false);
              verify(response2, timeout(5000).atLeast(1)).resume(responseCaptor2.capture());
  ...
  @Test
  public void testUpdatePartitionedTopicHavingNonPartitionTopicWithPartitionSuffix()
      throws Exception {
    // Already have non partition topic special-topic-partition-10, shouldn't able to update number
    // of
    ...
    doAnswer(
            invocation -> {
              ...
              persistentTopics.topicName =
                  TopicName.get("persistent", "tenant", "cluster", "namespace", "topicname");
              return null;
            })
        .when(persistentTopics)
        .validatePartitionedTopicName(any(), any(), any());
    ...
    ArgumentCaptor<RestException> errorCaptor = ArgumentCaptor.forClass(RestException.class);
    persistentTopics.updatePartitionedTopic(
        response, testTenant, testNamespace, partitionedTopicName, false, false, false, 10);
    verify(response, timeout(5000).times(1)).resume(errorCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
  }
  ...
  public void testUnloadTopic() {
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, partitionTopicName, 6, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.deletePartitionedTopic(
        response, testTenant, testNamespace, partitionTopicName, true, true);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
  ...
  @Test
  public void testGetPartitionedTopicsList()
      throws KeeperException, InterruptedException, PulsarAdminException {
    AsyncResponse response = mock(AsyncResponse.class);
    ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, "test-topic1", 3, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    nonPersistentTopic.createPartitionedTopic(
        response, testTenant, testNamespace, "test-topic2", 3, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, "__change_events", 3, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    Assert.assertEquals(
        TopicName.get(persistentPartitionedTopics.get(0)).getDomain().value(),
    ...
    Assert.assertEquals(
        TopicName.get(nonPersistentPartitionedTopics.get(0)).getDomain().value(),
  ...
  public void testGetList() throws Exception {
    ...
    ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, "test-topic-1", 1, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, "__change_events", 1, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    nonPersistentTopic.createNonPartitionedTopic(
        response, testTenant, testNamespace, "test-topic-2", false, null);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    nonPersistentTopic.createNonPartitionedTopic(
        response, testTenant, testNamespace, "__change_events", false, null);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
  ...
  public void testGrantNonPartitionedTopic() {
    ...
    persistentTopics.grantPermissionsOnTopic(
        response, testTenant, testNamespace, topicName, role, expectActions);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    ArgumentCaptor<Map<String, Set<AuthAction>>> permissionsCaptor =
  ...
  public void testCreateExistedPartition() throws InterruptedException {
    ...
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, topicName, 3, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    ArgumentCaptor<RestException> restExceptionCaptor =
        ArgumentCaptor.forClass(RestException.class);
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, partitionName, true, null);
    verify(response, timeout(5000).times(1)).resume(restExceptionCaptor.capture());
    Assert.assertEquals(
        restExceptionCaptor.getValue().getResponse().getStatus(),
  ...
  public void testGrantPartitionedTopic() {
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.grantPermissionsOnTopic(
        response, testTenant, testNamespace, partitionedTopicName, role, expectActions);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    ArgumentCaptor<Map<String, Set<AuthAction>>> permissionsCaptor =
        ArgumentCaptor.forClass(Map.class);
    persistentTopics.getPermissionsOnTopic(
  ...
  public void testRevokePartitionedTopic() {
    ...
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    persistentTopics.revokePermissionsOnTopic(
        response, testTenant, testNamespace, partitionedTopicName, role);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    TopicName topicName =
        TopicName.get(
            TopicDomain.persistent.value(), testTenant, testNamespace, partitionedTopicName);
    for (int i = 0; i < numPartitions; i++) {
      TopicName partition = topicName.getPartition(i);
      response = mock(AsyncResponse.class);
      permissionsCaptor = ArgumentCaptor.forClass(Map.class);
      persistentTopics.getPermissionsOnTopic(
          response, testTenant, testNamespace, partition.getEncodedLocalName());
      verify(response, timeout(5000).times(1)).resume(permissionsCaptor.capture());
      Map<String, Set<AuthAction>> partitionPermissions = permissionsCaptor.getValue();
  ...
  public void testRevokePartitionedTopicWithReadonlyPolicies() throws Exception {
    ...
    doReturn(
            CompletableFuture.failedFuture(
                new RestException(
                    Response.Status.FORBIDDEN, "Broker is forbidden to do read-write operations")))
        .when(persistentTopics)
    ...
    Assert.assertEquals(
        exceptionCaptor.getValue().getResponse().getStatus(),
  ...
  public void testTriggerCompactionTopic() {
    ...
    ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, nonPartitionTopicName, true, null);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    response = mock(AsyncResponse.class);
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespace, partitionTopicName, 2, true);
  ...
  public void testGetBacklogSizeByMessageId() throws Exception {
    ...
    Assert.assertEquals(
        Optional.ofNullable(
            admin
                .topics()
                .getBacklogSizeByMessageId(topicName + "-partition-0", MessageId.earliest)),
        Optional.of(320L));
  }
  ...
  public void testGetLastMessageId() throws Exception {
    ...
    completableFuture.get();
    Assert.assertEquals(
        ((BatchMessageIdImpl) admin.topics().getLastMessageId(topicName)).getBatchIndex(), 9);
  ...
  public void testExamineMessage() throws Exception {
    ...
    @Cleanup
    Producer<String> producer =
        pulsarClient.newProducer(Schema.STRING).topic(topicName + "-partition-0").create();
    ...
    try {
      ...
      Assert.assertEquals(
          e.getMessage(), "Could not examine messages due to the total message is zero");
    }

    producer.send("message1");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "earliest", 1).getData()),
        "message1");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "latest", 1).getData()),
        "message1");
    ...
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "earliest", 2).getData()),
        "message2");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "earliest", 3).getData()),
        "message3");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "earliest", 4).getData()),
        "message4");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "earliest", 5).getData()),
        "message5");
    ...
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "latest", 2).getData()),
        "message4");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "latest", 3).getData()),
        "message3");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "latest", 4).getData()),
        "message2");
    Assert.assertEquals(
        new String(
            admin.topics().examineMessage(topicName + "-partition-0", "latest", 5).getData()),
        "message1");
  }
  ...
  public void testExamineMessageMetadata() throws Exception {
    ...
    // test enum
    Assert.assertEquals(
        CompressionType.LZ4.ordinal(), message.getMessageBuilder().getCompression().ordinal());
  ...
  public void testOffloadWithNullMessageId() {
    ...
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, topicName, true, null);
    response = mock(AsyncResponse.class);
    persistentTopics.triggerOffload(response, testTenant, testNamespace, topicName, true, null);
    ArgumentCaptor<RestException> errCaptor = ArgumentCaptor.forClass(RestException.class);
    verify(response, timeout(5000).times(1)).resume(errCaptor.capture());
    Assert.assertEquals(
        errCaptor.getValue().getResponse().getStatus(),
  ...
  public void testSetReplicatedSubscriptionStatus() {
    ...
    AsyncResponse response = mock(AsyncResponse.class);
    persistentTopics.setReplicatedSubscriptionStatus(
        response, testTenant, testNamespace, topicName, subName, true, true);
    ArgumentCaptor<RestException> errorCaptor = ArgumentCaptor.forClass(RestException.class);
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.setReplicatedSubscriptionStatus(
        response, testTenant, testNamespace, partitionName, subName, true, true);
    errorCaptor = ArgumentCaptor.forClass(RestException.class);
    verify(response, timeout(10000).times(1)).resume(errorCaptor.capture());
    Assert.assertEquals(
        errorCaptor.getValue().getResponse().getStatus(),
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.setReplicatedSubscriptionStatus(
        response, testTenant, testNamespace, topicName, subName, true, false);
    verify(response, timeout(10000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.setReplicatedSubscriptionStatus(
        response, testTenant, testNamespace, partitionName, subName, true, false);
    verify(response, timeout(10000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.deleteSubscription(
        response, testTenant, testNamespace, topicName, subName, false, true);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(10000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    persistentTopics.deletePartitionedTopic(
        response, testTenant, testNamespace, topicName, true, true);
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    verify(response, timeout(10000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
  ...
  public void testGetMessageById() throws Exception {
    ...
    @Cleanup
    ProducerBase<byte[]> producer1 =
        (ProducerBase<byte[]>)
            pulsarClient.newProducer().topic(topicName1).enableBatching(false).create();
    String data1 = "test1";
    MessageIdImpl id1 = (MessageIdImpl) producer1.send(data1.getBytes());
    @Cleanup
    ProducerBase<byte[]> producer2 =
        (ProducerBase<byte[]>)
            pulsarClient.newProducer().topic(topicName2).enableBatching(false).create();
    String data2 = "test2";
    MessageIdImpl id2 = (MessageIdImpl) producer2.send(data2.getBytes());

    Message<byte[]> message1 =
        admin.topics().getMessageById(topicName1, id1.getLedgerId(), id1.getEntryId());
    Assert.assertEquals(message1.getData(), data1.getBytes());

    Message<byte[]> message2 =
        admin.topics().getMessageById(topicName2, id2.getLedgerId(), id2.getEntryId());
    ...
    Assert.expectThrows(
        PulsarAdminException.ServerSideErrorException.class,
        () -> {
  ...
  public void testGetMessageById4SpecialPropsInMsg() throws Exception {
    ...
    MessageIdImpl id1 =
        (MessageIdImpl)
            producer1.newMessage().value(data1.getBytes()).properties(inSpecialProps).send();
  ...
  public void testGetMessageIdByTimestamp() throws Exception {
    ...
    Assert.assertTrue(
        admin.topics().getMessageIdByTimestamp(topicName, publish2 + 1).compareTo(id2) > 0);
  }
  ...
  public void testGetBatchMessageIdByTimestamp() throws Exception {
                ...
                .intercept(
                    new ProducerInterceptor() {
                      ...
                      public void onSendAcknowledgement(
                          ...
                          Throwable exception) {
                        log.info(
                            "onSendAcknowledgement, message={}, msgId={},publish_time={},exception={}",
                            message,
                            msgId,
    ...
    MessageIdImpl id1 =
        new MessageIdImpl(
            ids.get(0).getLedgerId(), ids.get(0).getEntryId(), ids.get(0).getPartitionIndex());
    long publish1 = publishTimeMap.get(ids.get(0));

    Assert.assertEquals(ids.get(2).getLedgerId(), ids.get(3).getLedgerId());
    MessageIdImpl id2 =
        new MessageIdImpl(
            ids.get(2).getLedgerId(), ids.get(2).getEntryId(), ids.get(2).getPartitionIndex());
  ...
  public void testDeleteTopic() throws Exception {
    ...
    persistentTopics.createNonPartitionedTopic(
        response, testTenant, testNamespace, topicName, false, null);
  ...
  public void testResetCursorReturnTimeoutWhenZKTimeout() {
    ...
    try {
      ...
      String errorMsg =
          ((InternalServerErrorException) e.getCause()).getResponse().readEntity(String.class);
  ...
  public void testUpdatePartitionedTopic()
    ...
    ArgumentCaptor<Response> responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.createPartitionedTopic(
        response, testTenant, testNamespaceLocal, topicName, 2, true);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    Assert.assertEquals(
        responseCaptor.getValue().getStatus(), Response.Status.NO_CONTENT.getStatusCode());
    ...
    response = mock(AsyncResponse.class);
    ArgumentCaptor<PartitionedTopicMetadata> metaCaptor =
        ArgumentCaptor.forClass(PartitionedTopicMetadata.class);
    persistentTopics.getPartitionedMetadata(
        response, testTenant, testNamespaceLocal, topicName, true, false);
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.updatePartitionedTopic(
        response, testTenant, testNamespaceLocal, topicName, false, true, true, 4);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
    ...
    persistentTopics.updatePartitionedTopic(
        response, testTenant, testNamespaceLocal, topicName, false, true, true, 3);
    ...
    persistentTopics.updatePartitionedTopic(
        response, testTenant, testNamespaceLocal, topicName, false, true, true, 5);
    verify(response, timeout(5000).times(1)).resume(throwableCaptor.capture());
    Assert.assertEquals(
        throwableCaptor.getValue().getMessage(),
    ...
    responseCaptor = ArgumentCaptor.forClass(Response.class);
    persistentTopics.updatePartitionedTopic(
        response, testTenant, testNamespaceLocal, topicName, false, true, true, 6);
    verify(response, timeout(5000).times(1)).resume(responseCaptor.capture());
  ...
  public void testInternalGetReplicatedSubscriptionStatusFromLocal() throws Exception {
    ...
    doReturn(CompletableFuture.completedFuture(true))
        ...
        .isServiceUnitOwnedAsync(topic.getPartition(0));
    doReturn(CompletableFuture.completedFuture(false))
        .when(namespaceService)
        .isServiceUnitOwnedAsync(topic.getPartition(1));
    ...
    AsyncResponse response = mock(AsyncResponse.class);
    persistentTopics.getReplicatedSubscriptionStatus(
        response, testTenant, testNamespaceLocal, topic.getLocalName(), subName, false);
  ...
  public void testNamespaceResources() throws Exception {
    ...
    List<String> namespaces =
        pulsar.getPulsarResources().getNamespaceResources().listNamespacesAsync(testTenant).get();
  ...
  public void testCreateMissingPartitions() throws Exception {
    String topicName =
        "persistent://" + testTenant + "/" + testNamespaceLocal + "/testCreateMissingPartitions";
    assertThrows(
        PulsarAdminException.NotFoundException.class,
  ...
  public void testForceDeleteSubscription() throws Exception {
    try {
      ...
      String topicName =
          "persistent://" + testTenant + "/" + testNamespaceLocal + "/testForceDeleteSubscription";
      String subName = "sub1";
      admin.topics().createNonPartitionedTopic(topicName);
      admin.topics().createSubscription(topicName, subName, MessageId.latest);
  ...
  public void testPeekMessageWithProperties() throws Exception {
    String topicName =
        "persistent://" + testTenant + "/" + testNamespaceLocal + "/testPeekMessageWithProperties";
    admin.topics().createNonPartitionedTopic(topicName);
    ...
    nonBatchProducer.newMessage().properties(props1).value("non-batch-message").send();
    ...
    batchProducer.newMessage().properties(props2).value("batch-message-1").sendAsync();

    batchProducer.newMessage().properties(props2).value("batch-message-2").send();
    ...
    for (int i = 0; i < 2; i++) {
      ...
      assertEquals(
          batchMessage.getProperties().size(),
