...
public class SystemTopicBasedTopicPoliciesServiceTest extends MockedPulsarServiceBaseTest {
  ...
  private static final TopicName TOPIC1 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE1), "topic-1");
  private static final TopicName TOPIC2 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE1), "topic-2");
  private static final TopicName TOPIC3 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE2), "topic-1");
  private static final TopicName TOPIC4 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE2), "topic-2");
  private static final TopicName TOPIC5 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE3), "topic-1");
  private static final TopicName TOPIC6 =
      TopicName.get("persistent", NamespaceName.get(NAMESPACE3), "topic-2");
  ...
  @Test
  public void testConcurrentlyRegisterUnregisterListeners()
                ...
                () -> {
                  for (int i = 0; i < 100; i++) {
                    ...
                    Assert.assertNotNull(
                        systemTopicBasedTopicPoliciesService.listeners.get(topicName));
                    Assert.assertTrue(
                        systemTopicBasedTopicPoliciesService.listeners.get(topicName).size() >= 1);
  ...
  public void testGetPolicy() throws Exception {
        ...
        .untilAsserted(
            () -> {
              ...
              TopicPolicies policiesGet2 =
                  TopicPolicyTestUtils.getTopicPolicies(
                      systemTopicBasedTopicPoliciesService, TOPIC2);
              TopicPolicies policiesGet3 =
                  TopicPolicyTestUtils.getTopicPolicies(
                      systemTopicBasedTopicPoliciesService, TOPIC3);
              TopicPolicies policiesGet4 =
                  TopicPolicyTestUtils.getTopicPolicies(
                      systemTopicBasedTopicPoliciesService, TOPIC4);
              TopicPolicies policiesGet5 =
                  TopicPolicyTestUtils.getTopicPolicies(
                      systemTopicBasedTopicPoliciesService, TOPIC5);
              TopicPolicies policiesGet6 =
                  TopicPolicyTestUtils.getTopicPolicies(
                      systemTopicBasedTopicPoliciesService, TOPIC6);
    ...
    Assert.assertTrue(
        systemTopicBasedTopicPoliciesService.checkReaderIsCached(NamespaceName.get(NAMESPACE1)));
    Assert.assertTrue(
        systemTopicBasedTopicPoliciesService.checkReaderIsCached(NamespaceName.get(NAMESPACE2)));
    Assert.assertTrue(
        systemTopicBasedTopicPoliciesService.checkReaderIsCached(NamespaceName.get(NAMESPACE3)));
  ...
  private void prepareData() throws PulsarAdminException {
    ...
    admin
        .tenants()
        .createTenant("system-topic", new TenantInfoImpl(new HashSet<>(), Set.of("test")));
  ...
  public void testWriterCache() throws Exception {
    ...
    SystemTopicBasedTopicPoliciesService service =
        (SystemTopicBasedTopicPoliciesService) pulsar.getTopicPoliciesService();
    Assert.assertNotNull(
        service.getWriterCaches().synchronous().get(NamespaceName.get(NAMESPACE4)));
    for (int i = 1; i <= 5; i++) {
      final String topicName = "persistent://" + NAMESPACE4 + "/testWriterCache" + i;
    ...
    Assert.assertNull(
        service.getWriterCaches().synchronous().getIfPresent(NamespaceName.get(NAMESPACE4)));
  }
