...
public class ExclusiveProducerTest extends BrokerTestBase {
  ...
  private void simpleTest(String topic) throws Exception {
    ...
    CompletableFuture<Producer<String>> p5 =
        pulsarClient2
            .newProducer(Schema.STRING)
            .topic(topic)
            .producerName("p5")
    ...
    CompletableFuture<Producer<String>> p7 =
        pulsarClient2
            .newProducer(Schema.STRING)
            .topic(topic)
            .producerName("p7")
  ...
  @Test(dataProvider = "topics")
  public void testProducerTasksCleanupWhenUsingExclusiveProducers(String type, boolean partitioned)
      throws Exception {
    String topic = newTopic(type, partitioned);
    Producer<String> p1 =
        pulsarClient
  ...
  public void producerReconnection(ProducerAccessMode accessMode, boolean partitioned)
      throws Exception {
    String topic = newTopic("persistent", partitioned);

    Producer<String> p1 =
        pulsarClient.newProducer(Schema.STRING).topic(topic).accessMode(accessMode).create();
  ...
  public void topicDeleted(String ignored, boolean partitioned) throws Exception {
    ...
    if (!partitioned) {
      ...
      // The partitioned topic is deleted, the producer should not be able to publish again on the
      // topic.
  ...
  public void waitForExclusiveTest(String type, boolean partitioned) throws Exception {
    ...
    CompletableFuture<Producer<String>> fp2 =
        pulsarClient
            .newProducer(Schema.STRING)
            .topic(topic)
            .producerName("p2")
    ...
    CompletableFuture<Producer<String>> fp3 =
        pulsarClient
            .newProducer(Schema.STRING)
            .topic(topic)
            .producerName("p3")
  ...
  public void exclusiveWithConsumers(String type, boolean partitioned) throws Exception {
    ...
    pulsarClient.newConsumer(Schema.STRING).topic(topic).subscriptionName("test").subscribe();
