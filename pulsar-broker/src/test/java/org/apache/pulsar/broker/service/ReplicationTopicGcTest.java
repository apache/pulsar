...
public class ReplicationTopicGcTest extends OneWayReplicatorTestBase {
  ...
  public Object[][] topicTypes() {
    return new Object[][] {{TopicType.NON_PARTITIONED}, {TopicType.PARTITIONED}};
  }
  ...
  public void testTopicGC(TopicType topicType) throws Exception {
    ...
    final String subTopic =
        topicType == TopicType.NON_PARTITIONED
            ? topicName
            ...
            () -> {
              ...
              assertFalse(
                  pulsar1
                      .getPulsarResources()
                      .getTopicResources()
                      .persistentTopicExists(TopicName.get(subTopic))
                      .get());
              assertFalse(
                  pulsar2
                      .getPulsarResources()
              ...
              assertTrue(
                  pulsar1
                      ...
                      .getTopicPoliciesAsync(
                          TopicName.get(topicName), TopicPoliciesService.GetType.LOCAL_ONLY)
                      .get()
                      .isEmpty());
              assertTrue(
                  pulsar2
              ...
              // schema.
              assertTrue(
                  CollectionUtils.isEmpty(pulsar1.getSchemaStorage().getAll(schemaId).get()));
              assertTrue(
                  CollectionUtils.isEmpty(pulsar2.getSchemaStorage().getAll(schemaId).get()));
            });
  }
