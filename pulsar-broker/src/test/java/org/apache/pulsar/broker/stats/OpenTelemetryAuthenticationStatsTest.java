...
public class OpenTelemetryAuthenticationStatsTest extends BrokerTestBase {
  ...
  public void testAuthenticationSuccess() {
    ...
    assertMetricLongSumValue(
        ...
        Attributes.of(
            AuthenticationMetrics.PROVIDER_KEY,
            "AuthenticationProviderToken",
            AuthenticationMetrics.AUTH_RESULT_KEY,
            "success",
            AuthenticationMetrics.AUTH_METHOD_KEY,
            "token"),
        1);
  }
  ...
  public void testTokenDurationHistogram() {
    ...
    var expiryTime =
        Optional.of(new Date(System.currentTimeMillis() + TimeUnit.SECONDS.toMillis(15)));
