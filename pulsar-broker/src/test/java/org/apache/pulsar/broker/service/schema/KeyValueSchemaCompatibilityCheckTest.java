...
public class KeyValueSchemaCompatibilityCheckTest {
  ...
  public void testCheckKeyValueAvroCompatibilityFull() {
    ...
    SchemaData fromSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(fooSchema, barSchema).getSchemaInfo().getSchema())
            .props(properties)
            .build();
    SchemaData toSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(fooSchema, barSchema).getSchemaInfo().getSchema())
            .props(properties)
  ...
  public void testCheckKeyValueAvroInCompatibilityFull() {
    ...
    SchemaData fromSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(barSchema, fooSchema).getSchemaInfo().getSchema())
            .props(properties)
            .build();
    SchemaData toSchemaData =
        SchemaData.builder()
  ...
  public void testCheckKeyValueJsonCompatibilityFull() {
    ...
    JSONSchema<Bar> barSchema =
        JSONSchema.of(SchemaDefinition.<Bar>builder().withPojo(Bar.class).build());
    Map<String, String> properties = new HashMap<>();
  ...
  public void testCheckKeyJsonValueAvroKeyTypeInCompatibility() {
    ...
    SchemaData fromSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(fooSchema, barSchema).getSchemaInfo().getSchema())
            .props(fromProperties)
            .build();
    SchemaData toSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(barSchema, barSchema).getSchemaInfo().getSchema())
            .props(toProperties)
            .build();
    Assert.assertFalse(
        checkers
  ...
  public void testCheckKeyJsonValueAvroValueTypeInCompatibility() {
    ...
    SchemaData toSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
            .data(KeyValueSchemaImpl.of(fooSchema, fooSchema).getSchemaInfo().getSchema())
            .props(toProperties)
            .build();
    Assert.assertFalse(
        checkers
  ...
  public void testCheckSchemaTypeAlwaysCompatibility() {
    ...
    SchemaData fromSchemaData =
        SchemaData.builder()
            ...
            .data(stringSchema.getSchemaInfo().getSchema())
            .build();
    SchemaData toSchemaData =
        SchemaData.builder()
            .type(SchemaType.KEY_VALUE)
    ...
    Assert.assertTrue(
        checkers
            .get(SchemaType.KEY_VALUE)
            .isCompatible(
                fromSchemaData, toSchemaData, SchemaCompatibilityStrategy.ALWAYS_COMPATIBLE));
  }
  ...
  public void testCheckSchemaTypeOtherCompatibility() {
    ...
    Assert.assertFalse(
        checkers
            .get(SchemaType.KEY_VALUE)
            .isCompatible(
                fromSchemaData, toSchemaData, SchemaCompatibilityStrategy.ALWAYS_INCOMPATIBLE));
  }
}
