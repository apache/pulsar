...
public class TransactionBufferTestImpl extends TopicTransactionBuffer {
  @Setter public CompletableFuture<Void> transactionBufferFuture = null;
  @Setter public State state = null;
  @Setter public CompletableFuture<Position> publishFuture = null;
  ...
  public CompletableFuture<Void> getTransactionBufferFuture() {
    return transactionBufferFuture == null
        ? super.getTransactionBufferFuture()
