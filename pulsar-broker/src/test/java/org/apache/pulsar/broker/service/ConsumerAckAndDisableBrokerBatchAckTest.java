...
@Slf4j
@Test(groups = "broker")
public class ConsumerAckAndDisableBrokerBatchAckTest extends ConsumerAckTest {
    ...
    public void testAcknowledgeConcurrently(boolean enableBatchSend, boolean enableBatchIndexAcknowledgment1,
            ...
            throws Exception {
        super.testAcknowledgeConcurrently(enableBatchSend, enableBatchIndexAcknowledgment1, enableBatchIndexAcknowledgment2);
    }
}
