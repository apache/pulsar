...
public class ReplicatorRateLimiterTest extends ReplicatorTestBase {
    ...
    public void testReplicatorRateLimiterWithOnlyTopicLevel() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin1.topics().getReplicatorDispatchRate(topicName), topicRate));
        assertTrue(topic.getReplicators().values().get(0).getRateLimiter().isPresent());
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), 10);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), 20L);
        ...
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), -1);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), -1L);
    }
    ...
    public void testReplicatorRateLimiterWithOnlyNamespaceLevel() throws Exception {
        ...
        Awaitility.await()
                .untilAsserted(() -> assertEquals(admin1.namespaces().getReplicatorDispatchRate(namespace), topicRate));
        assertTrue(topic.getReplicators().values().get(0).getRateLimiter().isPresent());
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), 10);
        assertEquals(
        ...
        Awaitility.await().untilAsserted(() -> assertNull(admin1.namespaces().getReplicatorDispatchRate(namespace)));
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), -1);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), -1L);
    ...
    public void testReplicatorRateLimiterWithOnlyBrokerLevel() throws Exception {
        ...
        Awaitility.await().untilAsserted(() -> {
            ...
            assertEquals(
                    admin1.brokers().getAllDynamicConfigurations().get("dispatchThrottlingRatePerReplicatorInMsg"),
                    "10");
            assertEquals(
                    admin1.brokers().getAllDynamicConfigurations().get("dispatchThrottlingRatePerReplicatorInByte"),
                    "20");
        });
    ...
    public void testReplicatorRatePriority() throws Exception {
        ...
        assertTrue(topic.getReplicators().values().get(0).getRateLimiter().isPresent());
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), 100);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), 200L);
        ...
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), 50);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), 60L);
        ...
        Awaitility.await().untilAsserted(() -> assertNull(admin1.topics().getReplicatorDispatchRate(topicName)));
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), 500);
        assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnByte(), 600L);
    ...
    public void testReplicatorRateLimiterDynamicallyChange() throws Exception {
        ...
        Assert.assertFalse(
                topic.getReplicators().values().get(0).getRateLimiter().isPresent());
        ...
        Assert.assertEquals(
                topic.getReplicators().values().get(0).getRateLimiter().get().getDispatchRateOnMsg(), messageRate);
    ...
    public void testReplicatorRateLimiterMessageNotReceivedAllMessages(DispatchRateType dispatchRateType)
        ...
        final String namespace =
                "pulsar/replicatorbyteandmsg-" + dispatchRateType.toString() + "-" + System.currentTimeMillis();
        ...
        Consumer<byte[]> consumer = client2.newConsumer()
                .topic(topicName)
                .subscriptionName("sub2-in-cluster2")
