...
public class ManagedLedgerMetricsTest extends BrokerTestBase {
  ...
  public void testManagedLedgerMetrics() throws Exception {
    ...
    var attribCommon =
        Attributes.of(
            OpenTelemetryAttributes.ML_NAME,
            mlName,
        ...
        .untilAsserted(
            () -> {
              ...
              assertMetricLongSumValue(
                  otelMetrics, OpenTelemetryManagedLedgerStats.BACKLOG_COUNTER, attribCommon, 15);
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.MARK_DELETE_COUNTER,
                  attribCommon,
                  0);
            });
    ...
    Awaitility.await()
        .untilAsserted(
            () -> {
              var otelMetrics = metricReader.collectAllMetrics();
              assertMetricLongSumValue(
                  otelMetrics, OpenTelemetryManagedLedgerStats.BACKLOG_COUNTER, attribCommon, 5);
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.MARK_DELETE_COUNTER,
                  attribCommon,
            ...
            () -> {
              ...
              var attribSucceed =
                  Attributes.of(
                      ...
                      OpenTelemetryAttributes.PULSAR_NAMESPACE,
                      topicNameObj.getNamespace(),
                      OpenTelemetryAttributes.ML_OPERATION_STATUS,
                      "success");
              var attribFailed =
                  Attributes.of(
                      OpenTelemetryAttributes.ML_NAME,
              ...
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.ADD_ENTRY_COUNTER,
                  attribSucceed,
                  15);
              assertMetricLongSumValue(
                  otelMetrics, OpenTelemetryManagedLedgerStats.ADD_ENTRY_COUNTER, attribFailed, 0);
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.BYTES_OUT_COUNTER,
                  attribCommon,
                  value -> assertThat(value).isPositive());
              assertMetricLongSumValue(
                  otelMetrics,
              ...
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.READ_ENTRY_COUNTER,
                  attribSucceed,
                  value -> assertThat(value).isPositive());
              assertMetricLongSumValue(
                  otelMetrics, OpenTelemetryManagedLedgerStats.READ_ENTRY_COUNTER, attribFailed, 0);
              assertMetricLongSumValue(
                  otelMetrics,
                  OpenTelemetryManagedLedgerStats.BYTES_IN_COUNTER,
                  attribCommon,
                  value -> assertThat(value).isPositive());
              assertMetricLongSumValue(
                  otelMetrics,
