...
public class AdminApiTest extends MockedPulsarServiceBaseTest {
    ...
    public void testDeleteTenant() throws Exception {
        ...
        final String namespacePath = "/namespace/" + tenant;
        assertFalse(pulsar.getLocalMetadataStore().exists(managedLedgersPath).join());
        assertFalse(pulsar.getLocalMetadataStore().exists(namespacePath).join());
    }
    ...
    public void testDeleteNamespace() throws Exception {
        ...
        final String namespacePath = "/namespace/" + namespace;
        assertFalse(pulsar.getLocalMetadataStore().exists(managedLedgersPath).join());
        assertFalse(pulsar.getLocalMetadataStore().exists(namespacePath).join());
    }
