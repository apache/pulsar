...
public class JsonSchemaCompatibilityCheckTest extends BaseAvroSchemaCompatibilityTest{
    ...
    public void testJsonSchemaBackwardsCompatibility() throws JsonProcessingException {
        ...
        SchemaData to = SchemaData.builder().data(JSONSchema.of(new SchemaDefinition<>(Foo.class)).getSchemaInfo().getSchema()).build();
        ...
        from = SchemaData.builder().data(JSONSchema.of(new SchemaDefinition<>(Foo.class)).getSchemaInfo().getSchema()).build();
