...
public class JsonSchemaCompatibilityCheckTest extends BaseAvroSchemaCompatibilityTest{
    ...
    public void testJsonSchemaBackwardsCompatibility() throws JsonProcessingException {
        ...
        SchemaData to = SchemaData.builder().data(JSONSchema.of(Foo.class,true).getSchemaInfo().getSchema()).build();
        ...
        from = SchemaData.builder().data(JSONSchema.of(Foo.class,true).getSchemaInfo().getSchema()).build();
