...
public class NamespaceAuthZTest extends MockedPulsarStandalone {
  ...
  public void setup() {
    ...
    getServiceConfiguration()
        .setPackagesManagementStorageProvider(MockedPackagesStorageProvider.class.getName());
    ...
    Mockito.doAnswer(
        ...
        .when(authorizationService)
        .allowNamespaceOperationAsync(Mockito.any(), Mockito.any(), Mockito.any(), Mockito.any());
  }
  ...
  private AtomicBoolean setAuthorizationOperationChecker(
  ...
  public void testBookieAffinityGroup() throws Exception {
    ...
    Assert.assertThrows(
        ...
        () ->
            tenantManagerAdmin
                .namespaces()
                .setBookieAffinityGroup(namespace, bookieAffinityGroupData));
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testSplitBundles() throws Exception {
    ...
    Assert.assertThrows(
        ...
        () ->
            tenantManagerAdmin
                .namespaces()
                .splitNamespaceBundle(namespace, defaultBundle, false, null));
    ...
    for (AuthAction action : AuthAction.values()) {
      ...
      Assert.assertThrows(
          ...
          () ->
              subAdmin
                  .namespaces()
                  .grantPermissionOnNamespace(namespace, role, Set.of(testAction)));
      Assert.assertThrows(
          PulsarAdminException.NotAuthorizedException.class,
          () -> subAdmin.namespaces().getPermissions(namespace));
      Assert.assertThrows(
  ...
  public void testPermissionOnSubscription() throws Exception {
    ...
    final String role = "sub";
    pulsarClient.newConsumer().topic(topic).subscriptionName(subscription).subscribe().close();

    // test super admin
    superUserAdmin
        .namespaces()
        .grantPermissionOnSubscription(namespace, subscription, Set.of(role));
  ...
  public void testPackageAPI() throws Exception {
    ...
    String downloadPath3 =
        new File(file3.getParentFile(), "package-api-test-download.package").getPath();
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testAutoTopicCreation() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.AUTO_TOPIC_CREATION, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.AUTO_TOPIC_CREATION, PolicyOperation.WRITE);
  ...
  public void testNamespaceResourceGroup() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.RESOURCEGROUP, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.RESOURCEGROUP, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testDispatcherPauseOnAckStatePersistent() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.DISPATCHER_PAUSE_ON_ACK_STATE_PERSISTENT, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.DISPATCHER_PAUSE_ON_ACK_STATE_PERSISTENT, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testMaxSubscriptionsPerTopic() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.MAX_SUBSCRIPTIONS, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.MAX_SUBSCRIPTIONS, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testNamespaceReplicationClusters() {
    ...
    Assert.assertThrows(
        ...
        () ->
            subAdmin
                .namespaces()
                .setNamespaceReplicationClusters(namespace, Sets.newHashSet("test")));
    Assert.assertTrue(execFlag.get());
  }
  ...
  public void testMaxTopicsPerNamespace() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.MAX_TOPICS, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.MAX_TOPICS, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testPersistence() {
    ...
    Assert.assertThrows(
        ...
        () ->
            subAdmin
                .namespaces()
                .setPersistence(namespace, new PersistencePolicies(10, 10, 10, 10)));
    Assert.assertTrue(execFlag.get());
  ...
  public void testSubscriptionExpirationTime() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.SUBSCRIPTION_EXPIRATION_TIME, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.SUBSCRIPTION_EXPIRATION_TIME, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testInactiveTopicPolicies() {
    ...
    InactiveTopicPolicies inactiveTopicPolicies =
        new InactiveTopicPolicies(InactiveTopicDeleteMode.delete_when_no_subscriptions, 10, false);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testNamespaceAntiAffinityGroup() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.ANTI_AFFINITY, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.ANTI_AFFINITY, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testEncryptionRequiredStatus() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.ENCRYPTION, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.ENCRYPTION, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
        ...
        () ->
            subAdmin
                ...
                .setSubscriptionTypesEnabled(
                    namespace, Sets.newHashSet(SubscriptionType.Failover)));
    Assert.assertTrue(execFlag.get());
  ...
  public void testIsAllowAutoUpdateSchema() {
    ...
    AtomicBoolean execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.SCHEMA_COMPATIBILITY_STRATEGY, PolicyOperation.READ);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
    ...
    execFlag =
        setAuthorizationPolicyOperationChecker(
            subject, PolicyName.SCHEMA_COMPATIBILITY_STRATEGY, PolicyOperation.WRITE);
    Assert.assertThrows(
        PulsarAdminException.NotAuthorizedException.class,
  ...
  public void testSchemaAutoUpdateCompatibilityStrategy() {
    ...
    Assert.assertThrows(
        ...
        () ->
            subAdmin
                .namespaces()
                .setSchemaAutoUpdateCompatibilityStrategy(namespace, AutoUpdateDisabled));
    Assert.assertTrue(execFlag.get());
  }
