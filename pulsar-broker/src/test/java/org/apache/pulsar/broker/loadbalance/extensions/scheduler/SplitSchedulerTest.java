...
public class SplitSchedulerTest {
  ...
  public void setUp() {
    ...
    Split split =
        new Split(
            bundle1,
            broker,
            Map.of(childBundle11, Optional.empty(), childBundle12, Optional.empty()));
    ...
    Split split2 =
        new Split(
            bundle2,
            broker,
            Map.of(childBundle21, Optional.empty(), childBundle22, Optional.empty()));
  ...
  public void testExecuteSuccess() {
    ...
    SplitScheduler scheduler =
        new SplitScheduler(pulsar, channel, manager, counter, reference, context, strategy);
    doAnswer(
            (invocation) -> {
    ...
    assertEquals(
        ...
        counterExpected.toMetrics(pulsar.getAdvertisedAddress()).toString());
  ...
  public void testDisableLoadBalancer() {
    ...
    SplitScheduler scheduler =
        new SplitScheduler(pulsar, channel, null, null, null, context, strategy);
