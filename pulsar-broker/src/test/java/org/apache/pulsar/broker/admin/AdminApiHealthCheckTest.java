...
public class AdminApiHealthCheckTest extends MockedPulsarServiceBaseTest {
    ...
    public static Object[][] topicVersions() {
        return new Object[][] {
                { null }, { TopicVersion.V1 }, { TopicVersion.V2 },
        };
    }
    ...
    public void testHealthCheckup(TopicVersion topicVersion) throws Exception {
        ...
        final String testHealthCheckTopic = String.format("persistent://%s/%s", namespaceName,
                ...
                .untilAsserted(
                        () -> assertTrue(
                                CollectionUtils.isEmpty(
                                        admin.topics().getSubscriptions(testHealthCheckTopic).stream()
                                                // All system topics are using compaction, even though is not explicitly
                                                // set in
                                                // the policies.
    ...
    public void testHealthCheckTimeOut() throws Exception {
        ...
        // To ensure we don't have any subscription, the producers and readers are
        // closed.
        Awaitility.await()
                .untilAsserted(
                        () -> assertTrue(
