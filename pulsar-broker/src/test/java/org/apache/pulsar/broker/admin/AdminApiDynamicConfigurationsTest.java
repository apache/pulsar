...
public class AdminApiDynamicConfigurationsTest extends MockedPulsarServiceBaseTest {
  ...
  public void testRegisterCustomDynamicConfiguration() throws PulsarAdminException {
    ...
    pulsar
        .getBrokerService()
        .registerCustomDynamicConfiguration(key, value -> !value.equals(invalidValue));
    assertThrows(
  ...
  public void testDeleteStringDynamicConfig() throws PulsarAdminException {
    ...
    admin
        .brokers()
        .updateDynamicConfiguration("configurationMetadataSyncEventTopic", syncEventTopic);
    Awaitility.await()
        .untilAsserted(
            () -> {
              assertEquals(
                  pulsar.getConfig().getConfigurationMetadataSyncEventTopic(), syncEventTopic);
            });
