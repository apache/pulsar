...
public class MessageRedeliveryControllerTest {
  ...
  public void testAddAndRemove(boolean allowOutOfOrderDelivery) throws Exception {
    MessageRedeliveryController controller =
        new MessageRedeliveryController(allowOutOfOrderDelivery);
    ...
    ConcurrentLongLongHashMap hashesRefCount =
        (ConcurrentLongLongHashMap) hashesRefCountField.get(controller);
  ...
  public void testGetMessagesToReplayNow(boolean allowOutOfOrderDelivery) throws Exception {
    ...
    if (allowOutOfOrderDelivery) {
      ...
      Position[] actual1 =
          controller.getMessagesToReplayNow(3, item -> true).toArray(new Position[3]);
      Position[] expected1 = {
        PositionFactory.create(1, 1), PositionFactory.create(1, 2), PositionFactory.create(1, 3)
      };
