...
public class AdminApiSchemaWithAuthTest extends MockedPulsarServiceBaseTest {
    ...
    @Test
    public void testGetCreateDeleteV1Schema() throws Exception {
        // persistent, partitioned v1/topic
        String topicName = "persistent://schematest/test/ns/partitioned-topic";
        ...
        assertThrows(PulsarAdminException.class, () -> adminWithoutPermission.schemas().getAllSchemas(topicName));
        List<SchemaInfo> allSchemas = adminWithConsumePermission.schemas().getAllSchemas(topicName);
        assertEquals(allSchemas.size(), 1);
