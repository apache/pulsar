...
public class DelayedIndexQueueTest {
  ...
  public void testCompare() {
    DelayedIndex delayedIndex = new DelayedIndex().setTimestamp(1).setLedgerId(1L).setEntryId(1L);
    DelayedIndex delayedIndex2 = new DelayedIndex().setTimestamp(2).setLedgerId(2L).setEntryId(2L);
    ...
    delayedIndex2 = new DelayedIndex().setTimestamp(1).setLedgerId(2L).setEntryId(2L);
    Assert.assertTrue(COMPARATOR.compare(delayedIndex, delayedIndex2) < 0);
