...
public class GetPartitionMetadataMultiBrokerTest extends GetPartitionMetadataTest {
  ...
  protected PulsarClientImpl[] getClientsToTest() {
    return new PulsarClientImpl[] {
      clientWithHttpLookup1, clientWitBinaryLookup1, clientWithHttpLookup2, clientWitBinaryLookup2
    };
  }
  ...
  protected void verifyPartitionsNeverCreated(String topicNameStr) throws Exception {
    ...
    try {
      ...
      // If the namespace bundle has not been loaded yet, it means no non-persistent topic was
      // created. So
  ...
  protected void modifyTopicAutoCreation(
    ...
    doModifyTopicAutoCreation(
        admin2, pulsar2, allowAutoTopicCreation, allowAutoTopicCreationType, defaultNumPartitions);
  }
  ...
  public void testGetMetadataIfNonPartitionedTopicExists(
      ...
      throws Exception {
    super.testGetMetadataIfNonPartitionedTopicExists(
  ...
  public void testGetMetadataIfNotAllowedCreate(
      ...
      boolean isUsingHttpLookup)
      throws Exception {
    super.testGetMetadataIfNotAllowedCreate(
        configAllowAutoTopicCreation, paramMetadataAutoCreationEnabled, isUsingHttpLookup);
  }
  ...
  public void testGetMetadataIfNotAllowedCreateOfNonPersistentTopic(
      ...
      boolean isUsingHttpLookup)
      throws Exception {
    super.testGetMetadataIfNotAllowedCreateOfNonPersistentTopic(
        configAllowAutoTopicCreation, paramMetadataAutoCreationEnabled, isUsingHttpLookup);
  }
  ...
  public void testCompatibilityDifferentBrokersForNonPersistentTopic(
      boolean configAllowAutoTopicCreation,
      boolean paramMetadataAutoCreationEnabled,
      boolean isUsingHttpLookup)
      throws Exception {
    ...
    client1
        .getLookup(pulsar2.getBrokerServiceUrl())
        .getBroker(TopicName.get(DEFAULT_NS + "/tp1"))
        .join();
    client2
        .getLookup(pulsar1.getBrokerServiceUrl())
        .getBroker(TopicName.get(DEFAULT_NS + "/tp1"))
        .join();
    ...
    for (PulsarClientImpl client : clientArray) {
      ...
      try {
        ...
        assertFalse(
            ex.getMessage()
                .contains(
                    "getting partitions without auto-creation is not supported from"
                        + " the broker"));
      }
    }
