...
public class NullValueTest extends BrokerTestBase {
  ...
  public void nullValueBooleanSchemaTest(String topic, int partitions)
    ...
    Consumer<Boolean> consumer =
        pulsarClient.newConsumer(Schema.BOOL).topic(topic).subscriptionName("test").subscribe();
  ...
  public void keyValueNullInlineTest(String topic, int partitions)
    ...
    @Cleanup
    Producer<KeyValue<String, String>> producer =
        pulsarClient
    ...
    @Cleanup
    Consumer<KeyValue<String, String>> consumer =
        pulsarClient
  ...
  public void keyValueNullSeparatedTest(String topic, int partitions)
    ...
    Producer<KeyValue<String, String>> producer =
        pulsarClient
            ...
            .topic(topic)
            // The default SinglePartition routing mode will be affected by the key when the
            // KeyValueEncodingType is
