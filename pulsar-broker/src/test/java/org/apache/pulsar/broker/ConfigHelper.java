...
public class ConfigHelper {
  ...
  public static Map<BacklogQuota.BacklogQuotaType, BacklogQuota> backlogQuotaMap(
  ...
  public static BacklogQuota sizeBacklogQuota(ServiceConfiguration configuration) {
    long backlogQuotaBytes =
        configuration.getBacklogQuotaDefaultLimitGB() > 0
            ? ((long)
                (configuration.getBacklogQuotaDefaultLimitGB()
