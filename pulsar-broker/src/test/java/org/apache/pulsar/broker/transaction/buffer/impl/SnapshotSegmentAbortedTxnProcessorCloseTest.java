...
public class SnapshotSegmentAbortedTxnProcessorCloseTest {
    ...
    public void testCloseWaitsForRecoveryIndexUpdate() throws Exception {
        ...
        try {
            ...
            ExecutorProvider recoveryScheduler = mock(ExecutorProvider.class);
            ...
            when(recoveryScheduler.getExecutor(any(Object.class))).thenReturn(recoveryExecutor);
            ...
            when(indexService.getTableView()).thenReturn(tableView);
