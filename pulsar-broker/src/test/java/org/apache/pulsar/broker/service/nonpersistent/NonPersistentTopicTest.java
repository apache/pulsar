...
public class NonPersistentTopicTest extends BrokerTestBase {
  ...
  public void testAccumulativeStats() throws Exception {
    ...
    assertEquals(
        statsAfterUnsubscribe.getBytesInCounter(), statsBeforeUnsubscribe.getBytesInCounter());
    assertEquals(statsAfterUnsubscribe.getMsgInCounter(), statsBeforeUnsubscribe.getMsgInCounter());
    assertEquals(
        statsAfterUnsubscribe.getBytesOutCounter(), statsBeforeUnsubscribe.getBytesOutCounter());
    assertEquals(
        statsAfterUnsubscribe.getMsgOutCounter(), statsBeforeUnsubscribe.getMsgOutCounter());
  }
  ...
  public void testSubscriptionsOnNonPersistentTopic() throws Exception {
    ...
    pulsar
        .getBrokerService()
        .getTopics()
        .put(topicName, CompletableFuture.completedFuture(Optional.of(mockTopic)));
    Mockito.doAnswer(
            inv -> {
