...
public class NonPersistentTopicTest extends BrokerTestBase {
    ...
    public void testAccumulativeStats() throws Exception {
        ...
        TopicStats stats = topic.getStats(false, false, false, true);
        ...
        TopicStats statsBeforeUnsubscribe = topic.getStats(false, false, false, true);
        ...
        TopicStats statsAfterUnsubscribe = topic.getStats(false, false, false, true);
