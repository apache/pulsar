...
public class ServiceUnitStateDataTest {
  ...
  public void equalsTest() {
    ...
    var d1 =
        new ServiceUnitStateData(Assigning, "A", "B", Map.of("A", Optional.of("B")), true, 0, 1);
    var d2 =
        new ServiceUnitStateData(Assigning, "A", "B", Map.of("A", Optional.of("B")), true, 0, 1);
    assertEquals(d1, d2);
    var d3 = new ServiceUnitStateData(Assigning, "C", "B", 1);
    var d4 =
        new ServiceUnitStateData(Assigning, "A", "B", Map.of("A", Optional.of("C")), true, 0, 1);
    assertNotEquals(d1, d3);
    assertNotEquals(d1, d4);

    var d5 =
        new ServiceUnitStateData(Assigning, "A", "B", Map.of("A", Optional.of("B")), true, 0, 2);
    assertNotEquals(d1, d5);

    var d6 =
        new ServiceUnitStateData(Assigning, "C", "B", Map.of("A", Optional.of("B")), true, 0, 1);
