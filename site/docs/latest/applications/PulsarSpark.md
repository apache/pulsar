...
You can find a complete example [here]({{ site.pulsar_repo }}/tree/master/pulsar-spark/src/test/java/org/apache/pulsar/spark/example/SparkStreamingPulsarReceiverExample.java).
