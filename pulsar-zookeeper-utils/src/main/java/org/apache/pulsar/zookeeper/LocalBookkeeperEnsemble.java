...
public class LocalBookkeeperEnsemble {
    ...
    private void initializeZookeper() throws IOException {
        ...
        try {
            ...
            if (zkc.exists("/ledgers" + ZkBookieRackAffinityMapping.BOOKIE_INFO_ROOT_PATH, false) == null) {
                zkc.create("/ledgers" + ZkBookieRackAffinityMapping.BOOKIE_INFO_ROOT_PATH, "{}".getBytes(), Ids.OPEN_ACL_UNSAFE,
