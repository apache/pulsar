...
public class TxnLogBufferedWriter<T> implements AsyncCallbacks.AddEntryCallback, Closeable {
     ...
     */
    public void asyncAddData(T data, AsyncCallbacks.AddDataCallback callback, Object ctx){
        if (!batchEnabled){
    ...
    private void internalAsyncAddData(T data, AsyncCallbacks.AddDataCallback callback, Object ctx){
    ...
    public static class AsyncAddArgs {
        ...
        public static AsyncAddArgs newInstance(AsyncCallbacks.AddDataCallback callback, Object ctx, long addedTime){
        ...
        /** Argument for {@link #asyncAddData(Object, AsyncCallbacks.AddDataCallback, Object)}. **/
        private AsyncCallbacks.AddDataCallback callback;

        /** Argument for {@link #asyncAddData(Object, AsyncCallbacks.AddDataCallback, Object)}. **/
        private Object ctx;

        /** Time of executed {@link #asyncAddData(Object, AsyncCallbacks.AddDataCallback, Object)}. **/
    ...
    /***
     * Instead origin param-callback for {@link #asyncAddData(Object, AsyncCallbacks.AddDataCallback, Object)}
    ...
    public static class DisabledBatchCallback implements AsyncCallbacks.AddEntryCallback {
        ...
        @Override
        public void addComplete(Position position, ByteBuf entryData, Object ctx) {
            Triple<ByteBuf, AsyncCallbacks.AddDataCallback, Object> triple =
                    (Triple<ByteBuf, AsyncCallbacks.AddDataCallback, Object>) ctx;
