 ...
 */
public class MLTransactionTimeoutTrackerFactory implements TransactionTimeoutTrackerFactory {
    ...
    public TransactionTimeoutTracker newTracker(TransactionMetadataStore transactionMetadataStore) {
        ...
        return new MLTransactionTimeoutTracker(
                transactionMetadataStore.getTransactionCoordinatorID().getId(),
                transactionMetadataStore, timer, tickTimeMillis);
    }
