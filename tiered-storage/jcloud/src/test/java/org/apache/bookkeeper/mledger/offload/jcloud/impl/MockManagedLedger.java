...
public class MockManagedLedger implements ManagedLedger {
    ...
    @Override
    public ManagedCursor openCursor(String name, PulsarApi.CommandSubscribe.InitialPosition initialPosition) throws InterruptedException, ManagedLedgerException {
        return null;
    }

    @Override
    public ManagedCursor openCursor(String name, PulsarApi.CommandSubscribe.InitialPosition initialPosition, Map<String, Long> properties) throws InterruptedException, ManagedLedgerException {
        return null;
    }
    ...
    @Override
    public ManagedCursor newNonDurableCursor(Position startPosition, String subscriptionName, PulsarApi.CommandSubscribe.InitialPosition initialPosition, boolean isReadCompacted) throws ManagedLedgerException {
        return null;
    }
    ...
    @Override
    public void asyncOpenCursor(String name, PulsarApi.CommandSubscribe.InitialPosition initialPosition, AsyncCallbacks.OpenCursorCallback callback, Object ctx) {

    }

    @Override
    public void asyncOpenCursor(String name, PulsarApi.CommandSubscribe.InitialPosition initialPosition, Map<String, Long> properties, AsyncCallbacks.OpenCursorCallback callback, Object ctx) {
