...
public class FileStoreTestBase {
    ...
    public void start() throws Exception {
        ...
        properties.put("hdfsFileSystemManagedLedgerOffloadAccessUri", "hdfs://qa-5-173:9000");
        properties.put("hdfsFileSystemManagedLedgerOffloadStorageBasePath", "/user/root/pulsar");
        properties.put("managedLedgerOffloadDriver", "hdfs");
        properties.put("hdfsFileSystemManagedLedgerOffloadUserName", "root");
