...
public class RuntimeUtils {
    ...
    public static List<String> getGoInstanceCmd(InstanceConfig instanceConfig,
        ...
        // Serialize function details as Base64-encoded protobuf binary
        String functionDetails = Base64.getEncoder().encodeToString(
                instanceConfig.getFunctionDetails().toByteArray());
        ...
        if (instanceConfig.getFunctionDetails().getSource().getInputSpecsCount() > 0) {
            ...
            instanceConfig.getFunctionDetails().getSource().forEachInputSpecs((topic, spec) -> {
                sourceInputSpecs.put(topic, Base64.getEncoder().encodeToString(spec.toByteArray()));
    ...
    public static List<String> getCmd(InstanceConfig instanceConfig,
        ...
        args.add("'" + Base64.getEncoder().encodeToString(
                instanceConfig.getFunctionDetails().toByteArray()) + "'");
