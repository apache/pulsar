...
_FUNCTIONCONFIG_INPUTSENTRY = _descriptor.Descriptor(
  name='InputsEntry',
  full_name='proto.FunctionConfig.InputsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='proto.FunctionConfig.InputsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='proto.FunctionConfig.InputsEntry.value', index=1,
...
_FUNCTIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sinkTopic', full_name='proto.FunctionConfig.sinkTopic', index=6,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='processingGuarantees', full_name='proto.FunctionConfig.processingGuarantees', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='userConfig', full_name='proto.FunctionConfig.userConfig', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='subscriptionType', full_name='proto.FunctionConfig.subscriptionType', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='runtime', full_name='proto.FunctionConfig.runtime', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='autoAck', full_name='proto.FunctionConfig.autoAck', index=11,
  ...
  nested_types=[_FUNCTIONCONFIG_INPUTSENTRY, _FUNCTIONCONFIG_USERCONFIGENTRY, ],
  enum_types=[
...
_FUNCTIONMETADATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='workerId', full_name='proto.FunctionMetaData.workerId', index=4,
...
_FUNCTIONCONFIG_INPUTSENTRY.containing_type = _FUNCTIONCONFIG
_FUNCTIONCONFIG_USERCONFIGENTRY.containing_type = _FUNCTIONCONFIG
_FUNCTIONCONFIG.fields_by_name['inputs'].message_type = _FUNCTIONCONFIG_INPUTSENTRY
...
FunctionConfig = _reflection.GeneratedProtocolMessageType('FunctionConfig', (_message.Message,), dict(
  ...
  InputsEntry = _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), dict(
    DESCRIPTOR = _FUNCTIONCONFIG_INPUTSENTRY,
    __module__ = 'Function_pb2'
    # @@protoc_insertion_point(class_scope:proto.FunctionConfig.InputsEntry)
    ))
  ,
...
_sym_db.RegisterMessage(FunctionConfig.InputsEntry)
...
_FUNCTIONCONFIG_INPUTSENTRY.has_options = True
_FUNCTIONCONFIG_INPUTSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
