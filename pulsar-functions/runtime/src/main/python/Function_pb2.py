...
_FUNCTIONCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='custom_serde_inputs', full_name='proto.FunctionConfig.custom_serde_inputs', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sinkTopic', full_name='proto.FunctionConfig.sinkTopic', index=7,
...
_FUNCTIONCONFIG.fields_by_name['custom_serde_inputs'].message_type = _FUNCTIONCONFIG_CUSTOMSERDEINPUTSENTRY
