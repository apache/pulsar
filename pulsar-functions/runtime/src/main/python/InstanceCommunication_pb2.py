...
_FUNCTIONSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deserializationExceptions', full_name='proto.FunctionStatus.deserializationExceptions', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serializationExceptions', full_name='proto.FunctionStatus.serializationExceptions', index=8,
  ...
  nested_types=[_FUNCTIONSTATUS_DESERIALIZATIONEXCEPTIONSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
