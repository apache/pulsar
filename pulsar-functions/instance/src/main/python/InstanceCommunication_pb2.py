...
_FUNCTIONSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='numUserExceptions', full_name='proto.FunctionStatus.numUserExceptions', index=4,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='latestUserExceptions', full_name='proto.FunctionStatus.latestUserExceptions', index=5,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='latestSystemExceptions', full_name='proto.FunctionStatus.latestSystemExceptions', index=7,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='deserializationExceptions', full_name='proto.FunctionStatus.deserializationExceptions', index=8,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='serializationExceptions', full_name='proto.FunctionStatus.serializationExceptions', index=9,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='averageLatency', full_name='proto.FunctionStatus.averageLatency', index=10,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='lastInvocationTime', full_name='proto.FunctionStatus.lastInvocationTime', index=11,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='instanceId', full_name='proto.FunctionStatus.instanceId', index=12,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='workerId', full_name='proto.FunctionStatus.workerId', index=13,
