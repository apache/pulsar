...
_CONNECTORDETAILS_CONFIGSENTRY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='proto.ConnectorDetails.ConfigsEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CONNECTORDETAILS.fields_by_name['configs'].message_type = _CONNECTORDETAILS_CONFIGSENTRY
...
ConnectorDetails = _reflection.GeneratedProtocolMessageType('ConnectorDetails', (_message.Message,), dict(
...
_CONNECTORDETAILS_CONFIGSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
