    ...
    private void setupInput(ContextImpl contextImpl) throws Exception {
        ...
        try {
            if (sourceSpec.getConfigs().isEmpty()) {
                ...
                this.source.open(ObjectMapperFactory.getInstance().readValue(sourceSpec.getConfigs(),
    ...
    private void setupOutput(ContextImpl contextImpl) throws Exception {
        ...
        try {
            if (sinkSpec.getConfigs().isEmpty()) {
                ...
                this.sink.open(ObjectMapperFactory.getInstance().readValue(sinkSpec.getConfigs(),
                        new TypeReference<Map<String, Object>>() {
                        }), contextImpl);
            }
        } catch (Exception e) {
