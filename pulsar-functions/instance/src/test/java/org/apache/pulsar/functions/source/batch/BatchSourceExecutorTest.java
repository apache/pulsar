...
public class BatchSourceExecutorTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.doReturn(CompletableFuture.completedFuture(null))
                .when(consumer)
                .acknowledgeAsync(Mockito.any(MessageId.class));
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp = "Batch Configs cannot be found")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "BatchSourceTriggerer does not implement the correct interface")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "Bad config passed to TestTriggerer")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "BatchSource does not implement the correct interface")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "Bad config passed to TestBatchSource")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "Bad config passed to TestBatchPushSource")
