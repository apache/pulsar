...
public class ExceptionsTest {
    ...
    public void testAreExceptionsPresentInChain3() {
        assertTrue(Exceptions.areExceptionsPresentInChain(
                new IllegalArgumentException(new IllegalStateException()), IllegalStateException.class));
    }
    ...
    public void testAreExceptionsPresentInChain5() {
        assertFalse(Exceptions.areExceptionsPresentInChain(
                new IllegalArgumentException(new IllegalArgumentException()), IllegalStateException.class));
    }
}
