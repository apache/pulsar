...
public class FunctionRuntimeManagerTest {
    ...
    @Test
    public void testFunctionInstancesRestart() throws Exception {
        ...
        verifyRestart(functionRuntimeManager, source, "worker-2", true);
        verifyRestart(functionRuntimeManager, sink, "worker-1", false);
        verifyRestart(functionRuntimeManager, sink, "worker-2", true);
    }

    private static void verifyRestart(FunctionRuntimeManager functionRuntimeManager, Function.FunctionMetaData function,
             String workerId, boolean expectRestartByPulsarAdmin) throws Exception {
