...
public class FunctionApiV2ResourceTest {
    ...
    private void testGetFunctionMissingArguments(
        ...
        FunctionConfig config = (FunctionConfig) resource.getFunctionInfo(
            tenant,
            namespace,
            function
        );
    ...
    private FunctionConfig getDefaultFunctionInfo() throws IOException {
        return (FunctionConfig) resource.getFunctionInfo(
            tenant,
            namespace,
            function
        );
    ...
    public void testListFunctionsSuccess() throws Exception {
        ...
        assertEquals(new Gson().toJson(functions), functionList);
    }
