...
public class FunctionApiV3ResourceTest {
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp = "Function package is not provided")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "No input topic\\(s\\) specified for the function")
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp =
                    "Function package does not have"
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function class UnknownClass must be in class path")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function parallelism must be a positive number")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp =
                    "Output topic persistent://public/default/test_src is also being used as an input topic \\(topics must be one or the other\\)")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Output topic " + function + "-output-topic/test:" + " is invalid")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Encountered error .*. when getting Function package from .*")
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function class .*. does not implement the correct interface")
    ...
    private void testRegisterFunctionMissingArguments(
        ...
        resource.registerFunction(
                tenant, namespace, function, inputStream, details, functionPkgUrl, functionConfig, null);
    }
    ...
    public void testMissingFunctionConfig() {
        resource.registerFunction(tenant, namespace, function, mockedInputStream, mockedFormData, null, null, null);
    }
    ...
    public void testUpdateMissingFunctionConfig() {
        ...
        resource.updateFunction(tenant, namespace, function, mockedInputStream, mockedFormData, null, null, null, null);
    }
    ...
    public void testUpdateSourceWithNoChange() throws ClassNotFoundException {
        ...
        mockStatic(FunctionCommon.class, ctx -> {
            ctx.when(() -> FunctionCommon.getFunctionTypes(any(FunctionConfig.class), any(Class.class)))
                    .thenReturn(new Class[] {String.class, String.class});
            ctx.when(() -> FunctionCommon.convertRuntime(any(FunctionConfig.Runtime.class)))
                    .thenCallRealMethod();
        ...
        FunctionArchive functionArchive =
                FunctionArchive.builder().classLoader(mockedClassLoader).build();
        when(mockedFunctionsManager.getFunction("exclamation")).thenReturn(functionArchive);
        when(mockedFunctionsManager.getFunctionArchive(any()))
                .thenReturn(getPulsarApiExamplesNar().toPath());
        ...
        mockStatic(FunctionConfigUtils.class, ctx -> {
            ...
            ctx.when(() -> FunctionConfigUtils.convert(any(FunctionConfig.class), any(ClassLoader.class)))
                    .thenReturn(functionDetails);
            ctx.when(() -> FunctionConfigUtils.convert(
                            any(FunctionConfig.class), any(FunctionConfigUtils.ExtractedFunctionDetails.class)))
                    .thenReturn(functionDetails);
            ctx.when(() -> FunctionConfigUtils.validateJavaFunction(any(), any()))
                    .thenCallRealMethod();
    ...
    private void registerDefaultFunctionWithPackageUrl(String packageUrl) {
        ...
        resource.registerFunction(
                tenant, namespace, function, mockedInputStream, mockedFormData, packageUrl, functionConfig, null);
    }

    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function test-function already exists")
    ...
    */
    ...
    public void testRegisterFunctionSuccessK8sNoUpload() throws Exception {
        ...
        try (FileInputStream inputStream = new FileInputStream(getPulsarApiExamplesNar())) {
            resource.registerFunction(
                    tenant, namespace, function, inputStream, mockedFormData, null, functionConfig, null);
        }
    }
    ...
    */
    ...
    private void testUpdateFunctionMissingArguments(
        ...
        resource.updateFunction(tenant, namespace, function, inputStream, details, null, functionConfig, null, null);
    }
    ...
    private void updateDefaultFunctionWithPackageUrl(String packageUrl) {
        ...
        resource.updateFunction(
                tenant, namespace, function, mockedInputStream, mockedFormData, packageUrl, functionConfig, null, null);
    }

    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function test-function doesn't exist")
    ...
    public void testUpdateFunctionWithUrl() {
        ...
        resource.updateFunction(tenant, namespace, function, null, null, filePackageUrl, functionConfig, null, null);
    }
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function registeration interrupted")
    ...
    public void testDeregisterFunctionMissingTenant() {
        try {
            ...
            testDeregisterFunctionMissingArguments(null, namespace, function);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    public void testDeregisterFunctionMissingNamespace() {
        try {
            testDeregisterFunctionMissingArguments(tenant, null, function);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    public void testDeregisterFunctionMissingFunctionName() {
        try {
            testDeregisterFunctionMissingArguments(tenant, namespace, null);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    private void testDeregisterFunctionMissingArguments(String tenant, String namespace, String function) {
    ...
    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function deregisteration interrupted")
    ...
    public void testGetFunctionMissingTenant() {
        try {
            testGetFunctionMissingArguments(null, namespace, function);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    public void testGetFunctionMissingNamespace() {
        try {
            testGetFunctionMissingArguments(tenant, null, function);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    public void testGetFunctionMissingFunctionName() {
        try {
            testGetFunctionMissingArguments(tenant, namespace, null);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    private void testGetFunctionMissingArguments(String tenant, String namespace, String function) {
        resource.getFunctionInfo(tenant, namespace, function, null);
    }

    private FunctionConfig getDefaultFunctionInfo() {
        return resource.getFunctionInfo(tenant, namespace, function, null);
    }
    ...
    public void testGetFunctionSuccess() {
        ...
        FunctionMetaData metaData = FunctionMetaData.newBuilder()
                ...
                .setVersion(1234)
                .build();
        when(mockedManager.getFunctionMetaData(eq(tenant), eq(namespace), eq(function)))
                .thenReturn(metaData);

        FunctionConfig functionConfig = getDefaultFunctionInfo();
        assertEquals(FunctionConfigUtils.convertFromDetails(functionDetails), functionConfig);
    }
    ...
    public void testListFunctionsMissingTenant() {
        try {
            testListFunctionsMissingArguments(null, namespace);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    public void testListFunctionsMissingNamespace() {
        try {
            testListFunctionsMissingArguments(tenant, null);
        } catch (RestException re) {
            assertEquals(re.getResponse().getStatusInfo(), Response.Status.BAD_REQUEST);
            throw re;
        }
    ...
    private void testListFunctionsMissingArguments(String tenant, String namespace) {
        resource.listFunctions(tenant, namespace, null);
    }

    private List<String> listDefaultFunctions() {
        return resource.listFunctions(tenant, namespace, null);
    }
    ...
    public void testListFunctionsSuccess() {
        ...
        FunctionMetaData functionMetaData1 = FunctionMetaData.newBuilder()
                .setFunctionDetails(
                        FunctionDetails.newBuilder().setName("test-1").build())
                .build();
        FunctionMetaData functionMetaData2 = FunctionMetaData.newBuilder()
                .setFunctionDetails(
    ...
    public void testDownloadFunctionHttpUrl() throws Exception {
        ...
        String testDir = FunctionApiV3ResourceTest.class
                .getProtectionDomain()
                .getCodeSource()
                .getLocation()
                .getPath();
    ...
    public void testDownloadFunctionBuiltinConnector() throws Exception {
        ...
        WorkerConfig config = new WorkerConfig().setUploadBuiltinSinksSources(false);
    ...
    public void testDownloadFunctionBuiltinConnectorByName() throws Exception {
        ...
        FunctionMetaData metaData = FunctionMetaData.newBuilder()
                ...
                .setTransformFunctionPackageLocation(
                        PackageLocationMetaData.newBuilder().setPackagePath("http://invalid"))
        ...
        StreamingOutput streamOutput = resource.downloadFunction(
                tenant, namespace, function, AuthenticationParameters.builder().build(), false);
        File pkgFile = new File(testDir, UUID.randomUUID().toString());
        OutputStream output = new FileOutputStream(pkgFile);
        streamOutput.write(output);
        Assert.assertTrue(pkgFile.exists());
    ...
    public void testDownloadFunctionBuiltinFunctionByName() throws Exception {
        ...
        FunctionMetaData metaData = FunctionMetaData.newBuilder()
                ...
                .setTransformFunctionPackageLocation(
                        PackageLocationMetaData.newBuilder().setPackagePath("http://invalid"))
                .setFunctionDetails(
                        FunctionDetails.newBuilder().setComponentType(FunctionDetails.ComponentType.FUNCTION))
                .build();
        when(mockedManager.getFunctionMetaData(eq(tenant), eq(namespace), eq(function)))
                .thenReturn(metaData);
    ...
    public void testDownloadTransformFunctionByName() throws Exception {
        ...
        WorkerConfig workerConfig = new WorkerConfig().setUploadBuiltinSinksSources(false);
        when(mockedWorkerService.getWorkerConfig()).thenReturn(workerConfig);
        ...
        FunctionMetaData metaData = FunctionMetaData.newBuilder()
                ...
                .setTransformFunctionPackageLocation(
                        PackageLocationMetaData.newBuilder().setPackagePath("builtin://exclamation"))
                .build();
        when(mockedManager.getFunctionMetaData(eq(tenant), eq(namespace), eq(function)))
                .thenReturn(metaData);
        ...
        StreamingOutput streamOutput = resource.downloadFunction(
                tenant, namespace, function, AuthenticationParameters.builder().build(), true);
        File pkgFile = new File(testDir, UUID.randomUUID().toString());
        OutputStream output = new FileOutputStream(pkgFile);
        streamOutput.write(output);
        Assert.assertTrue(pkgFile.exists());
    ...
    public void testRegisterFunctionWithConflictingFields() throws Exception {
        ...
        functionConfig.setOutputSerdeClassName(outputSerdeClassName);
        resource.registerFunction(
                actualTenant, actualNamespace, actualName, null, null, filePackageUrl, functionConfig, null);
    }

    @Test(
            expectedExceptions = RestException.class,
            expectedExceptionsMessageRegExp = "Function language runtime is either not set or cannot be determined")
