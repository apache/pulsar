...
public class CmdFunctions extends CmdBase {
    ...
    abstract class NamespaceCommand extends BaseCommand {
        @Option(names = "--tenant", description = "The tenant of a Pulsar Function", defaultValue = PUBLIC_TENANT)
        protected String tenant;

        @Option(names = "--namespace", description = "The namespace of a Pulsar Function", defaultValue = DEFAULT_NAMESPACE)
    ...
    abstract class FunctionDetailsCommand extends BaseCommand {
        @Option(names = "--fqfn", description = "The Fully Qualified Function Name (FQFN) for the function"
                + " #Java, Python")
        protected String fqfn;
        @Option(names = "--tenant", description = "The tenant of a Pulsar Function #Java, Python, Go", defaultValue = PUBLIC_TENANT)
        protected String tenant;
        @Option(names = "--namespace", description = "The namespace of a Pulsar Function #Java, Python, Go", defaultValue = DEFAULT_NAMESPACE)
        protected String namespace;
