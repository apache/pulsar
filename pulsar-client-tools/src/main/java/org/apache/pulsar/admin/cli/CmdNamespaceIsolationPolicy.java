...
public class CmdNamespaceIsolationPolicy extends CmdBase {
    @Command(description = "Create/Update a namespace isolation policy for a cluster. his operation requires Pulsar super-user privileges")
    ...
    @Command(description = "List all namespace isolation policies of a cluster. This operation requires Pulsar super-user privileges")
    ...
    @Command(description = "List all brokers with namespace-isolation policies attached to it. This operation requires Pulsar super-user privileges")
    ...
    @Command(description = "Get broker with namespace-isolation policies attached to it. This operation requires Pulsar super-user privileges")
    ...
    @Command(description = "Get namespace isolation policy of a cluster. This operation requires Pulsar super-user privileges")
    ...
    @Command(description = "Delete namespace isolation policy of a cluster. This operation requires Pulsar super-user privileges")
